import{j as i,B as lt}from"./index-DqyrE_V4.js";import{b as o}from"./vendor-ViNJc2wV.js";import{u as ct,a as dt,M as mt}from"./useNavHeight-DbjtKnEM.js";import{u as pt,a as gt,E as ut}from"./HomePage-f-ybkpmA.js";import{S as bt}from"./SocialMediaButtons-CXU617FZ.js";import{F as ht}from"./Footer-Wd1jQuHp.js";import{i as ft}from"./breadcrumbSchema-BG74ATTs.js";import"./beacon-BB01f5iw.js";import"./mobileOptimization-ILGdA5i5.js";import"./sanitizer-a_XURlyA.js";const xt=({dropId:a,color:m="ff0409",theme:v="dark",background:p="solid",minimal:n=!0,style:k={},visible:u=!0})=>{const[T,se]=o.useState(0),[S,C]=o.useState(null),J=o.useRef(0),w=o.useRef(null),H=o.useRef(!1),Z=o.useRef(!1),P=2,be=7e3,D=o.useMemo(()=>a?`https://embed.laylo.com/?${new URLSearchParams({dropId:a,color:m,theme:v,background:p,...n&&{minimal:"true"}}).toString()}`:null,[a,m,v,p,n]),b=o.useCallback(g=>(g||"")+((g||"").includes("?")?"&":"?")+"_ts="+Date.now(),[]),d=o.useCallback((g,K)=>{const le=new Date().toISOString();console.log(`[LayloSimple ${le}] ${g}`,K??"")},[]);o.useEffect(()=>{!u||!D||Z.current||(Z.current=!0,J.current=Date.now(),H.current=!1,d("Initializing iframe src",{url:D}),C(D))},[u,D,d]),o.useEffect(()=>{if(!(!u||!S))return w.current&&(clearTimeout(w.current),w.current=null),J.current=Date.now(),w.current=setTimeout(()=>{H.current||(T<P?(d("Load timeout -> retry",{retryCount:T+1}),se(g=>g+1),H.current=!1,C(b(D))):d("Final load timeout -> giving up after max retries"))},be),()=>{w.current&&(clearTimeout(w.current),w.current=null)}},[S,u,T,D,b,d]),o.useEffect(()=>{const g=()=>{document.visibilityState==="visible"&&u&&!H.current&&(d("visibilitychange -> visible; refreshing iframe"),H.current=!1,C(b(D)))};return document.addEventListener("visibilitychange",g),()=>{document.removeEventListener("visibilitychange",g)}},[u,D,b,d]);const O=o.useCallback(()=>{const g=Date.now()-(J.current||0);H.current=!0,w.current&&(clearTimeout(w.current),w.current=null),d("Iframe onLoad fired",{elapsedMs:g})},[d]),Q=o.useCallback(()=>{d("Iframe onError"),w.current&&(clearTimeout(w.current),w.current=null),T<P?(d("Error -> retry",{retryCount:T+1}),se(g=>g+1),H.current=!1,C(b(D))):d("Final error -> giving up after max retries")},[T,D,b,d]);if(!a)return i.jsx("div",{style:{...k,display:"flex",alignItems:"center",justifyContent:"center",minHeight:60},children:i.jsx("span",{style:{color:"#999",fontSize:14},children:"[LayloSimple] Missing dropId"})});if(!u)return i.jsx("div",{style:{...k}});const ie=S||D;return i.jsx("iframe",{id:`laylo-drop-${a}`,title:"Laylo Signup",width:"100%",height:"100%",frameBorder:"0",scrolling:"no",allow:"web-share; clipboard-write; fullscreen; autoplay; encrypted-media; picture-in-picture",loading:"eager",onLoad:O,onError:Q,style:{...k,WebkitTransform:"translateZ(0)",transform:"translateZ(0)",display:"block"},src:ie},T)},ge=(a,m=null)=>{if(!a)return a;if(typeof a=="string"&&a.startsWith("data:"))return console.log("⚠️ Data URL detected, returning as-is:",a.substring(0,50)+"..."),a;const v=/iPad|iPhone|iPod/.test(navigator.userAgent)&&/Safari/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent);if(typeof a=="string"&&a.includes("/api/images/serve/")){console.log("🔄 Processing new image system URL:",a);const p=a.match(/\/api\/images\/serve\/([a-f0-9-]{36})/);if(p){const n=p[1],k=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click";let u="small";m&&(m<=150?u="thumbnail":m<=300?u="small":m<=600?u="medium":(m<=1200,u="large"));const T=`${k}/api/images/serve/${n}/${u}`;return console.log("✅ Generated optimized URL for new image system:",T,`(variant: ${u}, width: ${m})`),T}}if(typeof a=="string"&&a.includes("/images/figma-exact/")){const p=a.split("/").pop();return v&&p.includes(".webp")?`/images/optimized/${p.replace(".webp",".jpg")}`:`/images/optimized/${p}`}if(typeof a=="string"&&a.startsWith("http")){const p=encodeURIComponent(a),k=`${window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click"}/images/proxy-optimized?url=${p}`,u=v?"&format=jpeg&quality=85":"";return m?`${k}&w=${m}${u}`:`${k}${u}`}if(typeof a=="string"&&a.startsWith("/")&&(a.includes("/api/images/serve/")||!a.includes("/images/"))){console.log("🔄 Processing relative URL, assuming new image system:",a);const p=a.match(/([a-f0-9-]{36})/);if(p){const n=p[1],u=`${window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click"}/api/images/serve/${n}/medium`;return console.log("✅ Generated URL for UUID-based relative path:",u),u}}if(typeof a=="string"&&(a.includes("/images/")||a.includes("/custom/images/"))){const n=a.split("/").pop().replace(/\.[^/.]+$/,"");return m?`/images/optimized/${n}-${m}w.webp`:`/images/optimized/${n}.webp`}return console.log("⚠️ No optimization applied to URL:",a),a},Ye=a=>a==="event"?[150,300,450]:a==="hero"?[600,900,1200]:[150,300,600],vt=(a,m="event")=>a?Ye(m).map(v=>`${ge(a,v)} ${v}w`).join(", "):"",yt=(a,m="event")=>{if(!a||/iPhone|iPad|iPod/.test(navigator.userAgent)&&/Safari/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent))return"";if(typeof a=="string"&&(a.includes("/api/images/serve/")||a.includes("/api/settings/serve/")||a.startsWith("/api/")))return console.log("🚫 Skipping AVIF for internal API URL to prevent loop:",a),"";const p=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click";return Ye(m).map(n=>`${p}/images/proxy-optimized?url=${encodeURIComponent(a)}&w=${n}&format=avif ${n}w`).join(", ")},ue=[{id:"us",code:"+1",name:"United States",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"(555) 123-4567",maxLength:14,digitLength:10},{id:"ca",code:"+1",name:"Canada",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"(555) 123-4567",maxLength:14,digitLength:10},{id:"gb",code:"+44",name:"United Kingdom",flag:"data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjEiIGhlaWdodD0iMTUiIHZpZXdCb3g9IjAgMCAyMSAxNSIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPHJlY3Qgd2lkdGg9IjIxIiBoZWlnaHQ9IjE1IiBmaWxsPSIjMDEyMTY5Ii8+CjxwYXRoIGQ9Ik0wIDBoMjF2MTVIMHoiIGZpbGw9IiMwMTIxNjkiLz4KPC9zdmc+",pattern:/^\d{10,11}$/,placeholder:"7911 123456",maxLength:13,digitLength:11},{id:"au",code:"+61",name:"Australia",flag:"data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjEiIGhlaWdodD0iMTUiIHZpZXdCb3g9IjAgMCAyMSAxNSIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPHJlY3Qgd2lkdGg9IjIxIiBoZWlnaHQ9IjE1IiBmaWxsPSIjMDEyMTY5Ii8+PC9zdmc+",pattern:/^\d{9}$/,placeholder:"412 345 678",maxLength:11,digitLength:9},{id:"de",code:"+49",name:"Germany",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"30 12345678",maxLength:13,digitLength:11},{id:"fr",code:"+33",name:"France",flag:"data:image/svg+xml;base64,",pattern:/^\d{9}$/,placeholder:"6 12 34 56 78",maxLength:12,digitLength:9},{id:"es",code:"+34",name:"Spain",flag:"data:image/svg+xml;base64,",pattern:/^\d{9}$/,placeholder:"612 34 56 78",maxLength:11,digitLength:9},{id:"it",code:"+39",name:"Italy",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"312 345 6789",maxLength:12,digitLength:10},{id:"jp",code:"+81",name:"Japan",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"90 1234 5678",maxLength:13,digitLength:11},{id:"kr",code:"+82",name:"South Korea",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"10 1234 5678",maxLength:13,digitLength:11},{id:"cn",code:"+86",name:"China",flag:"data:image/svg+xml;base64,",pattern:/^\d{11}$/,placeholder:"138 0013 8000",maxLength:13,digitLength:11},{id:"in",code:"+91",name:"India",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"98765 43210",maxLength:12,digitLength:10},{id:"br",code:"+55",name:"Brazil",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"11 91234 5678",maxLength:14,digitLength:11},{id:"mx",code:"+52",name:"Mexico",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"55 1234 5678",maxLength:12,digitLength:10}],$e=(a,m)=>{const v=typeof a=="string"?a.replace(/[^\d]/g,""):"",p=ue.find(k=>k.id===m);if(!p||v.length===0)return v;const n=v.slice(0,p.digitLength);switch(m){case"us":case"ca":return n.length<=3?n:n.length<=6?`(${n.slice(0,3)}) ${n.slice(3)}`:`(${n.slice(0,3)}) ${n.slice(3,6)}-${n.slice(6)}`;case"gb":return n.length<=4?n:n.length<=7?`${n.slice(0,4)} ${n.slice(4)}`:`${n.slice(0,4)} ${n.slice(4,7)} ${n.slice(7)}`;case"jp":case"kr":return n.length<=2?n:n.length<=6?`${n.slice(0,2)} ${n.slice(2)}`:`${n.slice(0,2)} ${n.slice(2,6)} ${n.slice(6)}`;case"cn":return n.length<=3?n:n.length<=7?`${n.slice(0,3)} ${n.slice(3)}`:`${n.slice(0,3)} ${n.slice(3,7)} ${n.slice(7)}`;case"in":return n.length<=5?n:`${n.slice(0,5)} ${n.slice(5)}`;case"br":return n.length<=2?n:n.length<=7?`${n.slice(0,2)} ${n.slice(2)}`:`${n.slice(0,2)} ${n.slice(2,7)} ${n.slice(7)}`;case"mx":return n.length<=2?n:n.length<=6?`${n.slice(0,2)} ${n.slice(2)}`:`${n.slice(0,2)} ${n.slice(2,6)} ${n.slice(6)}`;default:return n.length<=3?n:n.length<=6?`${n.slice(0,3)} ${n.slice(3)}`:`${n.slice(0,3)} ${n.slice(3,6)} ${n.slice(6)}`}},wt=(a,m)=>{const v=a.replace(/[^\d]/g,""),p=ue.find(n=>n.id===m);return p?p.pattern.test(v):v.length>=10&&v.length<=15},je=a=>ue.find(m=>m.id===a)||ue[0],Pt=()=>{const{trackEvent:a}=pt(),[m,v]=o.useState(!1);o.useCallback(e=>{v(e),e&&a("privacy_consent",{action:"granted",timestamp:Date.now(),component:"PrivacyConsentModal"})},[a]);const[p,n]=o.useState(!0),[k,u]=o.useState(!1);o.useEffect(()=>{setTimeout(()=>{n(!1),u(!0)},2e3),a("component_load",{component:"FigmaMobile",viewport_type:"mobile"})},[a]),o.useEffect(()=>{ft("homepage")},[]),o.useEffect(()=>{if(!document.querySelector('script[src="https://embed.laylo.com/laylo-sdk.js"]')){const e=document.createElement("script");e.src="https://embed.laylo.com/laylo-sdk.js",e.async=!0,e.defer=!0,e.onerror=s=>{console.warn("⚠️ Laylo SDK failed to load in FigmaMobile:",s)},e.onload=()=>{console.log("✅ Laylo SDK script loaded successfully in FigmaMobile")},document.head.appendChild(e)}},[]);const[T,se]=o.useState(!1),[S,C]=o.useState(""),[J,w]=o.useState(!1),[H,Z]=o.useState(!1),[P,be]=o.useState("us"),[D,b]=o.useState("normal"),[d,O]=o.useState(!1),[Q,ie]=o.useState(""),[g,K]=o.useState(""),[le,X]=o.useState(!1),[It,A]=o.useState("normal"),[I,M]=o.useState(!1),[he,U]=o.useState(!1),[_,z]=o.useState(!1),[Te,De]=o.useState(!1);o.useState(!1);const[Ee,oe]=o.useState(0),[ce,ne]=o.useState(!1),[Ce,Ae]=o.useState(!1),[N,ae]=o.useState({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1}),{loading:fe,homeSettings:de,showAllEvents:y,setShowAllEvents:xe,filteredFeaturedEvents:B,filteredHomepageEvents:q,featuredEvents:Ve,homepageEvents:Je,normalizeEvent:Ne}=gt(),[St,Qe]=o.useState(0),[ee,Ke]=o.useState(!1),[G,Xe]=o.useState(!1),[j,ze]=o.useState(null),[Le,Ze]=o.useState(!1),Pe=o.useCallback((e,s)=>{if(Le)return;Ze(!0);let t=e.coverImage;t&&!t.startsWith("http")&&(t=`${window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click"}${t}`),t&&(t=t.replace(/[?&](w|width|h|height|size)=\d+/g,""),t=t.replace(/[?&]$/,"")),ze({...e,imageUrl:t||e.coverImage,originalRect:s?.getBoundingClientRect()||null}),setTimeout(()=>{Ze(!1)},400)},[Le]),Fe=o.useCallback(()=>{ze(null)},[]),x=o.useRef({scrollY:0,locked:!1,prevent:void 0,prevBodyPosition:"",prevBodyTop:"",prevBodyWidth:"",prevBodyOverflow:"",prevBodyTouchAction:""}),We=o.useCallback(()=>{if(x.current.locked)return;const e=window.scrollY||window.pageYOffset||0;x.current.scrollY=e;const s=r=>{r&&typeof r.preventDefault=="function"&&r.preventDefault(),r&&typeof r.stopPropagation=="function"&&r.stopPropagation()};x.current.prevent=s,document.documentElement.style.overscrollBehavior="none";const t=document.body;x.current.prevBodyPosition=t.style.position||"",x.current.prevBodyTop=t.style.top||"",x.current.prevBodyWidth=t.style.width||"",x.current.prevBodyOverflow=t.style.overflow||"",x.current.prevBodyTouchAction=t.style.touchAction||"",t.style.position="fixed",t.style.top=`-${e}px`,t.style.width="100%",t.style.overflow="hidden",t.style.touchAction="none",window.addEventListener("wheel",s,{passive:!1,capture:!0}),window.addEventListener("touchmove",s,{passive:!1,capture:!0}),x.current.locked=!0},[]),ve=o.useCallback(()=>{if(!x.current.locked)return;const e=document.body;e.style.position=x.current.prevBodyPosition,e.style.top=x.current.prevBodyTop,e.style.width=x.current.prevBodyWidth,e.style.overflow=x.current.prevBodyOverflow,e.style.touchAction=x.current.prevBodyTouchAction,document.documentElement.style.overscrollBehavior="",x.current.prevent&&(window.removeEventListener("wheel",x.current.prevent,{capture:!0}),window.removeEventListener("touchmove",x.current.prevent,{capture:!0}));const s=x.current.scrollY||0;window.scrollTo(0,s),x.current.locked=!1},[]);o.useEffect(()=>{if(j)return We(),()=>{ve()};ve()},[j,We,ve]);const[me,$]=o.useState("hd720"),[Re,Y]=o.useState("fast"),[L,ye]=o.useState({expanded:!1,showDisclaimer:!1,showVerification:!1,verificationCode:"",phoneNumber:""}),He=o.useCallback(()=>{ye({expanded:I,showDisclaimer:he,showVerification:d,verificationCode:Q,phoneNumber:S}),console.log("💾 Drawer state saved, iframe content preserved")},[I,he,d,Q,S]),[kt,we]=o.useState(!1),F=o.useRef(null),Ie=o.useRef(null),h=o.useRef(null),pe=o.useRef(!0),Se=o.useRef(null),ke=o.useRef(null),_e=ct(),qe=Math.max(_e||0,0)+12,{scrollY:et}=dt(ke.current,{threshold:20,throttleMs:32,passive:!0});o.useEffect(()=>{const e=document.body,s=ke.current;if(I){const t=window.scrollY;e.classList.add("drawer-scroll-lock"),e.style.top=`-${t}px`,s&&s.classList.add("drawer-active")}else{const t=e.style.top;e.classList.remove("drawer-scroll-lock"),e.style.top="",t&&window.scrollTo(0,parseInt(t||"0")*-1),s&&s.classList.remove("drawer-active")}return()=>{e.classList.remove("drawer-scroll-lock"),e.style.top="",s&&s.classList.remove("drawer-active")}},[I]),o.useCallback(e=>{const s=e.target.value,t=je(P),r=s.replace(/[^\d]/g,"");if(r.length>t.digitLength)return;const l=$e(r,P);C(l)},[P]),o.useCallback(e=>{e.key==="Enter"&&tt()},[]),o.useCallback(e=>{const s=e.target.value,t=je(s);if(be(s),Ie.current&&t.flag&&(Ie.current.src=t.flag,Ie.current.alt=t.name),S){const r=S.replace(/[^\d]/g,""),l=$e(r,s);C(l)}console.log(`🌍 Country changed to: ${t.code} (${t.name})`)},[S]);const tt=o.useCallback(async()=>{const e=S.trim();if(!e||J)return;if(e.replace(/\D/g,"")==="5555555555"){console.log("🧪 Test number detected - showing loading then verification UI"),w(!0),b("loading"),setTimeout(()=>{b("valid"),K(e),w(!1),setTimeout(()=>{O(!0),M(!0)},200)},800);return}const r=je(P);if(!wt(e,P)){console.warn("Invalid phone number format for",r.name),b("invalid"),F.current&&(F.current.classList.add("shake"),setTimeout(()=>{F.current?.classList.remove("shake"),b("normal")},400));return}try{w(!0),b("loading"),console.log("📱 Submitting phone number:",{phone:e,countryCode:r.code});const l=window.location.hostname==="localhost"?"":"https://admin.b2b.click",c=await fetch(`${l}/api/home-settings/submit-phone`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:e,countryCode:r.code})}),f=await c.json();c.ok&&f.success?(console.log("✅ Phone number submitted successfully"),f.requiresVerification?(console.log("🔐 Moving to verification step"),b("normal"),K(e),setTimeout(()=>{O(!0),M(!0)},500)):(Z(!0),b("valid"),C(""),setTimeout(()=>{Z(!1),b("normal")},3e3))):(console.error("❌ Failed to submit phone number:",f.error||"Unknown error"),b("invalid"),F.current&&(F.current.classList.add("shake"),setTimeout(()=>{F.current?.classList.remove("shake"),b("normal")},400)))}catch(l){console.error("❌ Error submitting phone number:",l),b("invalid"),F.current&&(F.current.classList.add("shake"),setTimeout(()=>{F.current?.classList.remove("shake"),b("normal")},400))}finally{w(!1)}},[S,J,P]);o.useCallback(async()=>{const e=Q.trim();if(!e||le)return;if(g.replace(/\D/g,"")==="5555555555"&&(console.log("🧪 Test verification - accepting any 4-digit code"),e.length===4)){X(!0),b("loading"),setTimeout(()=>{A("valid"),Z(!0),X(!1)},1e3),setTimeout(()=>{z(!0),O(!1),M(!1),U(!1)},2e3),setTimeout(()=>{ie(""),K(""),C(""),Z(!1),b("normal"),A("normal"),X(!1),z(!1),oe(0),ne(!1),h.current&&(clearInterval(h.current),h.current=null),ye({expanded:!1,showDisclaimer:!1,showVerification:!1,verificationCode:"",phoneNumber:""})},5e3);return}if(!/^\d{4}$/.test(e)){console.warn("Invalid verification code format"),A("invalid"),setTimeout(()=>{A("filled")},400);return}try{X(!0),b("loading"),console.log("🔐 Submitting verification code");const r=window.location.hostname==="localhost"?"":"https://admin.b2b.click",l=await fetch(`${r}/api/home-settings/verify-phone`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:g,code:e})}),c=await l.json();l.ok&&c.success?(console.log("✅ Phone verification successful"),A("valid"),Z(!0),setTimeout(()=>{z(!0),O(!1),M(!1),U(!1)},2e3),setTimeout(()=>{ie(""),K(""),C(""),Z(!1),b("normal"),A("normal"),X(!1),z(!1),oe(0),ne(!1),h.current&&(clearInterval(h.current),h.current=null),ye({expanded:!1,showDisclaimer:!1,showVerification:!1,verificationCode:"",phoneNumber:""})},5e3)):(console.error("❌ Phone verification failed:",c.error||"Unknown error"),A("invalid"),setTimeout(()=>{A("filled")},400))}catch(r){console.error("❌ Error submitting verification code:",r),A("invalid"),setTimeout(()=>{A("filled")},400)}finally{X(!1)}},[Q,le,g]);const te=o.useCallback(()=>{console.log("🚀 Starting countdown timer"),h.current&&(clearInterval(h.current),h.current=null),oe(60),ne(!1),h.current=setInterval(()=>{if(!pe.current){h.current&&(clearInterval(h.current),h.current=null);return}oe(e=>(console.log("⏰ Countdown tick:",e),e<=1?(console.log("✅ Countdown finished, enabling resend"),pe.current&&ne(!0),h.current&&(clearInterval(h.current),h.current=null),0):e-1))},1e3)},[]);o.useCallback(async()=>{if(!(!ce||Ce||!g))try{Ae(!0),console.log("🔄 Resending verification code to:",g);const e=window.location.hostname==="localhost"?"":"https://admin.b2b.click",t=await(await fetch(`${e}/api/home-settings/resend-verification`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phoneNumber:g})})).json();t.success?(console.log("✅ Verification code resent successfully"),te()):(console.error("❌ Failed to resend verification code:",t.error),te())}catch(e){console.error("❌ Error resending verification code:",e),te()}finally{Ae(!1)}},[ce,Ce,g,te]),o.useEffect(()=>(pe.current=!0,()=>{pe.current=!1,h.current&&(clearInterval(h.current),h.current=null)}),[]),o.useEffect(()=>{!d&&h.current&&(clearInterval(h.current),h.current=null,oe(0),ne(!1))},[d]),o.useEffect(()=>{console.log("🔄 Countdown useEffect triggered:",{showVerification:d,verificationPhone:g,resendCountdown:Ee,canResend:ce}),d&&g&&Ee===0&&!ce&&(console.log("🚀 Starting resend countdown"),te())},[d,g,te]),o.useEffect(()=>{fe||(setTimeout(()=>{Ke(!0)},150),setTimeout(()=>{Xe(!0)},300))},[fe]),o.useEffect(()=>{const e=setTimeout(()=>{z(!1),M(!1)},500);return()=>clearTimeout(e)},[]),o.useEffect(()=>{const s=setTimeout(()=>{if("connection"in navigator){const l=navigator.connection||navigator.mozConnection||navigator.webkitConnection;if(l){const c=l.effectiveType,f=l.downlink;console.log("🌐 Connection detected:",{effectiveType:c,downlink:f}),c==="4g"&&f>5?($("hd1080"),Y("fast")):c==="4g"||c==="3g"&&f>2?($("hd720"),Y("medium")):($("large"),Y("slow"));return}}const t=performance.now(),r=new Image;r.onload=()=>{const c=performance.now()-t;console.log("🚀 Speed test completed in:",c+"ms"),c<200?($("hd1080"),Y("fast")):c<500?($("hd720"),Y("medium")):($("large"),Y("slow"))},r.onerror=()=>{console.log("⚠️ Speed test failed, using default HD quality"),$("hd720"),Y("medium")},r.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"},200);return()=>clearTimeout(s)},[]),o.useEffect(()=>{if(B&&B.length>0){console.log("🚀 Preloading critical event images for instant display...");const e=/iPhone|iPad|iPod/.test(navigator.userAgent)&&/Safari/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent);B.slice(0,2).forEach((s,t)=>{if(s.coverImage){if(!e&&!s.coverImage.includes("/api/images/serve/")){const l=document.createElement("link");l.rel="preload",l.as="image",l.type="image/avif";const c=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click";l.href=`${c}/images/proxy-optimized?url=${encodeURIComponent(s.coverImage)}&w=120&format=avif`,document.head.appendChild(l)}const r=document.createElement("link");if(r.rel="preload",r.as="image",r.type="image/webp",r.href=ge(s.coverImage,300),document.head.appendChild(r),e){const l=document.createElement("link");l.rel="preload",l.as="image",l.href=s.coverImage,document.head.appendChild(l)}console.log(`✅ Preloaded mobile event image ${t+1}: ${s.title} ${e?"(Safari mobile optimized)":""}`)}})}},[B]);const[V,Be]=o.useState(!1),[Mt,Me]=o.useState(!1),Ge=()=>{V?(Be(!1),Me(!1)):(Me(!0),Be(!0),setTimeout(()=>Me(!1),600))},Oe=()=>{const e=window.location.pathname;return e==="/"||e===""?"events":e.startsWith("/about")?"about":e.startsWith("/contact")?"contact":"events"},[it,ot]=o.useState(Oe());o.useEffect(()=>{const e=()=>{ot(Oe())};return window.addEventListener("popstate",e),e(),()=>{window.removeEventListener("popstate",e)}},[]);const nt=e=>{if(e==="/"){window.scrollTo({top:0,behavior:"smooth"});return}window.location.href=e};o.useCallback(()=>{M(!0),U(!0)},[]),o.useCallback(()=>{!S.trim()&&!d&&setTimeout(()=>{M(!1),U(!1)},200)},[S,d]);const re=o.useCallback(e=>{Se.current&&!Se.current.contains(e.target)&&(He(),M(!1),d?z(!1):(z(!1),U(!1)))},[S,d,He]);o.useEffect(()=>(I&&(document.addEventListener("mousedown",re),document.addEventListener("touchstart",re)),()=>{document.removeEventListener("mousedown",re),document.removeEventListener("touchstart",re)}),[I,re]),o.useCallback(()=>_?"50px":Te?"320px":d&&I?"240px":d&&!I?"60px":I?"280px":"80px",[_,d,I,he,Te]);const at=o.useCallback(()=>"calc(16px + env(safe-area-inset-bottom, 0px))",[]);o.useEffect(()=>{const e=()=>{Qe(s=>s+1)};return window.addEventListener("resize",e),window.addEventListener("orientationchange",e),e(),()=>{window.removeEventListener("resize",e),window.removeEventListener("orientationchange",e)}},[]),o.useCallback(e=>{if(e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.closest("iframe"))return;const s=e.touches[0],t=Date.now();ae({isActive:!0,startY:s.clientY,currentY:s.clientY,startTime:t,isDragging:!1,initialDrawerState:I})},[I]),o.useCallback(e=>{if(!N.isActive||e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.closest("iframe"))return;const s=e.touches[0],t=N.startY-s.clientY,r=Math.abs(t);!N.isDragging&&r>10&&(ae(l=>({...l,isDragging:!0})),e.preventDefault()),N.isDragging&&(ae(l=>({...l,currentY:s.clientY})),e.preventDefault())},[N]),o.useCallback(e=>{if(!N.isActive)return;if(e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.closest("iframe")){ae({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1});return}const s=N.startY-N.currentY,t=Math.abs(s),r=Date.now()-N.startTime,l=t/r,c=30,f=.5,W=50;let R=!1;if(N.isDragging&&((l>f||t>c||t>W)&&(R=!0),R)){const E=Se.current;E&&(E.classList.remove("momentum-fast","momentum-slow"),l>f?E.classList.add("momentum-fast"):E.classList.add("momentum-slow"),setTimeout(()=>{E&&E.classList.remove("momentum-fast","momentum-slow")},250)),s>0?I||(M(!0),z(!1)):I&&M(!1)}ae({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1})},[N,I]),o.useCallback(()=>{_?(z(!1),M(L.expanded||!0),U(L.showDisclaimer),O(L.showVerification),L.verificationCode&&(ie(L.verificationCode),L.verificationCode.length===4&&A("filled")),L.phoneNumber&&C(L.phoneNumber)):I||(M(!0),L.showDisclaimer&&!d&&U(!0))},[_,I,L,d]),o.useCallback(e=>{e.stopPropagation(),_&&z(!1),M(!0),De(!0),setTimeout(()=>{De(!1)},1e4)},[_]),o.useCallback(()=>{we(!0)},[]),o.useCallback(()=>{we(!1)},[]),o.useCallback(()=>{we(!1)},[]),o.useEffect(()=>{const e=document.querySelector('meta[name="viewport"]'),s=e?e.getAttribute("content"):"";let t=document.querySelector('meta[name="viewport"]');t||(t=document.createElement("meta"),t.name="viewport",document.head.appendChild(t)),t.content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover, shrink-to-fit=no";const r=(W,R)=>{let E=document.querySelector(`meta[name="${W}"]`);E||(E=document.createElement("meta"),E.name=W,document.head.appendChild(E)),E.content=R};r("apple-mobile-web-app-capable","yes"),r("apple-mobile-web-app-status-bar-style","black-translucent"),r("apple-touch-fullscreen","yes"),r("mobile-web-app-capable","yes"),r("format-detection","telephone=no"),document.documentElement.style.webkitTextSizeAdjust="100%",document.documentElement.style.textSizeAdjust="100%";let l=null,c=null;const f=()=>{l&&cancelAnimationFrame(l),c&&clearTimeout(c),c=setTimeout(()=>{l=requestAnimationFrame(()=>{const W=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${W}px`)})},100)};return f(),window.addEventListener("resize",f,{passive:!0}),window.addEventListener("orientationchange",f,{passive:!0}),()=>{e&&s&&e.setAttribute("content",s),window.removeEventListener("resize",f),window.removeEventListener("orientationchange",f),l&&cancelAnimationFrame(l),c&&clearTimeout(c)}},[]);const rt=o.useMemo(()=>{const e="https://www.youtube.com/embed/vEHTO3gf1jk",r={...{autoplay:"1",mute:"1",controls:"0",showinfo:"0",rel:"0",loop:"1",playlist:"vEHTO3gf1jk",modestbranding:"1",iv_load_policy:"3",fs:"0",disablekb:"1",hd:"1",cc_load_policy:"0",autohide:"1",wmode:"transparent",enablejsapi:"1",origin:window.location.origin},...{vq:me,quality:me}},l=Object.entries(r).map(([f,W])=>`${f}=${W}`).join("&"),c=`${e}?${l}`;return console.log("🎥 YouTube URL built:",{videoQuality:me,connectionSpeed:Re,finalURL:c}),c},[me,Re]),Ue=o.useCallback(()=>{n(!1),u(!0),a("video_interaction",{action:"thumbnail_click",video_id:"vEHTO3gf1jk",component:"FigmaMobile"})},[a]),st=o.useMemo(()=>i.jsx("div",{onClick:Ue,style:{position:"absolute",top:"0",left:"0",width:"100%",height:"100%",cursor:"pointer",backgroundImage:"url(https://img.youtube.com/vi/vEHTO3gf1jk/maxresdefault.jpg)",backgroundSize:"cover",backgroundPosition:"center",backgroundRepeat:"no-repeat",transform:"translateZ(0)",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden",transition:"transform 0.2s ease-out"},onMouseDown:e=>{e.currentTarget.style.transform="translateZ(0) scale(0.98)"},onMouseUp:e=>{e.currentTarget.style.transform="translateZ(0) scale(1)"},onMouseLeave:e=>{e.currentTarget.style.transform="translateZ(0) scale(1)"},onTouchStart:e=>{e.currentTarget.style.transform="translateZ(0) scale(0.98)"},onTouchEnd:e=>{e.currentTarget.style.transform="translateZ(0) scale(1)"}}),[Ue]);return fe?i.jsx(lt,{fullScreen:!0,minDisplayTime:600,showMessage:!1}):i.jsxs(i.Fragment,{children:[i.jsx(ut,{events:[...Ve,...Je],domain:"bounce2bounce.com"}),i.jsx("link",{rel:"stylesheet",href:"/css/mobile-scroll-fix.css"}),i.jsx("style",{children:`
