const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DitherShadcn-B_y5Q02e.js","assets/index-CIsck3KZ.js","assets/vendor-ViNJc2wV.js","assets/index-BPM0BZxC.css"])))=>i.map(i=>d[i]);
import{j as t,_ as o}from"./index-CIsck3KZ.js";import{b as a}from"./vendor-ViNJc2wV.js";import{l as i}from"./productionDebug-ZprwcnaH.js";const n=a.lazy(()=>o(()=>import("./DitherShadcn-B_y5Q02e.js"),__vite__mapDeps([0,1,2,3])).then(r=>({default:r.Dither}))),s=()=>t.jsx("div",{style:{position:"absolute",top:0,left:0,width:"100%",height:"100%",zIndex:1,background:`
