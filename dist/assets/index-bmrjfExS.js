const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FigmaMobile-gZmimuPj.js","assets/MobileDrawer-CFMzFk69.js"])))=>i.map(i=>d[i]);
...
!e.current&&n&&"function"==typeof n.isEnabled&&n.isEnabled()&&(e.current=!0)},[])
const n=S.useCallback(e=>{!function(e){R&&R.sendEvent(e)}(e)},[]),t=S.useCallback((e,n="")=>{const t=i()
t&&"function"==typeof t.isEnabled&&t.isEnabled()&&t.trackLinkClick(e,n)},[]),r=S.useCallback((e,n={})=>{const t=i()
t&&"function"==typeof t.isEnabled&&t.isEnabled()&&t.sendEvent({event:e,properties:n,timestamp:Date.now()})},[]),o=i()
return{track:n,trackLinkClick:t,trackEvent:r,isTrackingEnabled:!(!o||"function"!=typeof o.isEnabled)&&o.isEnabled()}}
var B,U
