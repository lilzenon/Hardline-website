import{j as i,B as ct}from"./index-ZRVvjhmy.js";import{b as n}from"./vendor-ViNJc2wV.js";import{u as dt,a as mt,M as pt}from"./useNavHeight-DxWufA3-.js";import{u as gt,a as ut,E as bt}from"./HomePage-CCR7tkmK.js";import{S as ht}from"./SocialMediaButtons-BE73Dd-Q.js";import{F as ft}from"./Footer-BlhI4nXB.js";import{i as xt}from"./breadcrumbSchema-BG74ATTs.js";import"./beacon-BB01f5iw.js";import"./mobileOptimization-ILGdA5i5.js";import"./sanitizer-3HkbNTkh.js";const yt=({dropId:a,color:p="ff0409",theme:k="dark",background:g="solid",minimal:o=!0,style:E={},visible:d=!0})=>{const[X,Te]=n.useState(0),[j,z]=n.useState(0),V=n.useRef(0),h=n.useRef(null),_=n.useRef(!1),P=2,G=7e3,q=n.useMemo(()=>{if(typeof navigator>"u")return!1;const f=navigator.userAgent,b=/AppleWebKit/i.test(f),m=/iP(hone|od|ad)|Mobile/i.test(f),I=/CriOS/i.test(f),ae=/FxiOS/i.test(f);return b&&m&&!I&&!ae},[]),[ee,u]=n.useState(null),x=n.useRef(d),T=n.useRef(0),F=1e3,W=f=>(f||"")+((f||"").includes("?")?"&":"?")+"_ts="+Date.now(),y=n.useMemo(()=>a?`https://embed.laylo.com/?${new URLSearchParams({dropId:a,color:p,theme:k,background:g,...o&&{minimal:"true"}}).toString()}`:null,[a,p,k,g,o]),D=(f,b)=>{const m=new Date().toISOString();console.log(`[LayloSimple ${m}] ${f}`,b??"")};n.useEffect(()=>{const f=!x.current&&d;if(!d){h.current&&(clearTimeout(h.current),h.current=null),x.current=d;return}if(!f){x.current=d;return}if(z(0),V.current=Date.now(),_.current=!1,D("Visible -> ensuring iframe src",{retryCount:0,url:y}),q){u(null);const b=setTimeout(()=>{const m=W(y);T.current=Date.now(),u(m)},180);return x.current=d,()=>{clearTimeout(b),h.current&&(clearTimeout(h.current),h.current=null)}}else ee||(T.current=Date.now(),u(y));x.current=d},[d,y,q,ee]),n.useEffect(()=>{if(!q)return;const f=m=>{if(m.persisted&&d){const I=Date.now();I-T.current>F&&(D("pageshow (persisted) -> refreshing iframe src (iOS)"),T.current=I,_.current=!1,u(null),setTimeout(()=>{u(W(y))},180))}},b=()=>{if(document.visibilityState==="visible"&&d){const m=Date.now();m-T.current>F&&(D("visibilitychange -> visible; refreshing iframe src (iOS)"),T.current=m,u(I=>I??W(y)))}};return window.addEventListener("pageshow",f),document.addEventListener("visibilitychange",b),()=>{window.removeEventListener("pageshow",f),document.removeEventListener("visibilitychange",b)}},[q,d,y]);const de=()=>{const f=Date.now()-(V.current||0);_.current=!0,h.current&&(clearTimeout(h.current),h.current=null),D("Iframe onLoad fired",{elapsedMs:f})},O=f=>{if(D("Iframe onError",{error:f}),h.current&&(clearTimeout(h.current),h.current=null),j<P){D("Error -> retry (src bust)",{retryCount:j+1}),z(m=>m+1);const b=Date.now();b-T.current>F&&(T.current=b,V.current=Date.now(),_.current=!1,u(W(y)))}else D("Final error -> giving up after max retries")};return n.useEffect(()=>{if(!(!d||!ee))return h.current&&(clearTimeout(h.current),h.current=null),V.current=Date.now(),h.current=setTimeout(()=>{if(!_.current)if(j<P){D("Load timeout -> retry (src bust)",{retryCount:j+1}),z(b=>b+1);const f=Date.now();f-T.current>F&&(T.current=f,u(W(y)))}else D("Final load timeout -> giving up after max retries")},G),()=>{h.current&&(clearTimeout(h.current),h.current=null)}},[ee,d,j,y]),a?d?i.jsx("iframe",{id:`laylo-drop-${a}`,title:"Laylo Signup",width:"100%",height:"100%",frameBorder:"0",scrolling:"no",allow:"web-share; clipboard-write; fullscreen; autoplay; encrypted-media; picture-in-picture",loading:"eager",onLoad:de,onError:O,style:{...E,WebkitTransform:"translateZ(0)",transform:"translateZ(0)",display:"block"},src:ee??y},X):i.jsx("div",{style:{...E}}):i.jsx("div",{style:{...E,display:"flex",alignItems:"center",justifyContent:"center",minHeight:60},children:i.jsx("span",{style:{color:"#999",fontSize:14},children:"[LayloSimple] Missing dropId"})})},be=(a,p=null)=>{if(!a)return a;if(typeof a=="string"&&a.startsWith("data:"))return console.log("⚠️ Data URL detected, returning as-is:",a.substring(0,50)+"..."),a;const k=/iPad|iPhone|iPod/.test(navigator.userAgent)&&/Safari/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent);if(typeof a=="string"&&a.includes("/api/images/serve/")){console.log("🔄 Processing new image system URL:",a);const g=a.match(/\/api\/images\/serve\/([a-f0-9-]{36})/);if(g){const o=g[1],E=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click";let d="small";p&&(p<=150?d="thumbnail":p<=300?d="small":p<=600?d="medium":(p<=1200,d="large"));const X=`${E}/api/images/serve/${o}/${d}`;return console.log("✅ Generated optimized URL for new image system:",X,`(variant: ${d}, width: ${p})`),X}}if(typeof a=="string"&&a.includes("/images/figma-exact/")){const g=a.split("/").pop();return k&&g.includes(".webp")?`/images/optimized/${g.replace(".webp",".jpg")}`:`/images/optimized/${g}`}if(typeof a=="string"&&a.startsWith("http")){const g=encodeURIComponent(a),E=`${window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click"}/images/proxy-optimized?url=${g}`,d=k?"&format=jpeg&quality=85":"";return p?`${E}&w=${p}${d}`:`${E}${d}`}if(typeof a=="string"&&a.startsWith("/")&&(a.includes("/api/images/serve/")||!a.includes("/images/"))){console.log("🔄 Processing relative URL, assuming new image system:",a);const g=a.match(/([a-f0-9-]{36})/);if(g){const o=g[1],d=`${window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click"}/api/images/serve/${o}/medium`;return console.log("✅ Generated URL for UUID-based relative path:",d),d}}if(typeof a=="string"&&(a.includes("/images/")||a.includes("/custom/images/"))){const o=a.split("/").pop().replace(/\.[^/.]+$/,"");return p?`/images/optimized/${o}-${p}w.webp`:`/images/optimized/${o}.webp`}return console.log("⚠️ No optimization applied to URL:",a),a},Ye=a=>a==="event"?[150,300,450]:a==="hero"?[600,900,1200]:[150,300,600],vt=(a,p="event")=>a?Ye(p).map(k=>`${be(a,k)} ${k}w`).join(", "):"",wt=(a,p="event")=>{if(!a||/iPhone|iPad|iPod/.test(navigator.userAgent)&&/Safari/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent))return"";if(typeof a=="string"&&(a.includes("/api/images/serve/")||a.includes("/api/settings/serve/")||a.startsWith("/api/")))return console.log("🚫 Skipping AVIF for internal API URL to prevent loop:",a),"";const g=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click";return Ye(p).map(o=>`${g}/images/proxy-optimized?url=${encodeURIComponent(a)}&w=${o}&format=avif ${o}w`).join(", ")},he=[{id:"us",code:"+1",name:"United States",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"(555) 123-4567",maxLength:14,digitLength:10},{id:"ca",code:"+1",name:"Canada",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"(555) 123-4567",maxLength:14,digitLength:10},{id:"gb",code:"+44",name:"United Kingdom",flag:"data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjEiIGhlaWdodD0iMTUiIHZpZXdCb3g9IjAgMCAyMSAxNSIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPHJlY3Qgd2lkdGg9IjIxIiBoZWlnaHQ9IjE1IiBmaWxsPSIjMDEyMTY5Ii8+CjxwYXRoIGQ9Ik0wIDBoMjF2MTVIMHoiIGZpbGw9IiMwMTIxNjkiLz4KPC9zdmc+",pattern:/^\d{10,11}$/,placeholder:"7911 123456",maxLength:13,digitLength:11},{id:"au",code:"+61",name:"Australia",flag:"data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjEiIGhlaWdodD0iMTUiIHZpZXdCb3g9IjAgMCAyMSAxNSIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPHJlY3Qgd2lkdGg9IjIxIiBoZWlnaHQ9IjE1IiBmaWxsPSIjMDEyMTY5Ii8+PC9zdmc+",pattern:/^\d{9}$/,placeholder:"412 345 678",maxLength:11,digitLength:9},{id:"de",code:"+49",name:"Germany",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"30 12345678",maxLength:13,digitLength:11},{id:"fr",code:"+33",name:"France",flag:"data:image/svg+xml;base64,",pattern:/^\d{9}$/,placeholder:"6 12 34 56 78",maxLength:12,digitLength:9},{id:"es",code:"+34",name:"Spain",flag:"data:image/svg+xml;base64,",pattern:/^\d{9}$/,placeholder:"612 34 56 78",maxLength:11,digitLength:9},{id:"it",code:"+39",name:"Italy",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"312 345 6789",maxLength:12,digitLength:10},{id:"jp",code:"+81",name:"Japan",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"90 1234 5678",maxLength:13,digitLength:11},{id:"kr",code:"+82",name:"South Korea",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"10 1234 5678",maxLength:13,digitLength:11},{id:"cn",code:"+86",name:"China",flag:"data:image/svg+xml;base64,",pattern:/^\d{11}$/,placeholder:"138 0013 8000",maxLength:13,digitLength:11},{id:"in",code:"+91",name:"India",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"98765 43210",maxLength:12,digitLength:10},{id:"br",code:"+55",name:"Brazil",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"11 91234 5678",maxLength:14,digitLength:11},{id:"mx",code:"+52",name:"Mexico",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"55 1234 5678",maxLength:12,digitLength:10}],Ve=(a,p)=>{const k=typeof a=="string"?a.replace(/[^\d]/g,""):"",g=he.find(E=>E.id===p);if(!g||k.length===0)return k;const o=k.slice(0,g.digitLength);switch(p){case"us":case"ca":return o.length<=3?o:o.length<=6?`(${o.slice(0,3)}) ${o.slice(3)}`:`(${o.slice(0,3)}) ${o.slice(3,6)}-${o.slice(6)}`;case"gb":return o.length<=4?o:o.length<=7?`${o.slice(0,4)} ${o.slice(4)}`:`${o.slice(0,4)} ${o.slice(4,7)} ${o.slice(7)}`;case"jp":case"kr":return o.length<=2?o:o.length<=6?`${o.slice(0,2)} ${o.slice(2)}`:`${o.slice(0,2)} ${o.slice(2,6)} ${o.slice(6)}`;case"cn":return o.length<=3?o:o.length<=7?`${o.slice(0,3)} ${o.slice(3)}`:`${o.slice(0,3)} ${o.slice(3,7)} ${o.slice(7)}`;case"in":return o.length<=5?o:`${o.slice(0,5)} ${o.slice(5)}`;case"br":return o.length<=2?o:o.length<=7?`${o.slice(0,2)} ${o.slice(2)}`:`${o.slice(0,2)} ${o.slice(2,7)} ${o.slice(7)}`;case"mx":return o.length<=2?o:o.length<=6?`${o.slice(0,2)} ${o.slice(2)}`:`${o.slice(0,2)} ${o.slice(2,6)} ${o.slice(6)}`;default:return o.length<=3?o:o.length<=6?`${o.slice(0,3)} ${o.slice(3)}`:`${o.slice(0,3)} ${o.slice(3,6)} ${o.slice(6)}`}},It=(a,p)=>{const k=a.replace(/[^\d]/g,""),g=he.find(o=>o.id===p);return g?g.pattern.test(k):k.length>=10&&k.length<=15},je=a=>he.find(p=>p.id===a)||he[0],Pt=()=>{const{trackEvent:a}=gt(),[p,k]=n.useState(!1);n.useCallback(e=>{k(e),e&&a("privacy_consent",{action:"granted",timestamp:Date.now(),component:"PrivacyConsentModal"})},[a]);const[g,o]=n.useState(!0),[E,d]=n.useState(!1);n.useEffect(()=>{setTimeout(()=>{o(!1),d(!0)},2e3),a("component_load",{component:"FigmaMobile",viewport_type:"mobile"})},[a]),n.useEffect(()=>{xt("homepage")},[]),n.useEffect(()=>{if(!document.querySelector('script[src="https://embed.laylo.com/laylo-sdk.js"]')){const e=document.createElement("script");e.src="https://embed.laylo.com/laylo-sdk.js",e.async=!0,e.defer=!0,e.onerror=s=>{console.warn("⚠️ Laylo SDK failed to load in FigmaMobile:",s)},e.onload=()=>{console.log("✅ Laylo SDK script loaded successfully in FigmaMobile")},document.head.appendChild(e)}},[]);const[X,Te]=n.useState(!1),[j,z]=n.useState(""),[V,h]=n.useState(!1),[_,P]=n.useState(!1),[G,q]=n.useState("us"),[ee,u]=n.useState("normal"),[x,T]=n.useState(!1),[F,W]=n.useState(""),[y,D]=n.useState(""),[de,O]=n.useState(!1),[f,b]=n.useState("normal"),[m,I]=n.useState(!1),[ae,Y]=n.useState(!1),[te,L]=n.useState(!1),[De,Ee]=n.useState(!1);n.useState(!1);const[Ce,re]=n.useState(0),[me,se]=n.useState(!1),[Ae,Ne]=n.useState(!1),[N,le]=n.useState({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1}),{loading:fe,homeSettings:pe,showAllEvents:M,setShowAllEvents:xe,filteredFeaturedEvents:U,filteredHomepageEvents:ie,featuredEvents:Je,homepageEvents:Qe,normalizeEvent:ze}=ut(),[St,Ke]=n.useState(0),[ne,Xe]=n.useState(!1),[$,_e]=n.useState(!1),[C,Le]=n.useState(null),[Ze,Pe]=n.useState(!1),Fe=n.useCallback((e,s)=>{if(Ze)return;Pe(!0);let t=e.coverImage;t&&!t.startsWith("http")&&(t=`${window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click"}${t}`),t&&(t=t.replace(/[?&](w|width|h|height|size)=\d+/g,""),t=t.replace(/[?&]$/,"")),Le({...e,imageUrl:t||e.coverImage,originalRect:s?.getBoundingClientRect()||null}),setTimeout(()=>{Pe(!1)},400)},[Ze]),We=n.useCallback(()=>{Le(null)},[]),S=n.useRef({scrollY:0,locked:!1,prevent:void 0,prevBodyPosition:"",prevBodyTop:"",prevBodyWidth:"",prevBodyOverflow:"",prevBodyTouchAction:""}),Re=n.useCallback(()=>{if(S.current.locked)return;const e=window.scrollY||window.pageYOffset||0;S.current.scrollY=e;const s=r=>{r&&typeof r.preventDefault=="function"&&r.preventDefault(),r&&typeof r.stopPropagation=="function"&&r.stopPropagation()};S.current.prevent=s,document.documentElement.style.overscrollBehavior="none";const t=document.body;S.current.prevBodyPosition=t.style.position||"",S.current.prevBodyTop=t.style.top||"",S.current.prevBodyWidth=t.style.width||"",S.current.prevBodyOverflow=t.style.overflow||"",S.current.prevBodyTouchAction=t.style.touchAction||"",t.style.position="fixed",t.style.top=`-${e}px`,t.style.width="100%",t.style.overflow="hidden",t.style.touchAction="none",window.addEventListener("wheel",s,{passive:!1,capture:!0}),window.addEventListener("touchmove",s,{passive:!1,capture:!0}),S.current.locked=!0},[]),ye=n.useCallback(()=>{if(!S.current.locked)return;const e=document.body;e.style.position=S.current.prevBodyPosition,e.style.top=S.current.prevBodyTop,e.style.width=S.current.prevBodyWidth,e.style.overflow=S.current.prevBodyOverflow,e.style.touchAction=S.current.prevBodyTouchAction,document.documentElement.style.overscrollBehavior="",S.current.prevent&&(window.removeEventListener("wheel",S.current.prevent,{capture:!0}),window.removeEventListener("touchmove",S.current.prevent,{capture:!0}));const s=S.current.scrollY||0;window.scrollTo(0,s),S.current.locked=!1},[]);n.useEffect(()=>{if(C)return Re(),()=>{ye()};ye()},[C,Re,ye]);const[ge,J]=n.useState("hd720"),[He,Q]=n.useState("fast"),[Z,ve]=n.useState({expanded:!1,showDisclaimer:!1,showVerification:!1,verificationCode:"",phoneNumber:""}),Be=n.useCallback(()=>{ve({expanded:m,showDisclaimer:ae,showVerification:x,verificationCode:F,phoneNumber:j}),console.log("💾 Drawer state saved, iframe content preserved")},[m,ae,x,F,j]),[kt,we]=n.useState(!1),R=n.useRef(null),Ie=n.useRef(null),v=n.useRef(null),ue=n.useRef(!0),Se=n.useRef(null),ke=n.useRef(null),qe=dt(),et=Math.max(qe||0,0)+12,{scrollY:tt}=mt(ke.current,{threshold:20,throttleMs:32,passive:!0});n.useEffect(()=>{const e=document.body,s=ke.current;if(m){const t=window.scrollY;e.classList.add("drawer-scroll-lock"),e.style.top=`-${t}px`,s&&s.classList.add("drawer-active")}else{const t=e.style.top;e.classList.remove("drawer-scroll-lock"),e.style.top="",t&&window.scrollTo(0,parseInt(t||"0")*-1),s&&s.classList.remove("drawer-active")}return()=>{e.classList.remove("drawer-scroll-lock"),e.style.top="",s&&s.classList.remove("drawer-active")}},[m]),n.useCallback(e=>{const s=e.target.value,t=je(G),r=s.replace(/[^\d]/g,"");if(r.length>t.digitLength)return;const l=Ve(r,G);z(l)},[G]),n.useCallback(e=>{e.key==="Enter"&&it()},[]),n.useCallback(e=>{const s=e.target.value,t=je(s);if(q(s),Ie.current&&t.flag&&(Ie.current.src=t.flag,Ie.current.alt=t.name),j){const r=j.replace(/[^\d]/g,""),l=Ve(r,s);z(l)}console.log(`🌍 Country changed to: ${t.code} (${t.name})`)},[j]);const it=n.useCallback(async()=>{const e=j.trim();if(!e||V)return;if(e.replace(/\D/g,"")==="5555555555"){console.log("🧪 Test number detected - showing loading then verification UI"),h(!0),u("loading"),setTimeout(()=>{u("valid"),D(e),h(!1),setTimeout(()=>{T(!0),I(!0)},200)},800);return}const r=je(G);if(!It(e,G)){console.warn("Invalid phone number format for",r.name),u("invalid"),R.current&&(R.current.classList.add("shake"),setTimeout(()=>{R.current?.classList.remove("shake"),u("normal")},400));return}try{h(!0),u("loading"),console.log("📱 Submitting phone number:",{phone:e,countryCode:r.code});const l=window.location.hostname==="localhost"?"":"https://admin.b2b.click",c=await fetch(`${l}/api/home-settings/submit-phone`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:e,countryCode:r.code})}),w=await c.json();c.ok&&w.success?(console.log("✅ Phone number submitted successfully"),w.requiresVerification?(console.log("🔐 Moving to verification step"),u("normal"),D(e),setTimeout(()=>{T(!0),I(!0)},500)):(P(!0),u("valid"),z(""),setTimeout(()=>{P(!1),u("normal")},3e3))):(console.error("❌ Failed to submit phone number:",w.error||"Unknown error"),u("invalid"),R.current&&(R.current.classList.add("shake"),setTimeout(()=>{R.current?.classList.remove("shake"),u("normal")},400)))}catch(l){console.error("❌ Error submitting phone number:",l),u("invalid"),R.current&&(R.current.classList.add("shake"),setTimeout(()=>{R.current?.classList.remove("shake"),u("normal")},400))}finally{h(!1)}},[j,V,G]);n.useCallback(async()=>{const e=F.trim();if(!e||de)return;if(y.replace(/\D/g,"")==="5555555555"&&(console.log("🧪 Test verification - accepting any 4-digit code"),e.length===4)){O(!0),u("loading"),setTimeout(()=>{b("valid"),P(!0),O(!1)},1e3),setTimeout(()=>{L(!0),T(!1),I(!1),Y(!1)},2e3),setTimeout(()=>{W(""),D(""),z(""),P(!1),u("normal"),b("normal"),O(!1),L(!1),re(0),se(!1),v.current&&(clearInterval(v.current),v.current=null),ve({expanded:!1,showDisclaimer:!1,showVerification:!1,verificationCode:"",phoneNumber:""})},5e3);return}if(!/^\d{4}$/.test(e)){console.warn("Invalid verification code format"),b("invalid"),setTimeout(()=>{b("filled")},400);return}try{O(!0),u("loading"),console.log("🔐 Submitting verification code");const r=window.location.hostname==="localhost"?"":"https://admin.b2b.click",l=await fetch(`${r}/api/home-settings/verify-phone`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:y,code:e})}),c=await l.json();l.ok&&c.success?(console.log("✅ Phone verification successful"),b("valid"),P(!0),setTimeout(()=>{L(!0),T(!1),I(!1),Y(!1)},2e3),setTimeout(()=>{W(""),D(""),z(""),P(!1),u("normal"),b("normal"),O(!1),L(!1),re(0),se(!1),v.current&&(clearInterval(v.current),v.current=null),ve({expanded:!1,showDisclaimer:!1,showVerification:!1,verificationCode:"",phoneNumber:""})},5e3)):(console.error("❌ Phone verification failed:",c.error||"Unknown error"),b("invalid"),setTimeout(()=>{b("filled")},400))}catch(r){console.error("❌ Error submitting verification code:",r),b("invalid"),setTimeout(()=>{b("filled")},400)}finally{O(!1)}},[F,de,y]);const oe=n.useCallback(()=>{console.log("🚀 Starting countdown timer"),v.current&&(clearInterval(v.current),v.current=null),re(60),se(!1),v.current=setInterval(()=>{if(!ue.current){v.current&&(clearInterval(v.current),v.current=null);return}re(e=>(console.log("⏰ Countdown tick:",e),e<=1?(console.log("✅ Countdown finished, enabling resend"),ue.current&&se(!0),v.current&&(clearInterval(v.current),v.current=null),0):e-1))},1e3)},[]);n.useCallback(async()=>{if(!(!me||Ae||!y))try{Ne(!0),console.log("🔄 Resending verification code to:",y);const e=window.location.hostname==="localhost"?"":"https://admin.b2b.click",t=await(await fetch(`${e}/api/home-settings/resend-verification`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phoneNumber:y})})).json();t.success?(console.log("✅ Verification code resent successfully"),oe()):(console.error("❌ Failed to resend verification code:",t.error),oe())}catch(e){console.error("❌ Error resending verification code:",e),oe()}finally{Ne(!1)}},[me,Ae,y,oe]),n.useEffect(()=>(ue.current=!0,()=>{ue.current=!1,v.current&&(clearInterval(v.current),v.current=null)}),[]),n.useEffect(()=>{!x&&v.current&&(clearInterval(v.current),v.current=null,re(0),se(!1))},[x]),n.useEffect(()=>{console.log("🔄 Countdown useEffect triggered:",{showVerification:x,verificationPhone:y,resendCountdown:Ce,canResend:me}),x&&y&&Ce===0&&!me&&(console.log("🚀 Starting resend countdown"),oe())},[x,y,oe]),n.useEffect(()=>{fe||(setTimeout(()=>{Xe(!0)},150),setTimeout(()=>{_e(!0)},300))},[fe]),n.useEffect(()=>{const e=setTimeout(()=>{L(!1),I(!1)},500);return()=>clearTimeout(e)},[]),n.useEffect(()=>{const s=setTimeout(()=>{if("connection"in navigator){const l=navigator.connection||navigator.mozConnection||navigator.webkitConnection;if(l){const c=l.effectiveType,w=l.downlink;console.log("🌐 Connection detected:",{effectiveType:c,downlink:w}),c==="4g"&&w>5?(J("hd1080"),Q("fast")):c==="4g"||c==="3g"&&w>2?(J("hd720"),Q("medium")):(J("large"),Q("slow"));return}}const t=performance.now(),r=new Image;r.onload=()=>{const c=performance.now()-t;console.log("🚀 Speed test completed in:",c+"ms"),c<200?(J("hd1080"),Q("fast")):c<500?(J("hd720"),Q("medium")):(J("large"),Q("slow"))},r.onerror=()=>{console.log("⚠️ Speed test failed, using default HD quality"),J("hd720"),Q("medium")},r.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"},200);return()=>clearTimeout(s)},[]),n.useEffect(()=>{if(U&&U.length>0){console.log("🚀 Preloading critical event images for instant display...");const e=/iPhone|iPad|iPod/.test(navigator.userAgent)&&/Safari/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent);U.slice(0,2).forEach((s,t)=>{if(s.coverImage){if(!e&&!s.coverImage.includes("/api/images/serve/")){const l=document.createElement("link");l.rel="preload",l.as="image",l.type="image/avif";const c=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click";l.href=`${c}/images/proxy-optimized?url=${encodeURIComponent(s.coverImage)}&w=120&format=avif`,document.head.appendChild(l)}const r=document.createElement("link");if(r.rel="preload",r.as="image",r.type="image/webp",r.href=be(s.coverImage,300),document.head.appendChild(r),e){const l=document.createElement("link");l.rel="preload",l.as="image",l.href=s.coverImage,document.head.appendChild(l)}console.log(`✅ Preloaded mobile event image ${t+1}: ${s.title} ${e?"(Safari mobile optimized)":""}`)}})}},[U]);const[K,Ge]=n.useState(!1),[Mt,Me]=n.useState(!1),Oe=()=>{K?(Ge(!1),Me(!1)):(Me(!0),Ge(!0),setTimeout(()=>Me(!1),600))},Ue=()=>{const e=window.location.pathname;return e==="/"||e===""?"events":e.startsWith("/about")?"about":e.startsWith("/contact")?"contact":"events"},[nt,ot]=n.useState(Ue());n.useEffect(()=>{const e=()=>{ot(Ue())};return window.addEventListener("popstate",e),e(),()=>{window.removeEventListener("popstate",e)}},[]);const at=e=>{if(e==="/"){window.scrollTo({top:0,behavior:"smooth"});return}window.location.href=e};n.useCallback(()=>{I(!0),Y(!0)},[]),n.useCallback(()=>{!j.trim()&&!x&&setTimeout(()=>{I(!1),Y(!1)},200)},[j,x]);const ce=n.useCallback(e=>{Se.current&&!Se.current.contains(e.target)&&(Be(),I(!1),x?L(!1):(L(!1),Y(!1)))},[j,x,Be]);n.useEffect(()=>(m&&(document.addEventListener("mousedown",ce),document.addEventListener("touchstart",ce)),()=>{document.removeEventListener("mousedown",ce),document.removeEventListener("touchstart",ce)}),[m,ce]),n.useCallback(()=>te?"50px":De?"320px":x&&m?"240px":x&&!m?"60px":m?"280px":"80px",[te,x,m,ae,De]);const rt=n.useCallback(()=>"calc(16px + env(safe-area-inset-bottom, 0px))",[]);n.useEffect(()=>{const e=()=>{Ke(s=>s+1)};return window.addEventListener("resize",e),window.addEventListener("orientationchange",e),e(),()=>{window.removeEventListener("resize",e),window.removeEventListener("orientationchange",e)}},[]),n.useCallback(e=>{if(e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.closest("iframe"))return;const s=e.touches[0],t=Date.now();le({isActive:!0,startY:s.clientY,currentY:s.clientY,startTime:t,isDragging:!1,initialDrawerState:m})},[m]),n.useCallback(e=>{if(!N.isActive||e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.closest("iframe"))return;const s=e.touches[0],t=N.startY-s.clientY,r=Math.abs(t);!N.isDragging&&r>10&&(le(l=>({...l,isDragging:!0})),e.preventDefault()),N.isDragging&&(le(l=>({...l,currentY:s.clientY})),e.preventDefault())},[N]),n.useCallback(e=>{if(!N.isActive)return;if(e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.closest("iframe")){le({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1});return}const s=N.startY-N.currentY,t=Math.abs(s),r=Date.now()-N.startTime,l=t/r,c=30,w=.5,H=50;let B=!1;if(N.isDragging&&((l>w||t>c||t>H)&&(B=!0),B)){const A=Se.current;A&&(A.classList.remove("momentum-fast","momentum-slow"),l>w?A.classList.add("momentum-fast"):A.classList.add("momentum-slow"),setTimeout(()=>{A&&A.classList.remove("momentum-fast","momentum-slow")},250)),s>0?m||(I(!0),L(!1)):m&&I(!1)}le({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1})},[N,m]),n.useCallback(()=>{te?(L(!1),I(Z.expanded||!0),Y(Z.showDisclaimer),T(Z.showVerification),Z.verificationCode&&(W(Z.verificationCode),Z.verificationCode.length===4&&b("filled")),Z.phoneNumber&&z(Z.phoneNumber)):m||(I(!0),Z.showDisclaimer&&!x&&Y(!0))},[te,m,Z,x]),n.useCallback(e=>{e.stopPropagation(),te&&L(!1),I(!0),Ee(!0),setTimeout(()=>{Ee(!1)},1e4)},[te]),n.useCallback(()=>{we(!0)},[]),n.useCallback(()=>{we(!1)},[]),n.useCallback(()=>{we(!1)},[]),n.useEffect(()=>{const e=document.querySelector('meta[name="viewport"]'),s=e?e.getAttribute("content"):"";let t=document.querySelector('meta[name="viewport"]');t||(t=document.createElement("meta"),t.name="viewport",document.head.appendChild(t)),t.content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover, shrink-to-fit=no";const r=(H,B)=>{let A=document.querySelector(`meta[name="${H}"]`);A||(A=document.createElement("meta"),A.name=H,document.head.appendChild(A)),A.content=B};r("apple-mobile-web-app-capable","yes"),r("apple-mobile-web-app-status-bar-style","black-translucent"),r("apple-touch-fullscreen","yes"),r("mobile-web-app-capable","yes"),r("format-detection","telephone=no"),document.documentElement.style.webkitTextSizeAdjust="100%",document.documentElement.style.textSizeAdjust="100%";let l=null,c=null;const w=()=>{l&&cancelAnimationFrame(l),c&&clearTimeout(c),c=setTimeout(()=>{l=requestAnimationFrame(()=>{const H=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${H}px`)})},100)};return w(),window.addEventListener("resize",w,{passive:!0}),window.addEventListener("orientationchange",w,{passive:!0}),()=>{e&&s&&e.setAttribute("content",s),window.removeEventListener("resize",w),window.removeEventListener("orientationchange",w),l&&cancelAnimationFrame(l),c&&clearTimeout(c)}},[]);const st=n.useMemo(()=>{const e="https://www.youtube.com/embed/vEHTO3gf1jk",r={...{autoplay:"1",mute:"1",controls:"0",showinfo:"0",rel:"0",loop:"1",playlist:"vEHTO3gf1jk",modestbranding:"1",iv_load_policy:"3",fs:"0",disablekb:"1",hd:"1",cc_load_policy:"0",autohide:"1",wmode:"transparent",enablejsapi:"1",origin:window.location.origin},...{vq:ge,quality:ge}},l=Object.entries(r).map(([w,H])=>`${w}=${H}`).join("&"),c=`${e}?${l}`;return console.log("🎥 YouTube URL built:",{videoQuality:ge,connectionSpeed:He,finalURL:c}),c},[ge,He]),$e=n.useCallback(()=>{o(!1),d(!0),a("video_interaction",{action:"thumbnail_click",video_id:"vEHTO3gf1jk",component:"FigmaMobile"})},[a]),lt=n.useMemo(()=>i.jsx("div",{onClick:$e,style:{position:"absolute",top:"0",left:"0",width:"100%",height:"100%",cursor:"pointer",backgroundImage:"url(https://img.youtube.com/vi/vEHTO3gf1jk/maxresdefault.jpg)",backgroundSize:"cover",backgroundPosition:"center",backgroundRepeat:"no-repeat",transform:"translateZ(0)",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden",transition:"transform 0.2s ease-out"},onMouseDown:e=>{e.currentTarget.style.transform="translateZ(0) scale(0.98)"},onMouseUp:e=>{e.currentTarget.style.transform="translateZ(0) scale(1)"},onMouseLeave:e=>{e.currentTarget.style.transform="translateZ(0) scale(1)"},onTouchStart:e=>{e.currentTarget.style.transform="translateZ(0) scale(0.98)"},onTouchEnd:e=>{e.currentTarget.style.transform="translateZ(0) scale(1)"}}),[$e]);return fe?i.jsx(ct,{fullScreen:!0,minDisplayTime:600,showMessage:!1}):i.jsxs(i.Fragment,{children:[i.jsx(bt,{events:[...Je,...Qe],domain:"bounce2bounce.com"}),i.jsx("link",{rel:"stylesheet",href:"/css/mobile-scroll-fix.css"}),i.jsx("style",{children:`
