const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomePage-MTPkMxw6.js","assets/usePerformantResize-DOfXzbLW.js","assets/beacon-r5K5QvzQ.js","assets/mobileOptimization-DxuCIEdC.js","assets/sanitizer-DviOXSNm.js","assets/SocialMediaButtons-Du5SXfe_.js","assets/AdminLoginFigma-DaEPHwqr.js","assets/vendor-BkEynug1.js","assets/AboutPage-DoLRT87P.js","assets/ContactPage-DiSO1LYH.js"])))=>i.map(i=>d[i]);
...
const Ie=x.lazy(()=>p(()=>import("./AboutPage-DoLRT87P.js").then(e=>e.A),__vite__mapDeps([8,1]))),Be=x.lazy(()=>p(()=>import("./ContactPage-DiSO1LYH.js"),__vite__mapDeps([9,1,7]))),Ne=()=>E.jsx($e,{message:"Loading page",fullScreen:!0,minDisplayTime:500}),Ue=()=>{const[e,n]=x.useState(!1),[t,r]=x.useState(window.location.pathname)
