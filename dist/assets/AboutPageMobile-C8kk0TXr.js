import{D as S,j as o}from"./index-BI7dje9I.js";import{b as l}from"./vendor-ViNJc2wV.js";import{u as $,a as z,M as Y}from"./useNavHeight-Cd0XAVOv.js";import{i as W,r as L,M as H}from"./AboutPage-C3gLqWzb.js";import{F as P}from"./Footer-_oh_m9DM.js";import{B as R}from"./Breadcrumb-C_vqnJvS.js";import"./SocialMediaButtons-DDDT61w9.js";import"./breadcrumbSchema-BG74ATTs.js";const et=()=>{const[F,x]=l.useState(""),[G,y]=l.useState(!0),[j,C]=l.useState(null),[g,m]=l.useState([]),b=l.useRef(null),f=l.useRef(null),k=$(),h=l.useRef({startY:0,lastY:0}),A=Math.max(k||0,0)+12,[_,B]=l.useState(0),{scrollY:O}=z(b.current,{threshold:50,throttleMs:200,passive:!0});l.useEffect(()=>{const t="https://bounce2bounce.com",n=`${t}/about`,a=S?.about_page_description||"Learn about BOUNCE2BOUNCE - NJ's premiere EDM collective curating exclusive live music events.",e=S?.about_page_og_image||`${t}/images/og-image.png`,i="ld-json-about",s=document.getElementById(i);s&&s.remove();const r=document.createElement("script");r.type="application/ld+json",r.id=i,r.text=JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"Organization",name:"BOUNCE2BOUNCE",url:t,logo:`${t}/images/og-image.png`},{"@type":"AboutPage",name:"About BOUNCE2BOUNCE",url:n,description:a,isPartOf:{"@type":"WebSite",name:"BOUNCE2BOUNCE",url:t},primaryImageOfPage:{"@type":"ImageObject",url:e}}]}),document.head.appendChild(r)},[]),l.useEffect(()=>{const t=()=>{B(n=>n+1)};return window.addEventListener("resize",t),window.addEventListener("orientationchange",t),()=>{window.removeEventListener("resize",t),window.removeEventListener("orientationchange",t)}},[]),l.useEffect(()=>{const t=b.current;if(!t)return;const n=navigator.userAgent||"";if(!(/iPhone|iPad|iPod/.test(n)&&/Safari/.test(n)&&!/Chrome/.test(n)))return;const e=s=>{const r=s.touches&&s.touches[0];r&&(h.current.startY=r.clientY,h.current.lastY=r.clientY)},i=s=>{const r=s.touches&&s.touches[0];if(!r||f.current&&s.target&&f.current.contains(s.target))return;const c=r.clientY-h.current.lastY;h.current.lastY=r.clientY;const v=t.scrollTop<=0,d=t.scrollTop+t.clientHeight>=t.scrollHeight-1;(v&&c>0||d&&c<0)&&s.preventDefault()};return t.addEventListener("touchstart",e,{passive:!0}),t.addEventListener("touchmove",i,{passive:!1}),()=>{t.removeEventListener("touchstart",e),t.removeEventListener("touchmove",i)}},[]),l.useEffect(()=>{I(),M()},[]),l.useEffect(()=>(W(g),()=>{L()}),[g]);const I=async()=>{try{y(!0),C(null);const n=window.location.hostname==="localhost"?"":"https://admin.b2b.click";console.log("🔍 Fetching About page content from API...");const a=await fetch(`${n}/api/settings/about`,{method:"GET",headers:{"Content-Type":"application/json"}});if(!a.ok)throw new Error(`HTTP error! status: ${a.status}`);const e=await a.json();if(e.success&&e.data)x(e.data.content),console.log("✅ About page content loaded successfully");else throw new Error("Invalid response format")}catch(t){console.error("❌ Error fetching About page content:",t),x(`BOUNCE2BOUNCE is New Jersey's premiere electronic music collective, dedicated to curating exclusive live music events and creating unforgettable experiences for music lovers.

Our mission is to unite top talent, immersive production, and passionate fans to create the ultimate electronic music experiences in the tri-state area.`),console.log("✅ Using static fallback content for About page (API blocked or unavailable)")}finally{y(!1)}},N=t=>{const n=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click",a=t?.url||t?.src||t?.image_url||t?.file_url||t?.path||t?.imagePath||"",e=typeof a=="string"?a:a?.url||"";if(e&&/^https?:\/\//i.test(e))return{...t,url:e};if(e&&/^\/?api\/images\/serve\//i.test(e))return{...t,url:`${n}/${e.replace(/^\//,"")}`};if(e&&/^\/?(uploads|static\/uploads|data\/static\/uploads)\//i.test(e)){let i=e.replace(/^\/?data\/static\/uploads\//,"/static/uploads/");return i.startsWith("/")||(i=`/${i}`),{...t,url:`${n}${i}`}}return{...t,url:e}},M=async()=>{try{const n=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click",a=`cb=${Date.now()}`,e=await fetch(`${n}/api/settings/about/gallery/public?${a}`,{method:"GET",headers:{"Content-Type":"application/json"},cache:"no-cache"});if(e.ok){const i=await e.json();if(i.success&&Array.isArray(i.data)){const s=i.data.map(r=>{const c=N(r),v=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click",d=p=>{if(!p)return p;const E=/^https?:\/\//i.test(p)?p:`${v}${p}`,U=E.includes("?")?"&":"?";return`${E}${U}${a}`},u=c&&(c.urls||c.srcSet)||{},w={thumbnail:d(u.thumbnail),small:d(u.small),medium:d(u.medium||c?.url),large:d(u.large),original:d(u.original||c?.url)};return{...c,urls:w,srcSet:w}});m(s)}else console.warn("Invalid gallery response format:",i),m([])}else console.warn("Failed to fetch gallery images:",e.status),m([])}catch(t){console.error("❌ Error fetching gallery images:",t),m([])}},D=t=>{if(!t)return[];const n=t.split(/\n\s*\n|\n/).filter(a=>a.trim());return n.map((a,e)=>o.jsx("p",{style:{marginBottom:e===n.length-1?"0":"20px"},children:a.trim()},e))},T=t=>{if(t==="/about"){window.scrollTo({top:0,behavior:"smooth"});return}window.location.href=t};return o.jsxs(o.Fragment,{children:[o.jsx("style",{children:`
          .mobile-content-fade {
