const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomePage-CWf-fLpe.js","assets/usePerformantResize-Cxs6ZpPf.js","assets/beacon-r5K5QvzQ.js","assets/mobileOptimization-DxuCIEdC.js","assets/sanitizer-Dkw_Cx7v.js","assets/SocialMediaButtons-BIITcf_y.js","assets/AdminLoginFigma-DZEGpE8f.js","assets/vendor-BkEynug1.js","assets/AboutPage-CQPlf5Fq.js","assets/ContactPage-CWv6wQAs.js"])))=>i.map(i=>d[i]);
...
const Ie=x.lazy(()=>p(()=>import("./AboutPage-CQPlf5Fq.js").then(e=>e.A),__vite__mapDeps([8,1]))),Be=x.lazy(()=>p(()=>import("./ContactPage-CWv6wQAs.js"),__vite__mapDeps([9,1,7]))),Ne=()=>E.jsx($e,{message:"Loading page",fullScreen:!0,minDisplayTime:500}),Ue=()=>{const[e,n]=x.useState(!1),[t,r]=x.useState(window.location.pathname)
