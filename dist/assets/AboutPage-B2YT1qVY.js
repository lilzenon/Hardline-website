const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AboutPageMobile-BA1rMbRb.js","assets/index-CM1kMICb.js","assets/vendor-ViNJc2wV.js","assets/index-CTSQklRg.css","assets/MobileNavigation-ZwdXs138.js","assets/SocialMediaButtons-BrPE5lCS.js","assets/usePerformantResize-Fo8ytToz.js","assets/DesktopNavigation-CWDsXt27.js"])))=>i.map(i=>d[i]);
import{j as a,B as L,_ as V}from"./index-CM1kMICb.js";import{b as s,R as _}from"./vendor-ViNJc2wV.js";import{u as Y}from"./usePerformantResize-Fo8ytToz.js";import{D as X}from"./DesktopNavigation-CWDsXt27.js";const q=({images:o=[],columns:x={desktop:4,tablet:3,mobile:2},gap:W=16,className:w="",onImageClick:M=null})=>{const[j,A]=s.useState(new Set),[S,P]=s.useState(x.desktop),[B,N]=s.useState(!1),[i,T]=s.useState(null),[I,C]=s.useState(new Map),[k,z]=s.useState(!1),U=s.useRef(null),$=s.useRef(null),t=s.useRef(null),d=s.useRef(0),c=s.useCallback(()=>{const e=window.innerWidth;e<768?P(x.mobile):e<1024?P(x.tablet):P(x.desktop)},[x]),r=s.useCallback(()=>window.innerWidth<768,[]);s.useEffect(()=>($.current=new IntersectionObserver(([e])=>{e.isIntersecting&&(N(!0),$.current?.disconnect())},{threshold:.1}),U.current&&$.current.observe(U.current),()=>$.current?.disconnect()),[]),s.useEffect(()=>(c(),window.addEventListener("resize",c),()=>window.removeEventListener("resize",c)),[c]);const p=s.useCallback(e=>{A(n=>new Set([...n,e])),C(n=>new Map(n.set(e,"loaded")))},[]),g=s.useCallback(e=>{C(n=>new Map(n.set(e,"loading")))},[]),u=s.useCallback((e,n)=>{if(Date.now()-d.current<300){console.log("🚫 Image click ignored - too soon after modal close");return}if(k){console.log("🚫 Image click ignored - modal is closing");return}console.log("🖼️ Image clicked:",e),console.log("🔍 Image properties:",Object.keys(e));const F=e.url||e.src||e.image_url||e.file_url;console.log("🔗 Image URL found:",F),F?(T({...e,url:F,index:n}),document.body.style.overflow="hidden"):console.error("❌ No valid image URL found in image object:",e),M&&M(e)},[M,k]),m=s.useCallback(e=>{e&&(e.preventDefault(),e.stopPropagation(),typeof e.stopImmediatePropagation=="function"&&e.stopImmediatePropagation()),z(!0),d.current=Date.now(),T(null),document.body.style.overflow="unset",setTimeout(()=>{z(!1)},100)},[]),f=s.useCallback(e=>{e.target===e.currentTarget&&(e.preventDefault(),e.stopPropagation(),typeof e.stopImmediatePropagation=="function"&&e.stopImmediatePropagation(),m(e))},[m]),E=s.useCallback(e=>{e.target===e.currentTarget&&(e.preventDefault(),e.stopPropagation(),typeof e.stopImmediatePropagation=="function"&&e.stopImmediatePropagation(),m(e))},[m]);s.useEffect(()=>{const e=n=>{if(i)switch(n.key){case"Escape":n.preventDefault(),m();break;case"Enter":case" ":n.preventDefault(),m();break}};if(i)return document.addEventListener("keydown",e),t.current&&t.current.focus(),()=>document.removeEventListener("keydown",e)},[i,m]);const v=s.useCallback(()=>{const e=Array.from({length:S},()=>[]),n=Array(S).fill(0);return o.forEach((l,F)=>{const R=n.indexOf(Math.min(...n));e[R].push({...l,originalIndex:F});const D=300*(l.aspectRatio||l.height/l.width||1.2);n[R]+=D+W}),e},[o,S,W])(),h=`
