function t(t={}){return o?(t.debug,0):(o=new n(t),window.analyticsBeacon=o,window.getAnalyticsTracker=()=>o,!1!==t.enableRealTime&&setTimeout(()=>{o?.sendPageView()},100),t.debug),o}function e(){return o}function i(t){o&&o.sendEvent(t)}class n{constructor(t={}){this.hasTrackedPageView=!1,this.sessionId=null
