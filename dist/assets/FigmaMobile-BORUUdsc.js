import{j as n,B as ct}from"./index-MUNeEoaI.js";import{b as i}from"./vendor-ViNJc2wV.js";import{u as dt,a as pt,M as mt}from"./useNavHeight-BeV49mE_.js";import{u as ut,a as gt}from"./HomePage-DvEkoaTE.js";import{S as ft}from"./SocialMediaButtons-DbItAbTc.js";import{F as bt}from"./Footer-BR37FLXq.js";import"./beacon-BB01f5iw.js";import"./mobileOptimization-ILGdA5i5.js";import"./sanitizer-BX97C1dn.js";const ht=()=>{const[r,y]=i.useState(!1),[A,h]=i.useState(0),o=3,W=1e4,u="https://embed.laylo.com/laylo-sdk.js";i.useCallback(()=>typeof window<"u"&&(window.Laylo!==void 0||document.querySelector(`script[src="${u}"]`)!==null),[]);const g=i.useCallback(()=>new Promise((w,R)=>{if(document.querySelector(`script[src="${u}"]`)){const U=()=>{window.Laylo||document.readyState==="complete"?w():setTimeout(U,100)};U();return}const d=document.createElement("script");d.src=u,d.async=!0;const G=setTimeout(()=>{d.remove(),R(new Error("Script load timeout"))},W);d.onload=()=>{clearTimeout(G),setTimeout(w,200)},d.onerror=()=>{clearTimeout(G),d.remove(),R(new Error("Script load failed"))},document.head.appendChild(d)}),[]),H=i.useCallback(async(w=0)=>{if(!r)try{await g(),y(!0),console.log("🎉 Laylo SDK ready")}catch(R){if(w<o-1){const k=Math.pow(2,w)*1e3;h(w+1),console.warn(`⚠️ Laylo SDK load failed (attempt ${w+1}), retrying in ${k}ms...`),setTimeout(()=>H(w+1),k)}else console.error("❌ Laylo SDK failed to load after retries:",R.message)}},[r,g]);return i.useEffect(()=>{H(0)},[H]),r},xt=({dropId:r,color:y="ff0409",theme:A="dark",background:h="solid",minimal:o=!0,style:W={},visible:u=!0})=>{const[g,H]=i.useState(0),[w,R]=i.useState(0),k=i.useRef(0),d=i.useRef(null),G=i.useRef(!1),U=2,_=7e3,le=i.useMemo(()=>{if(typeof navigator>"u")return!1;const D=navigator.userAgent,x=/AppleWebKit/i.test(D),b=/iP(hone|od|ad)|Mobile/i.test(D),T=/CriOS/i.test(D),ce=/FxiOS/i.test(D);return x&&b&&!T&&!ce},[]),[ee,v]=i.useState(null),j=i.useRef(u),Z=i.useRef(0),p=1e3,B=D=>(D||"")+((D||"").includes("?")?"&":"?")+"_ts="+Date.now(),I=i.useMemo(()=>r?`https://embed.laylo.com/?${new URLSearchParams({dropId:r,color:y,theme:A,background:h,...o&&{minimal:"true"}}).toString()}`:null,[r,y,A,h,o]),O=(D,x)=>{const b=new Date().toISOString();console.log(`[LayloSimple ${b}] ${D}`,x??"")};i.useEffect(()=>{const D=!j.current&&u;if(!u){d.current&&(clearTimeout(d.current),d.current=null),j.current=u;return}if(!D){j.current=u;return}if(R(0),k.current=Date.now(),G.current=!1,O("Visible -> ensuring iframe src",{retryCount:0,url:I}),le){v(null);const x=setTimeout(()=>{const b=B(I);Z.current=Date.now(),v(b)},180);return j.current=u,()=>{clearTimeout(x),d.current&&(clearTimeout(d.current),d.current=null)}}else ee||(Z.current=Date.now(),v(I));j.current=u},[u,I,le,ee]),i.useEffect(()=>{if(!le)return;const D=b=>{if(b.persisted&&u){const T=Date.now();T-Z.current>p&&(O("pageshow (persisted) -> refreshing iframe src (iOS)"),Z.current=T,G.current=!1,v(null),setTimeout(()=>{v(B(I))},180))}},x=()=>{if(document.visibilityState==="visible"&&u){const b=Date.now();b-Z.current>p&&(O("visibilitychange -> visible; refreshing iframe src (iOS)"),Z.current=b,v(T=>T??B(I)))}};return window.addEventListener("pageshow",D),document.addEventListener("visibilitychange",x),()=>{window.removeEventListener("pageshow",D),document.removeEventListener("visibilitychange",x)}},[le,u,I]);const $=()=>{const D=Date.now()-(k.current||0);G.current=!0,d.current&&(clearTimeout(d.current),d.current=null),O("Iframe onLoad fired",{elapsedMs:D})},V=D=>{if(O("Iframe onError",{error:D}),d.current&&(clearTimeout(d.current),d.current=null),w<U){O("Error -> retry (src bust)",{retryCount:w+1}),R(b=>b+1);const x=Date.now();x-Z.current>p&&(Z.current=x,k.current=Date.now(),G.current=!1,v(B(I)))}else O("Final error -> giving up after max retries")};return i.useEffect(()=>{if(!(!u||!ee))return d.current&&(clearTimeout(d.current),d.current=null),k.current=Date.now(),d.current=setTimeout(()=>{if(!G.current)if(w<U){O("Load timeout -> retry (src bust)",{retryCount:w+1}),R(x=>x+1);const D=Date.now();D-Z.current>p&&(Z.current=D,v(B(I)))}else O("Final load timeout -> giving up after max retries")},_),()=>{d.current&&(clearTimeout(d.current),d.current=null)}},[ee,u,w,I]),r?u?n.jsx("iframe",{id:`laylo-drop-${r}`,title:"Laylo Signup",width:"100%",height:"100%",frameBorder:"0",scrolling:"no",allow:"web-share; clipboard-write; fullscreen; autoplay; encrypted-media; picture-in-picture",loading:"eager",onLoad:$,onError:V,style:{...W,WebkitTransform:"translateZ(0)",transform:"translateZ(0)",display:"block"},src:ee??I},g):n.jsx("div",{style:{...W}}):n.jsx("div",{style:{...W,display:"flex",alignItems:"center",justifyContent:"center",minHeight:60},children:n.jsx("span",{style:{color:"#999",fontSize:14},children:"[LayloSimple] Missing dropId"})})},wt=({contentRef:r,viewportContext:y={isRealMobileDevice:!1},onStateChange:A=()=>{}})=>{const[h,o]=i.useState("");i.useState(!1);const[W,u]=i.useState(!1);i.useState("us"),i.useState("normal");const[g,H]=i.useState(!1),[w,R]=i.useState(!1),[k,d]=i.useState(!1),[G,U]=i.useState(!1),[_,le]=i.useState(!1);i.useState(0);const ee=ht();i.useState(!1);const v=!k&&ee,j=v,Z=g,[p,B]=i.useState({isActive:!1,startY:0,currentY:0,startX:0,currentX:0,startTime:0,isDragging:!1,initialDrawerState:!1,isOnDrawerContent:!1,isOnDrawerHandle:!1,isOnSwipeZone:!1,dragDistance:0,isIntentionalGesture:!1,isVerticalIntent:null}),[I,O]=i.useState({expanded:!1,showDisclaimer:!1,phoneNumber:""});i.useState(!1),i.useRef(null),i.useRef(null);const $=i.useRef(null);i.useRef(null);const V=i.useRef(null),D=i.useCallback(()=>{O({expanded:g,showDisclaimer:w,phoneNumber:h}),console.log("💾 Drawer state saved, iframe content preserved")},[g,w,h]),x=i.useCallback(a=>{$.current&&!$.current.contains(a.target)&&(D(),H(!1),d(!1),R(!1))},[h,D]);i.useEffect(()=>(g&&(document.addEventListener("mousedown",x),document.addEventListener("touchstart",x)),()=>{document.removeEventListener("mousedown",x),document.removeEventListener("touchstart",x)}),[g,x]),i.useEffect(()=>{const a=document.body,m=r?.current;if(g){const M=window.scrollY;a.classList.add("drawer-scroll-lock"),a.style.top=`-${M}px`,m&&m.classList.add("drawer-active")}else{a.classList.remove("drawer-scroll-lock");const M=a.style.top;a.style.top="",M&&window.scrollTo(0,parseInt(M||"0")*-1),m&&m.classList.remove("drawer-active")}return()=>{a.classList.remove("drawer-scroll-lock"),a.style.top="",m&&m.classList.remove("drawer-active")}},[g,r]);const b=i.useRef({drawerExpanded:void 0,drawerFullyClosed:void 0,iframeExpanded:void 0,phoneSubmitted:void 0});i.useEffect(()=>{const a={drawerExpanded:g,drawerFullyClosed:k,iframeExpanded:G,phoneSubmitted:W},m=b.current;(m.drawerExpanded!==a.drawerExpanded||m.drawerFullyClosed!==a.drawerFullyClosed||m.iframeExpanded!==a.iframeExpanded||m.phoneSubmitted!==a.phoneSubmitted)&&(b.current=a,A(a))},[g,k,G,W,A]),i.useRef(!1),i.useEffect(()=>{},[k]),i.useEffect(()=>{if(v&&ee&&!_){const a=setTimeout(()=>{le(!0),console.log("✅ Laylo iframe ready for interaction")},1e3);return()=>clearTimeout(a)}},[v,ee,_]);const T=i.useCallback(()=>k?"50px":G?"320px":g?"280px":"80px",[k,g,w,G]);i.useCallback(()=>{const a=T(),m=(()=>{const N="ontouchstart"in window||navigator.maxTouchPoints>0,C=/Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),Y=window.innerWidth,z=window.innerHeight,S=Y/z;return N&&C&&(S<1.5||Y<768)})(),M=parseInt(a.replace("px",""));if(m)return`calc(${a} + 20px)`;{const N=Math.max(15,M*.2);return`calc(${a} + ${N}px)`}},[T,y]);const ce=i.useCallback(a=>{if(a.target.tagName==="INPUT"||a.target.tagName==="TEXTAREA"||a.target.tagName==="BUTTON"||a.target.closest("iframe")||a.target.closest("button")||a.target.closest('[role="button"]'))return;const m=a.touches[0],M=Date.now(),N=a.target.closest(".mobile-drawer-content"),C=$.current?.getBoundingClientRect(),Y=C&&m.clientY>C.top&&m.clientY<C.top+120,z=g?C?.height*.4:120,S=C&&m.clientY>C.top&&m.clientY<C.top+z;B({isActive:!0,startY:m.clientY,currentY:m.clientY,startX:m.clientX,currentX:m.clientX,startTime:M,isDragging:!1,initialDrawerState:g,isOnDrawerContent:!!N,isOnDrawerHandle:!!Y,isOnSwipeZone:!!S,dragDistance:0,isIntentionalGesture:!1,isVerticalIntent:null}),S&&!N&&(a.preventDefault(),a.stopPropagation())},[g]),te=i.useCallback(a=>{if(!p.isActive||a.target.tagName==="INPUT"||a.target.tagName==="TEXTAREA"||a.target.tagName==="BUTTON"||a.target.closest("iframe")||a.target.closest("button")||a.target.closest('[role="button"]'))return;const m=a.touches[0],M=p.startY-m.clientY,N=Math.abs(M),C=m.clientX-p.startX,Y=Math.abs(C);if(p.isVerticalIntent===null&&(N>4||Y>4)){const z=N>=Y*1.2;if(B(S=>({...S,isVerticalIntent:z})),!z)return}if(p.isVerticalIntent!==!1){if(!p.isDragging&&N>3&&p.isOnSwipeZone&&!p.isOnDrawerContent){const z=N>8||N>3&&Date.now()-p.startTime>100;B(S=>({...S,isDragging:!0,isIntentionalGesture:z,dragDistance:N})),z&&(a.preventDefault(),a.stopPropagation())}if(p.isDragging&&p.isOnSwipeZone&&!p.isOnDrawerContent){const z=Math.max(N,p.dragDistance);p.isIntentionalGesture&&(a.preventDefault(),a.stopPropagation()),B(S=>({...S,currentY:m.clientY,currentX:m.clientX,dragDistance:z}))}else p.isOnDrawerContent||B(z=>({...z,currentY:m.clientY,currentX:m.clientX}))}},[p]),ae=i.useCallback(a=>{if(!p.isActive)return;const m=p.startY-p.currentY,M=Math.abs(m),N=Date.now()-p.startTime,C=M/N,Y=8,z=.15,S=5,K=p.isIntentionalGesture?.7:1;let re=!1;if(p.isDragging&&p.isIntentionalGesture){const ie=Y*K,E=z*K;C>E?(re=!0,console.log("🚀 Flick gesture detected:",{velocity:C,threshold:E})):M>ie?(re=!0,console.log("🚀 Swipe gesture detected:",{distance:M,threshold:ie})):M>S&&(re=!0,console.log("🚀 Snap gesture detected:",{distance:M,threshold:S}))}else p.isDragging&&!p.isIntentionalGesture&&(C>z*1.2||M>Y*1.5)&&(re=!0,console.log("🚀 Fallback gesture detected"));if(re)C>z?($.current?.classList.add("momentum-fast"),setTimeout(()=>{$.current?.classList.remove("momentum-fast")},100)):($.current?.classList.add("momentum-slow"),setTimeout(()=>{$.current?.classList.remove("momentum-slow")},250)),m>0?g||(H(!0),d(!1),console.log("🔄 Drawer opened via swipe up")):g&&(H(!1),console.log("🔄 Drawer closed via swipe down"));else{const ie=$.current?.getBoundingClientRect(),E=g?ie?.height*.4:120;ie&&p.startY>ie.top&&p.startY<ie.top+E&&(k?(d(!1),H(!0),console.log("🔄 Drawer opened via tap on swipe zone")):g?(H(!1),console.log("🔄 Drawer collapsed via tap on swipe zone")):(H(!0),console.log("🔄 Drawer expanded via tap on swipe zone")))}B({isActive:!1,startY:0,currentY:0,startX:0,currentX:0,startTime:0,isDragging:!1,initialDrawerState:!1,isOnDrawerContent:!1,isOnDrawerHandle:!1,isOnSwipeZone:!1,dragDistance:0,isIntentionalGesture:!1,isVerticalIntent:null})},[p,g,k]),J=i.useCallback(()=>{k?(d(!1),H(I.expanded||!0),R(I.showDisclaimer),I.phoneNumber&&o(I.phoneNumber)):g||(H(!0),I.showDisclaimer&&R(!0))},[k,g,I]),we=i.useCallback(a=>{a.stopPropagation(),k&&d(!1),H(!0),U(!0),setTimeout(()=>{U(!1)},1e4)},[k]);return n.jsxs(n.Fragment,{children:[n.jsx("style",{children:`
