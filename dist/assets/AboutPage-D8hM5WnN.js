const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AboutPageMobile-bwC7jMtF.js","assets/index-CiowJHZz.js","assets/vendor-ViNJc2wV.js","assets/index-C9VxiwSc.css","assets/useNavHeight-D62kXlPp.js","assets/SocialMediaButtons-E_zTaFlg.js","assets/DesktopNavigationPills-IljRaiEt.js"])))=>i.map(i=>d[i]);
import{r as V,j as a,D as Y,B as _,_ as q}from"./index-CiowJHZz.js";import{b as r,R as G}from"./vendor-ViNJc2wV.js";import{u as X,D as J}from"./DesktopNavigationPills-IljRaiEt.js";var K=V();const Q=({images:o=[],columns:b={desktop:4,tablet:3,mobile:2},gap:F=16,className:W="",onImageClick:B=null})=>{const[A,z]=r.useState(new Set),[M,$]=r.useState(()=>{if(typeof window>"u")return b.desktop;const e=window.innerWidth;return e<768?b.mobile:e<1024?b.tablet:b.desktop}),[j,D]=r.useState(!1),[p,R]=r.useState(null),[L,T]=r.useState(new Map),[m,f]=r.useState(!1),g=r.useRef(null),v=r.useRef(null),t=r.useRef(null),u=r.useRef(0),l=r.useRef({y:0,locked:!1}),s=r.useCallback(()=>{if(l.current.locked)return;const e=window.scrollY||document.documentElement.scrollTop||0;l.current.y=e,l.current.locked=!0;const n=document.body.style;n.position="fixed",n.top=`-${e}px`,n.left="0",n.right="0",n.width="100%",n.overflow="hidden",document.documentElement.style.overscrollBehavior="none",document.documentElement.style.touchAction="none";const i=x=>{x.preventDefault(),x.stopPropagation()};window.addEventListener("wheel",i,{passive:!1,capture:!0}),window.addEventListener("touchmove",i,{passive:!1,capture:!0}),l.current.preventScroll=i},[]),k=r.useCallback(()=>{if(!l.current.locked)return;const e=l.current.y||0,n=document.body.style;n.position="",n.top="",n.left="",n.right="",n.width="",n.overflow="",document.documentElement.style.overscrollBehavior="",document.documentElement.style.touchAction="",l.current.preventScroll&&(window.removeEventListener("wheel",l.current.preventScroll,{capture:!0}),window.removeEventListener("touchmove",l.current.preventScroll,{capture:!0}),l.current.preventScroll=void 0),l.current.locked=!1,window.scrollTo(0,e)},[]),d=r.useCallback(()=>{const e=g.current?.clientWidth||(typeof window<"u"?window.innerWidth:1024);e<768?$(b.mobile):e<1024?$(b.tablet):$(b.desktop)},[b]),c=r.useCallback(()=>window.innerWidth<768,[]);r.useEffect(()=>{if(typeof window<"u"&&!("IntersectionObserver"in window)){D(!0);return}if(v.current=new IntersectionObserver(([e])=>{e&&e.isIntersecting&&(D(!0),v.current?.disconnect())},{threshold:.1,rootMargin:"50px"}),g.current)v.current.observe(g.current);else{const e=setTimeout(()=>D(!0),800);return()=>clearTimeout(e)}return()=>v.current?.disconnect()},[]),r.useEffect(()=>(d(),window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)),[d]),r.useEffect(()=>{if(!j&&Array.isArray(o)&&o.length>0){const e=setTimeout(()=>D(!0),1e3);return()=>clearTimeout(e)}},[o,j]),r.useEffect(()=>{if(!j)return;typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>d()):d();const e=setTimeout(d,150);return()=>clearTimeout(e)},[j,d]),r.useEffect(()=>{const e=()=>d();return typeof window<"u"&&(window.addEventListener("visibilitychange",e),window.addEventListener("pageshow",e)),()=>{typeof window<"u"&&(window.removeEventListener("visibilitychange",e),window.removeEventListener("pageshow",e))}},[d]),r.useEffect(()=>{if(!g.current||typeof ResizeObserver>"u")return;const e=new ResizeObserver(()=>d());return e.observe(g.current),()=>e.disconnect()},[d]);const O=r.useCallback(e=>{z(n=>new Set([...n,e])),T(n=>new Map(n.set(e,"loaded")))},[]),P=r.useCallback(e=>{T(n=>new Map(n.set(e,"loading")))},[]),I=r.useCallback((e,n)=>{if(Date.now()-u.current<300){console.log("🚫 Image click ignored - too soon after modal close");return}if(m){console.log("🚫 Image click ignored - modal is closing");return}console.log("🖼️ Image clicked:",e),console.log("🔍 Image properties:",Object.keys(e));const x=e.url||e.src||e.image_url||e.file_url;console.log("🔗 Image URL found:",x),x?(R({...e,url:x,index:n}),s()):console.error("❌ No valid image URL found in image object:",e),B&&B(e)},[B,m]),h=r.useCallback(e=>{e&&(e.preventDefault(),e.stopPropagation(),typeof e.stopImmediatePropagation=="function"&&e.stopImmediatePropagation()),f(!0),u.current=Date.now();let n=!1;const i=x=>{n||(n=!0,x.preventDefault(),x.stopPropagation(),typeof x.stopImmediatePropagation=="function"&&x.stopImmediatePropagation(),document.removeEventListener("pointerup",i,!0),document.removeEventListener("click",i,!0),document.removeEventListener("touchend",i,!0))};document.addEventListener("pointerup",i,!0),document.addEventListener("click",i,!0),document.addEventListener("touchend",i,!0),R(null),k(),setTimeout(()=>{f(!1)},100)},[]),S=r.useCallback(e=>{e.target===e.currentTarget&&(e.preventDefault(),e.stopPropagation(),typeof e.stopImmediatePropagation=="function"&&e.stopImmediatePropagation(),h(e))},[h]),E=r.useCallback(e=>{e.target===e.currentTarget&&(e.preventDefault(),e.stopPropagation(),typeof e.stopImmediatePropagation=="function"&&e.stopImmediatePropagation(),h(e))},[h]);r.useEffect(()=>{const e=n=>{if(p)switch(n.key){case"Escape":n.preventDefault(),h();break;case"Enter":case" ":n.preventDefault(),h();break}};if(p){if(document.addEventListener("keydown",e),t.current)try{t.current.focus({preventScroll:!0})}catch{c()||t.current.focus()}return()=>document.removeEventListener("keydown",e)}},[p,h,c]);const w=r.useCallback(()=>{const e=Array.from({length:M},()=>[]),n=Array(M).fill(0);return o.forEach((i,x)=>{const N=n.indexOf(Math.min(...n));e[N].push({...i,originalIndex:x});const U=300*(i.aspectRatio||i.height/i.width||1.2);n[N]+=U+F}),e},[o,M,F])(),y=`
