import{j as i}from"./index-DtXN6fn2.js";import{b as s}from"./vendor-ViNJc2wV.js";import{u as U,a as z,M as $}from"./useNavHeight-J3QGiGDF.js";import{M as D}from"./AboutPage-BiiGRM_Y.js";import"./SocialMediaButtons-B0BSOKdZ.js";import"./DesktopNavigationPills-D4Kyw8MR.js";const Y=()=>{const[E,v]=s.useState(""),[W,y]=s.useState(!0),[k,x]=s.useState(null),[B,g]=s.useState([]),w=s.useRef(null),C=U(),S=Math.max(C||0,0)+12,[T,F]=s.useState(0),{scrollY:j}=z(w.current,{threshold:50,throttleMs:200,passive:!0});s.useEffect(()=>{const e="https://b2b.click",a=`${e}/about`,n="About BOUNCE2BOUNCE | Live Music Events & Experiences",t="Learn about BOUNCE2BOUNCE — curating premium live music events and unforgettable experiences. Discover our mission, story, and how we connect artists and fans.",l="about bounce2bounce, live music events, edm collective, concerts, event platform, artist community",h=`${e}/images/og-image.png`,o=(r,b,p)=>{let u=document.head.querySelector(`meta[${r}="${b}"]`);u||(u=document.createElement("meta"),u.setAttribute(r,b),document.head.appendChild(u)),u.setAttribute("content",p)},f=(r,b)=>{let p=document.head.querySelector(`link[rel="${r}"]`);p||(p=document.createElement("link"),p.setAttribute("rel",r),document.head.appendChild(p)),p.setAttribute("href",b)};document.title=n,o("name","description",t),o("name","keywords",l),o("name","robots","index,follow"),o("property","og:type","website"),o("property","og:site_name","BOUNCE2BOUNCE"),o("property","og:title",n),o("property","og:description",t),o("property","og:url",a),o("property","og:image",h),o("name","twitter:card","summary_large_image"),o("name","twitter:title",n),o("name","twitter:description",t),o("name","twitter:image",h),o("name","twitter:site","@bounce2bounce"),f("canonical",a);const c="ld-json-about",d=document.getElementById(c);d&&d.remove();const m=document.createElement("script");m.type="application/ld+json",m.id=c,m.text=JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"Organization",name:"BOUNCE2BOUNCE",url:e,logo:`${e}/images/og-image.png`},{"@type":"AboutPage",name:"About BOUNCE2BOUNCE",url:a,description:t,isPartOf:{"@type":"WebSite",name:"BOUNCE2BOUNCE",url:e},primaryImageOfPage:{"@type":"ImageObject",url:h}}]}),document.head.appendChild(m)},[]),s.useEffect(()=>{const e=()=>{F(a=>a+1)};return window.addEventListener("resize",e),window.addEventListener("orientationchange",e),()=>{window.removeEventListener("resize",e),window.removeEventListener("orientationchange",e)}},[]),s.useEffect(()=>{O(),N()},[]);const O=async()=>{try{y(!0),x(null);const a=window.location.hostname==="localhost"?"":"https://admin.b2b.click";console.log("🔍 Fetching About page content from API...");const n=await fetch(`${a}/api/settings/about`,{method:"GET",headers:{"Content-Type":"application/json"}});if(!n.ok)throw new Error(`HTTP error! status: ${n.status}`);const t=await n.json();if(t.success&&t.data)v(t.data.content),console.log("✅ About page content loaded successfully");else throw new Error("Invalid response format")}catch(e){console.error("❌ Error fetching About page content:",e),x(e.message),v(`Bounce2Bounce is the premier destination for exclusive events, contests, and unforgettable experiences. We connect people with the most exciting opportunities in their area.
