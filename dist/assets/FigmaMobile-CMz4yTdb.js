import{j as o,B as ct}from"./index-Dk1MTCwB.js";import{b as i}from"./vendor-ViNJc2wV.js";import{u as dt,a as pt,M as mt}from"./useNavHeight-BGVpFRuw.js";import{u as ut,a as gt,E as ft}from"./HomePage-B1GgnRcx.js";import{S as bt}from"./SocialMediaButtons-DG7AC_7Y.js";import{F as ht}from"./Footer-DUFQcqXk.js";import{i as xt}from"./breadcrumbSchema-BG74ATTs.js";import"./beacon-BB01f5iw.js";import"./mobileOptimization-ILGdA5i5.js";import"./sanitizer-bb09M-iY.js";const wt=()=>{const[r,y]=i.useState(!1),[A,h]=i.useState(0),n=3,W=1e4,u="https://embed.laylo.com/laylo-sdk.js";i.useCallback(()=>typeof window<"u"&&(window.Laylo!==void 0||document.querySelector(`script[src="${u}"]`)!==null),[]);const g=i.useCallback(()=>new Promise((w,R)=>{if(document.querySelector(`script[src="${u}"]`)){const U=()=>{window.Laylo||document.readyState==="complete"?w():setTimeout(U,100)};U();return}const d=document.createElement("script");d.src=u,d.async=!0;const G=setTimeout(()=>{d.remove(),R(new Error("Script load timeout"))},W);d.onload=()=>{clearTimeout(G),setTimeout(w,200)},d.onerror=()=>{clearTimeout(G),d.remove(),R(new Error("Script load failed"))},document.head.appendChild(d)}),[]),H=i.useCallback(async(w=0)=>{if(!r)try{await g(),y(!0),console.log("🎉 Laylo SDK ready")}catch(R){if(w<n-1){const k=Math.pow(2,w)*1e3;h(w+1),console.warn(`⚠️ Laylo SDK load failed (attempt ${w+1}), retrying in ${k}ms...`),setTimeout(()=>H(w+1),k)}else console.error("❌ Laylo SDK failed to load after retries:",R.message)}},[r,g]);return i.useEffect(()=>{H(0)},[H]),r},vt=({dropId:r,color:y="ff0409",theme:A="dark",background:h="solid",minimal:n=!0,style:W={},visible:u=!0})=>{const[g,H]=i.useState(0),[w,R]=i.useState(0),k=i.useRef(0),d=i.useRef(null),G=i.useRef(!1),U=2,q=7e3,ce=i.useMemo(()=>{if(typeof navigator>"u")return!1;const D=navigator.userAgent,x=/AppleWebKit/i.test(D),b=/iP(hone|od|ad)|Mobile/i.test(D),T=/CriOS/i.test(D),de=/FxiOS/i.test(D);return x&&b&&!T&&!de},[]),[te,v]=i.useState(null),j=i.useRef(u),Z=i.useRef(0),p=1e3,B=D=>(D||"")+((D||"").includes("?")?"&":"?")+"_ts="+Date.now(),I=i.useMemo(()=>r?`https://embed.laylo.com/?${new URLSearchParams({dropId:r,color:y,theme:A,background:h,...n&&{minimal:"true"}}).toString()}`:null,[r,y,A,h,n]),O=(D,x)=>{const b=new Date().toISOString();console.log(`[LayloSimple ${b}] ${D}`,x??"")};i.useEffect(()=>{const D=!j.current&&u;if(!u){d.current&&(clearTimeout(d.current),d.current=null),j.current=u;return}if(!D){j.current=u;return}if(R(0),k.current=Date.now(),G.current=!1,O("Visible -> ensuring iframe src",{retryCount:0,url:I}),ce){v(null);const x=setTimeout(()=>{const b=B(I);Z.current=Date.now(),v(b)},180);return j.current=u,()=>{clearTimeout(x),d.current&&(clearTimeout(d.current),d.current=null)}}else te||(Z.current=Date.now(),v(I));j.current=u},[u,I,ce,te]),i.useEffect(()=>{if(!ce)return;const D=b=>{if(b.persisted&&u){const T=Date.now();T-Z.current>p&&(O("pageshow (persisted) -> refreshing iframe src (iOS)"),Z.current=T,G.current=!1,v(null),setTimeout(()=>{v(B(I))},180))}},x=()=>{if(document.visibilityState==="visible"&&u){const b=Date.now();b-Z.current>p&&(O("visibilitychange -> visible; refreshing iframe src (iOS)"),Z.current=b,v(T=>T??B(I)))}};return window.addEventListener("pageshow",D),document.addEventListener("visibilitychange",x),()=>{window.removeEventListener("pageshow",D),document.removeEventListener("visibilitychange",x)}},[ce,u,I]);const $=()=>{const D=Date.now()-(k.current||0);G.current=!0,d.current&&(clearTimeout(d.current),d.current=null),O("Iframe onLoad fired",{elapsedMs:D})},V=D=>{if(O("Iframe onError",{error:D}),d.current&&(clearTimeout(d.current),d.current=null),w<U){O("Error -> retry (src bust)",{retryCount:w+1}),R(b=>b+1);const x=Date.now();x-Z.current>p&&(Z.current=x,k.current=Date.now(),G.current=!1,v(B(I)))}else O("Final error -> giving up after max retries")};return i.useEffect(()=>{if(!(!u||!te))return d.current&&(clearTimeout(d.current),d.current=null),k.current=Date.now(),d.current=setTimeout(()=>{if(!G.current)if(w<U){O("Load timeout -> retry (src bust)",{retryCount:w+1}),R(x=>x+1);const D=Date.now();D-Z.current>p&&(Z.current=D,v(B(I)))}else O("Final load timeout -> giving up after max retries")},q),()=>{d.current&&(clearTimeout(d.current),d.current=null)}},[te,u,w,I]),r?u?o.jsx("iframe",{id:`laylo-drop-${r}`,title:"Laylo Signup",width:"100%",height:"100%",frameBorder:"0",scrolling:"no",allow:"web-share; clipboard-write; fullscreen; autoplay; encrypted-media; picture-in-picture",loading:"eager",onLoad:$,onError:V,style:{...W,WebkitTransform:"translateZ(0)",transform:"translateZ(0)",display:"block"},src:te??I},g):o.jsx("div",{style:{...W}}):o.jsx("div",{style:{...W,display:"flex",alignItems:"center",justifyContent:"center",minHeight:60},children:o.jsx("span",{style:{color:"#999",fontSize:14},children:"[LayloSimple] Missing dropId"})})},yt=({contentRef:r,viewportContext:y={isRealMobileDevice:!1},onStateChange:A=()=>{}})=>{const[h,n]=i.useState("");i.useState(!1);const[W,u]=i.useState(!1);i.useState("us"),i.useState("normal");const[g,H]=i.useState(!1),[w,R]=i.useState(!1),[k,d]=i.useState(!1),[G,U]=i.useState(!1),[q,ce]=i.useState(!1);i.useState(0);const te=wt();i.useState(!1);const v=!k&&te,j=v,Z=g,[p,B]=i.useState({isActive:!1,startY:0,currentY:0,startX:0,currentX:0,startTime:0,isDragging:!1,initialDrawerState:!1,isOnDrawerContent:!1,isOnDrawerHandle:!1,isOnSwipeZone:!1,dragDistance:0,isIntentionalGesture:!1,isVerticalIntent:null}),[I,O]=i.useState({expanded:!1,showDisclaimer:!1,phoneNumber:""});i.useState(!1),i.useRef(null),i.useRef(null);const $=i.useRef(null);i.useRef(null);const V=i.useRef(null),D=i.useCallback(()=>{O({expanded:g,showDisclaimer:w,phoneNumber:h}),console.log("💾 Drawer state saved, iframe content preserved")},[g,w,h]),x=i.useCallback(a=>{$.current&&!$.current.contains(a.target)&&(D(),H(!1),d(!1),R(!1))},[h,D]);i.useEffect(()=>(g&&(document.addEventListener("mousedown",x),document.addEventListener("touchstart",x)),()=>{document.removeEventListener("mousedown",x),document.removeEventListener("touchstart",x)}),[g,x]),i.useEffect(()=>{const a=document.body,m=r?.current;if(g){const M=window.scrollY;a.classList.add("drawer-scroll-lock"),a.style.top=`-${M}px`,m&&m.classList.add("drawer-active")}else{a.classList.remove("drawer-scroll-lock");const M=a.style.top;a.style.top="",M&&window.scrollTo(0,parseInt(M||"0")*-1),m&&m.classList.remove("drawer-active")}return()=>{a.classList.remove("drawer-scroll-lock"),a.style.top="",m&&m.classList.remove("drawer-active")}},[g,r]);const b=i.useRef({drawerExpanded:void 0,drawerFullyClosed:void 0,iframeExpanded:void 0,phoneSubmitted:void 0});i.useEffect(()=>{const a={drawerExpanded:g,drawerFullyClosed:k,iframeExpanded:G,phoneSubmitted:W},m=b.current;(m.drawerExpanded!==a.drawerExpanded||m.drawerFullyClosed!==a.drawerFullyClosed||m.iframeExpanded!==a.iframeExpanded||m.phoneSubmitted!==a.phoneSubmitted)&&(b.current=a,A(a))},[g,k,G,W,A]),i.useRef(!1),i.useEffect(()=>{},[k]),i.useEffect(()=>{if(v&&te&&!q){const a=setTimeout(()=>{ce(!0),console.log("✅ Laylo iframe ready for interaction")},1e3);return()=>clearTimeout(a)}},[v,te,q]);const T=i.useCallback(()=>k?"50px":G?"320px":g?"280px":"80px",[k,g,w,G]);i.useCallback(()=>{const a=T(),m=(()=>{const N="ontouchstart"in window||navigator.maxTouchPoints>0,E=/Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),Y=window.innerWidth,z=window.innerHeight,S=Y/z;return N&&E&&(S<1.5||Y<768)})(),M=parseInt(a.replace("px",""));if(m)return`calc(${a} + 20px)`;{const N=Math.max(15,M*.2);return`calc(${a} + ${N}px)`}},[T,y]);const de=i.useCallback(a=>{if(a.target.tagName==="INPUT"||a.target.tagName==="TEXTAREA"||a.target.tagName==="BUTTON"||a.target.closest("iframe")||a.target.closest("button")||a.target.closest('[role="button"]'))return;const m=a.touches[0],M=Date.now(),N=a.target.closest(".mobile-drawer-content"),E=$.current?.getBoundingClientRect(),Y=E&&m.clientY>E.top&&m.clientY<E.top+120,z=g?E?.height*.4:120,S=E&&m.clientY>E.top&&m.clientY<E.top+z;B({isActive:!0,startY:m.clientY,currentY:m.clientY,startX:m.clientX,currentX:m.clientX,startTime:M,isDragging:!1,initialDrawerState:g,isOnDrawerContent:!!N,isOnDrawerHandle:!!Y,isOnSwipeZone:!!S,dragDistance:0,isIntentionalGesture:!1,isVerticalIntent:null}),S&&!N&&(a.preventDefault(),a.stopPropagation())},[g]),ie=i.useCallback(a=>{if(!p.isActive||a.target.tagName==="INPUT"||a.target.tagName==="TEXTAREA"||a.target.tagName==="BUTTON"||a.target.closest("iframe")||a.target.closest("button")||a.target.closest('[role="button"]'))return;const m=a.touches[0],M=p.startY-m.clientY,N=Math.abs(M),E=m.clientX-p.startX,Y=Math.abs(E);if(p.isVerticalIntent===null&&(N>4||Y>4)){const z=N>=Y*1.2;if(B(S=>({...S,isVerticalIntent:z})),!z)return}if(p.isVerticalIntent!==!1){if(!p.isDragging&&N>3&&p.isOnSwipeZone&&!p.isOnDrawerContent){const z=N>8||N>3&&Date.now()-p.startTime>100;B(S=>({...S,isDragging:!0,isIntentionalGesture:z,dragDistance:N})),z&&(a.preventDefault(),a.stopPropagation())}if(p.isDragging&&p.isOnSwipeZone&&!p.isOnDrawerContent){const z=Math.max(N,p.dragDistance);p.isIntentionalGesture&&(a.preventDefault(),a.stopPropagation()),B(S=>({...S,currentY:m.clientY,currentX:m.clientX,dragDistance:z}))}else p.isOnDrawerContent||B(z=>({...z,currentY:m.clientY,currentX:m.clientX}))}},[p]),ae=i.useCallback(a=>{if(!p.isActive)return;const m=p.startY-p.currentY,M=Math.abs(m),N=Date.now()-p.startTime,E=M/N,Y=8,z=.15,S=5,K=p.isIntentionalGesture?.7:1;let re=!1;if(p.isDragging&&p.isIntentionalGesture){const Q=Y*K,C=z*K;E>C?(re=!0,console.log("🚀 Flick gesture detected:",{velocity:E,threshold:C})):M>Q?(re=!0,console.log("🚀 Swipe gesture detected:",{distance:M,threshold:Q})):M>S&&(re=!0,console.log("🚀 Snap gesture detected:",{distance:M,threshold:S}))}else p.isDragging&&!p.isIntentionalGesture&&(E>z*1.2||M>Y*1.5)&&(re=!0,console.log("🚀 Fallback gesture detected"));if(re)E>z?($.current?.classList.add("momentum-fast"),setTimeout(()=>{$.current?.classList.remove("momentum-fast")},100)):($.current?.classList.add("momentum-slow"),setTimeout(()=>{$.current?.classList.remove("momentum-slow")},250)),m>0?g||(H(!0),d(!1),console.log("🔄 Drawer opened via swipe up")):g&&(H(!1),console.log("🔄 Drawer closed via swipe down"));else{const Q=$.current?.getBoundingClientRect(),C=g?Q?.height*.4:120;Q&&p.startY>Q.top&&p.startY<Q.top+C&&(k?(d(!1),H(!0),console.log("🔄 Drawer opened via tap on swipe zone")):g?(H(!1),console.log("🔄 Drawer collapsed via tap on swipe zone")):(H(!0),console.log("🔄 Drawer expanded via tap on swipe zone")))}B({isActive:!1,startY:0,currentY:0,startX:0,currentX:0,startTime:0,isDragging:!1,initialDrawerState:!1,isOnDrawerContent:!1,isOnDrawerHandle:!1,isOnSwipeZone:!1,dragDistance:0,isIntentionalGesture:!1,isVerticalIntent:null})},[p,g,k]),J=i.useCallback(()=>{k?(d(!1),H(I.expanded||!0),R(I.showDisclaimer),I.phoneNumber&&n(I.phoneNumber)):g||(H(!0),I.showDisclaimer&&R(!0))},[k,g,I]),we=i.useCallback(a=>{a.stopPropagation(),k&&d(!1),H(!0),U(!0),setTimeout(()=>{U(!1)},1e4)},[k]);return o.jsxs(o.Fragment,{children:[o.jsx("style",{children:`
        ...
        `}),o.jsxs("div",{className:"mobile-container",style:{background:"#000000",fontFamily:"Inter, sans-serif"},role:"main","aria-label":"BOUNCE2BOUNCE Mobile Experience",children:[o.jsxs("main",{style:{width:"100vw",height:"100vh",maxWidth:"100vw",maxHeight:"100vh",margin:"0",position:"relative",background:"#000000",display:"flex",flexDirection:"column",overflow:"hidden",minHeight:"100vh",minWidth:"100vw",isolation:"isolate",transform:"none",willChange:"auto",WebkitOverflowScrolling:"auto",WebkitTransform:"none",touchAction:"manipulation",overscrollBehavior:"contain"},"aria-label":"Mobile homepage content",children:[o.jsx(mt,{currentPage:ot,scrollY:tt,onNavigate:at,onMenuToggle:H}),o.jsxs("div",{ref:Ie,className:"mobile-content-container",style:{flex:"1 1 auto",width:"100%",background:"#000000",display:"flex",flexDirection:"column",justifyContent:"flex-start",alignItems:"center",paddingTop:et,paddingLeft:"0px",paddingRight:"0px",paddingBottom:rt(),boxSizing:"border-box",overflow:"auto",overflowX:"hidden",WebkitOverflowScrolling:"touch",overscrollBehavior:"contain",WebkitOverscrollBehavior:"contain",scrollBehavior:"auto",transform:"translateZ(0)",WebkitTransform:"translateZ(0)",willChange:"auto",touchAction:"pan-y",WebkitTouchCallout:"none",WebkitUserSelect:"none",scrollSnapType:"none",WebkitScrollSnapType:"none",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden"},children:[o.jsxs("section",{"aria-labelledby":"events-section-title",style:{width:"100%",marginTop:"2px",marginBottom:"4px",opacity:be?1:0,transform:be?"translateY(0)":"translateY(16px)",transition:"opacity var(--animation-duration-normal) var(--animation-easing-decelerate), transform var(--animation-duration-normal) var(--animation-easing-decelerate)",transitionDelay:"0ms"},children:[o.jsxs("div",{style:{display:"flex",width:"min(344px, calc(100vw - 4px))",justifyContent:"space-between",alignItems:"center",marginBottom:"8px",margin:"0 auto 8px auto",boxSizing:"border-box"},children:[o.jsx("h2",{id:"events-section-title",style:{color:"#FFF",fontFamily:"Inter",fontSize:"32px",fontWeight:"800",lineHeight:"normal",margin:0,textAlign:"left"},children:"Events"}),o.jsxs("div",{style:{display:"flex",width:"118px",height:"34px",padding:"2px",justifyContent:"center",alignItems:"center",flexShrink:0,borderRadius:"9px",background:"rgba(22, 22, 22, 0.30)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",border:"1px solid rgba(255, 255, 255, 0.12)",position:"relative",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",WebkitTapHighlightColor:"transparent",boxShadow:"0px 4px 4px 0px rgba(0, 0, 0, 0.25)"},onClick:()=>Me(!C),role:"switch","aria-checked":C,"aria-label":`Switch to ${C?"Past":"Next"} events`,tabIndex:0,onKeyDown:e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),Me(!C))},onTouchStart:e=>{e.currentTarget.style.transform="scale(0.98)"},onTouchEnd:e=>{e.currentTarget.style.transform="scale(1)"},onMouseDown:e=>{e.currentTarget.style.transform="scale(0.98)"},onMouseUp:e=>{e.currentTarget.style.transform="scale(1)"},onMouseLeave:e=>{e.currentTarget.style.transform="scale(1)"},children:[o.jsx("div",{style:{position:"absolute",width:"57px",height:"30px",borderRadius:"7px",border:"0.5px solid rgba(0, 0, 0, 0.04)",background:"#FFF",boxShadow:"0 3px 8px 0 rgba(0, 0, 0, 0.12), 0 3px 1px 0 rgba(0, 0, 0, 0.04)",left:C?"2px":"59px",top:"2px",transition:"left 0.3s cubic-bezier(0.4, 0, 0.2, 1)",zIndex:1}}),o.jsx("div",{style:{display:"flex",padding:"3px 10px",alignItems:"center",flex:"1 0 0",alignSelf:"stretch",borderRadius:"7px",position:"relative",zIndex:2},children:o.jsx("span",{style:{display:"-webkit-box",WebkitBoxOrient:"vertical",WebkitLineClamp:1,flex:"1 0 0",overflow:"hidden",color:C?"#000":"#FFF",textAlign:"center",fontFeatureSettings:"'liga' off, 'clig' off",textOverflow:"ellipsis",fontFamily:"Inter",fontSize:"13px",fontStyle:"normal",fontWeight:C?"590":"400",lineHeight:"18px",letterSpacing:"-0.08px",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)"},children:"Next"})}),o.jsx("div",{style:{display:"flex",padding:"3px 10px",alignItems:"center",flex:"1 0 0",alignSelf:"stretch",position:"relative",zIndex:2},children:o.jsx("span",{style:{display:"-webkit-box",WebkitBoxOrient:"vertical",WebkitLineClamp:1,flex:"1 0 0",overflow:"hidden",color:C?"#FFF":"#000",textAlign:"center",fontFeatureSettings:"'liga' off, 'clig' off",textOverflow:"ellipsis",fontFamily:"Inter",fontSize:"13px",fontStyle:"normal",fontWeight:C?"400":"590",lineHeight:"18px",letterSpacing:"-0.08px",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)"},children:"Past"})})]})]}),C&&se.length>0&&o.jsx("div",{style:{width:"100%",transition:"opacity 0.3s cubic-bezier(0.4, 0, 0.2, 1), transform 0.3s cubic-bezier(0.4, 0, 0.2, 1), margin 0.3s cubic-bezier(0.4, 0, 0.2, 1)",opacity:C?1:0,transform:C?"translateY(0)":"translateY(-20px)",marginBottom:C?"20px":"0px",overflow:"hidden"},children:se.map((e,l)=>o.jsx("div",{className:fe?"event-card-spring":"event-card-hidden",style:{width:"100%",padding:"0",marginBottom:"2px",boxSizing:"border-box",display:"flex",justifyContent:"center",opacity:fe?1:0,transform:fe?"translateY(0) scale(1)":"translateY(20px) scale(0.96)",transition:"opacity var(--animation-duration-slow) var(--animation-easing-standard), transform var(--animation-duration-slow) var(--animation-easing-standard)",transitionDelay:fe?`${l*120}ms`:"0s"},children:o.jsxs("div",{onClick:t=>{console.log("🔍 Mobile Featured Event: Click detected!",t.target),t.preventDefault(),t.stopPropagation(),e?.ticketsUrl&&e.ticketsUrl!=="#"?(console.log(`🎫 Mobile Featured Event: Opening ticket link for ${e.title}:`,e.ticketsUrl),window.open(e.ticketsUrl,"_blank","noopener,noreferrer")):(console.log("🎫 Mobile Featured Event: No ticket link available for",e?.title),console.log("🔍 Mobile Featured Event data:",e),console.log("🔍 Available fields:",Object.keys(e||{})))},style:{width:"min(344px, calc(100vw - 4px))",height:"min(344px, calc(100vw - 4px))",position:"relative",margin:"0 auto",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",transform:"scale(1)",borderRadius:"20px",overflow:"hidden"},onTouchStart:t=>{t.currentTarget.style.transform="scale(0.98)"},onTouchEnd:t=>{t.currentTarget.style.transform="scale(1)"},role:"button",tabIndex:0,"aria-label":"View featured event details",children:[o.jsx("div",{style:{position:"absolute",left:"0px",top:"0px",width:"100%",height:"100%",borderRadius:"20px",overflow:"hidden"},children:e.coverImage?o.jsxs("picture",{children:[o.jsx("source",{srcSet:St(e.coverImage,"hero"),sizes:"(max-width: 320px) 320px, (max-width: 375px) 375px, (max-width: 414px) 414px, 640px",type:"image/avif"}),o.jsx("source",{srcSet:It(e.coverImage,"hero"),sizes:"(max-width: 320px) 320px, (max-width: 375px) 375px, (max-width: 414px) 414px, 640px",type:"image/webp"}),o.jsx("img",{crossOrigin:"anonymous",referrerPolicy:"no-referrer",src:Se(e.coverImage,375),alt:`${e.title} - Featured Event`,loading:"eager",decoding:"async",fetchpriority:"high",onLoad:()=>console.log("✅ MOBILE FEATURED EVENT HERO IMAGE LOADED:",e.title),onError:t=>{console.error("❌ MOBILE FEATURED EVENT HERO IMAGE FAILED:",t.target.src),t.target.dataset.heroFallbackAttempted?(t.target.removeAttribute("onError"),console.error("❌ Hero fallback also failed, removing error handler")):(t.target.dataset.heroFallbackAttempted="true",t.target.src="/images/optimized/hero-left-image-375w.jpg")},style:{position:"absolute",left:"0px",top:"0px",width:"100%",height:"100%",objectFit:"cover",objectPosition:"center",zIndex:1}})]}):o.jsxs("picture",{children:[o.jsx("source",{srcSet:"/images/optimized/hero-left-image-320w.avif 320w, /images/optimized/hero-left-image-375w.avif 375w, /images/optimized/hero-left-image-414w.avif 414w, /images/optimized/hero-left-image-640w.avif 640w",sizes:"(max-width: 320px) 320px, (max-width: 375px) 375px, (max-width: 414px) 414px, 640px",type:"image/avif"}),o.jsx("source",{srcSet:"/images/optimized/hero-left-image-320w.webp 320w, /images/optimized/hero-left-image-375w.webp 375w, /images/optimized/hero-left-image-414w.webp 414w, /images/optimized/hero-left-image-640w.webp 640w",sizes:"(max-width: 320px) 320px, (max-width: 375px) 375px, (max-width: 414px) 414px, 640px",type:"image/webp"}),o.jsx("img",{crossOrigin:"anonymous",referrerPolicy:"no-referrer",src:"/images/optimized/hero-left-image-375w.jpg",alt:"Default Hero Background",loading:"eager",decoding:"async",fetchpriority:"high",onLoad:()=>console.log("✅ MOBILE DEFAULT HERO IMAGE LOADED"),onError:t=>console.error("❌ MOBILE DEFAULT HERO IMAGE FAILED:",t.target.src),style:{position:"absolute",left:"0px",top:"0px",width:"100%",height:"100%",objectFit:"cover",objectPosition:"center",zIndex:1}})]})}),o.jsx("div",{style:{position:"absolute",left:"0px",top:"0px",width:"100%",height:"100%",background:"linear-gradient(180deg, rgba(0, 0, 0, 0.00) 30%, rgba(0, 0, 0, 0.25) 50%, rgba(0, 0, 0, 0.65) 70%, rgba(0, 0, 0, 0.90) 90%)",borderRadius:"20px",pointerEvents:"none",zIndex:2,WebkitTransform:"translateZ(0)",transform:"translateZ(0)",WebkitBackfaceVisibility:"hidden",backfaceVisibility:"hidden"}}),o.jsxs("div",{style:{position:"absolute",left:"0px",bottom:"8px",display:"flex",width:"100%",justifyContent:"space-between",padding:"0px 10px 0px 16px",gap:"12px",boxSizing:"border-box",zIndex:3,minHeight:"44px",WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale",textRendering:"optimizeLegibility",opacity:1,transform:"translateZ(0)",willChange:"transform"},children:[o.jsxs("div",{style:{display:"flex",flex:"1",padding:"0px 0px",flexDirection:"column",minWidth:0,maxWidth:"calc(100% - 132px)"},children:[o.jsxs("div",{style:{display:"flex",alignSelf:"stretch",alignItems:"center",gap:"6px",minWidth:0,marginBottom:"1px"},children:[o.jsx("svg",{width:"12",height:"12",viewBox:"0 0 10 10",fill:"none",style:{flexShrink:0},children:o.jsx("path",{d:"M1 3h8v6H1V3zm2-2v1m4-1v1M1 5h8",stroke:"#FFF",strokeWidth:"0.5"})}),o.jsx("span",{style:{color:"#FFF",fontFamily:"Inter",fontSize:"12px",fontWeight:"200",lineHeight:"normal",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",flex:1,minWidth:0,WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale",textRendering:"optimizeLegibility",textShadow:"0 1px 2px rgba(0, 0, 0, 0.7)",opacity:1},children:Le?Le(e.eventData||e,"hero",!0)?.date||e.date||"March 29th, 9:00 P.M.":e.date||"March 29th, 9:00 P.M."})]}),o.jsxs("div",{style:{display:"flex",alignSelf:"stretch",alignItems:"center",gap:"4px",minWidth:0},children:[o.jsxs("svg",{width:"12",height:"12",viewBox:"0 0 10 10",fill:"none",style:{flexShrink:0},children:[o.jsx("path",{d:"M5 1a3 3 0 0 0-3 3c0 2 3 5 3 5s3-3 3-5a3 3 0 0 0-3-3z",stroke:"#FFF",strokeWidth:"0.5"}),o.jsx("circle",{cx:"5",cy:"4",r:"1",fill:"#FFF"})]}),o.jsx("span",{style:{color:"#FFF",fontFamily:"Inter",fontSize:"12px",fontWeight:"200",lineHeight:"normal",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",flex:1,minWidth:0,WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale",textRendering:"optimizeLegibility",textShadow:"0 1px 2px rgba(0, 0, 0, 0.7)",opacity:1},children:e.location||"Asbury Park, NJ"})]})]}),o.jsx("div",{style:{display:"flex",width:"120px",height:"44px",padding:"2px",justifyContent:"center",alignItems:"center",flexShrink:0,zIndex:3},children:o.jsx("div",{style:{display:"flex",width:"116px",height:"40px",justifyContent:"center",alignItems:"center",gap:"8px",borderRadius:"22px",background:"rgba(15, 15, 15, 0.95)",backdropFilter:"blur(20px) saturate(180%)",WebkitBackdropFilter:"blur(20px) saturate(180%)",border:"1px solid rgba(255, 255, 255, 0.2)",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",transform:"scale(1)",boxShadow:"0 4px 16px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1)"},onTouchStart:t=>{t.stopPropagation(),t.target.style.transform="scale(0.95)",t.target.style.background="rgba(35, 35, 35, 0.98)",t.target.style.boxShadow="0 2px 8px rgba(0, 0, 0, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.05)"},onTouchEnd:t=>{t.stopPropagation(),t.target.style.transform="scale(1)",t.target.style.background="rgba(15, 15, 15, 0.95)",t.target.style.boxShadow="0 4px 16px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1)"},onClick:t=>{t.stopPropagation(),e.isRealEvent&&e.hasTicketLink&&(console.log(`🎫 Opening ticket link for ${e.title}:`,e.ticketsUrl),window.open(e.ticketsUrl,"_blank","noopener,noreferrer"))},children:o.jsx("span",{style:{color:"#FFF",fontFamily:"Inter",fontSize:"15px",fontWeight:"500",lineHeight:"normal",pointerEvents:"none",textShadow:"0 1px 2px rgba(0, 0, 0, 0.5)"},children:e.isRealEvent&&e.hasTicketLink?e.buttonText||"Get Tickets":"View Event"})})})]}),o.jsx("div",{style:{position:"absolute",left:"0px",bottom:"50px",display:"flex",width:"100%",height:"auto",minHeight:"32px",padding:"8px 16px",justifyContent:"flex-start",alignItems:"flex-end",gap:"10px",boxSizing:"border-box",zIndex:2,pointerEvents:"none",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden",transform:"translateZ(0)",willChange:"transform"},children:o.jsx("div",{style:{color:"#FFFFFF",fontFamily:'Inter, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',fontSize:"24px",fontWeight:"800",lineHeight:"1.1",flex:"1",display:"-webkit-box",WebkitBoxOrient:"vertical",WebkitLineClamp:2,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"normal",maxWidth:"100%",margin:"0px 0px 4px 0px",WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale",textRendering:"optimizeLegibility",textShadow:"0 1px 3px rgba(0, 0, 0, 0.8), 0 0 8px rgba(0, 0, 0, 0.6)",transform:"translateZ(0)",willChange:"transform"},children:e.title||"FEATURED EVENT"})})]})},`hero-${e.id}`))}),C&&se.length===0&&pe.length>0&&o.jsx("div",{className:fe?"event-card-spring":"event-card-hidden",style:{width:"100%",padding:"0",marginBottom:"0px",boxSizing:"border-box",display:"flex",justifyContent:"center"},children:o.jsxs("div",{style:{width:"min(344px, calc(100vw - 4px))",height:"min(344px, calc(100vw - 4px))",position:"relative",margin:"0 auto",borderRadius:"20px",overflow:"hidden",background:"linear-gradient(180deg, rgba(0, 0, 0, 0.00) 30%, rgba(0, 0, 0, 0.90) 90%)"},children:[o.jsx("img",{crossOrigin:"anonymous",referrerPolicy:"no-referrer",src:"/images/optimized/hero-left-image-375w.jpg",alt:"Default Hero Background",style:{position:"absolute",left:"0px",top:"0px",width:"100%",height:"100%",objectFit:"cover",objectPosition:"center",zIndex:1}}),o.jsx("div",{style:{position:"absolute",left:"0px",bottom:"95px",display:"flex",width:"100%",height:"48px",padding:"8px 16px",justifyContent:"flex-start",alignItems:"flex-end",gap:"10px",boxSizing:"border-box",zIndex:2},children:o.jsx("div",{style:{color:"#FFF",fontFamily:"Inter",fontSize:"24px",fontWeight:"800",lineHeight:"1.1"},children:C?"UPCOMING EVENTS":"PAST EVENTS"})})]})}),o.jsxs("div",{style:{width:"min(344px, calc(100vw - 4px))",margin:"0 auto",position:"relative",paddingBottom:pe.length>3?"4px":"0",background:"#000000"},children:[o.jsxs("div",{className:`mobile-event-cards-container ${ge?"expanded":"collapsed"}`,style:{width:"100%",position:"relative",background:"#000000"},children:[o.jsx("div",{role:"list","aria-label":C?"Upcoming live music events":"Past live music events",style:{display:"flex",width:"100%",flexDirection:"column",justifyContent:"center",alignItems:"stretch",gap:"4px",flexShrink:0,padding:"4px 0",boxSizing:"border-box",minHeight:"auto",overflow:"visible",position:"relative",zIndex:1},children:pe.length>0?pe.map((e,l)=>o.jsx("article",{className:`mobile-event-card-item ${fe?"event-card-spring":"event-card-hidden"}`,style:{width:"100%",minHeight:"132px",height:"auto",borderRadius:"20px",background:"rgba(15, 15, 15, 0.95)",backdropFilter:"blur(20px) saturate(180%)",WebkitBackdropFilter:"blur(20px) saturate(180%)",border:"1px solid rgba(255, 255, 255, 0.12)",boxShadow:"0 8px 32px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.08)",position:"relative",margin:"0 0 4px 0",padding:"2px",overflow:"hidden",boxSizing:"border-box",isolation:"isolate",transform:"translateZ(0)",willChange:"transform, opacity",contain:"layout style paint",zIndex:1,clear:"both"},children:o.jsxs("div",{style:{width:"100%",height:"124px",position:"relative",display:"flex",alignItems:"center",justifyContent:"center",boxSizing:"border-box",padding:"2px"},children:[o.jsx("div",{style:{position:"absolute",left:"2px",top:"2px",width:"120px",height:"120px",flexShrink:0,borderRadius:"20px",overflow:"hidden",cursor:"pointer",zIndex:100,transition:"transform 0.1s ease",boxSizing:"border-box"},onClick:t=>{t.preventDefault(),t.stopPropagation();const s=t.currentTarget.querySelector("img");Re(e,s)},onTouchStart:t=>{t.currentTarget.style.transform="scale(0.95)"},onTouchEnd:t=>{t.preventDefault(),t.stopPropagation(),t.currentTarget.style.transform="scale(1)";const s=t.currentTarget.querySelector("img");Re(e,s)},onTouchCancel:t=>{t.currentTarget.style.transform="scale(1)"},onMouseDown:t=>{t.currentTarget.style.transform="scale(0.95)"},onMouseUp:t=>{t.currentTarget.style.transform="scale(1)"},onMouseLeave:t=>{t.currentTarget.style.transform="scale(1)"},children:o.jsx("img",{crossOrigin:"anonymous",referrerPolicy:"no-referrer",width:"120",height:"120",src:(()=>{const t=Se(e.coverImage,120);return console.log(`🖼️ Loading homepage image for "${e.title}":`,{original:e.coverImage,optimized:t,isDataUrl:e.coverImage?.startsWith("data:"),isNewImageSystem:e.coverImage?.includes("/api/images/serve/"),hostname:window.location.hostname}),t})(),srcSet:e.image_srcset?Object.entries(e.image_srcset).map(([t,s])=>`${s} ${t}`).join(", "):void 0,sizes:"(max-width: 768px) 100vw, 400px",alt:e.image_alt_text||`${e.title} event cover`,title:e.image_title||e.title,loading:"lazy",decoding:"async",onError:t=>{const s=parseInt(t.target.dataset.fallbackAttempt||"0"),c=2,f=t.target.src,L=e.id||e.title;if(window.failedImages||(window.failedImages=new Set),window.failedImages.has(f)){console.log("🛑 Global circuit breaker: Image URL previously failed, using placeholder immediately"),t.target.src="data:image/svg+xml;base64,",t.target.dataset.fallbackAttempt="final",t.target.removeAttribute("onError");return}if(s>=c){console.log(`🛑 Circuit breaker: Max fallback attempts (${c}) reached for ${L}, using placeholder`),window.failedImages.add(f),t.target.src="data:image/svg+xml;base64,",t.target.dataset.fallbackAttempt="final",t.target.removeAttribute("onError");return}if(console.log(`❌ Homepage event image failed (attempt ${s+1}/${c}):`,L,"URL:",f),window.failedImages.add(f),f.includes("/api/images/serve/")&&(console.error("🚨 API image serving failed - check persistent storage pipeline"),console.error("📋 UUID extraction:",f.match(/\/api\/images\/serve\/([a-f0-9-]{36})/))),s===0){const ne=`${window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click"}/api/images/placeholder`;console.log("🔄 Trying dashboard placeholder:",ne),t.target.src=ne,t.target.dataset.fallbackAttempt="1";return}else if(s===1){console.log("🔄 Using final inline SVG placeholder"),t.target.src="data:image/svg+xml;base64,",t.target.dataset.fallbackAttempt="final",t.target.removeAttribute("onError");return}console.log("🔄 Safety fallback: Using inline SVG placeholder"),t.target.src="data:image/svg+xml;base64,",t.target.dataset.fallbackAttempt="final",t.target.removeAttribute("onError")},onLoad:t=>{delete t.target.dataset.fallbackAttempt,console.log("✅ Homepage event image loaded successfully:",e.title,t.target.src),t.target.style.backgroundColor="transparent",t.target.style.opacity="1"},style:{position:"absolute",left:"4px",top:"4px",width:"112px",height:"112px",borderRadius:"17px",objectFit:"cover",backgroundColor:"#2a2a2a",opacity:"0",transition:"opacity 0.3s cubic-bezier(0.4, 0, 0.2, 1)",transform:"scale(1)",boxShadow:"none",pointerEvents:"none"}})}),o.jsxs("div",{style:{display:"flex",width:"calc(100% - 130px)",padding:"2px 2px 2px 4px",flexDirection:"column",justifyContent:"space-between",alignItems:"flex-start",position:"absolute",left:"126px",top:"2px",height:"120px",boxSizing:"border-box"},children:[o.jsxs("div",{style:{width:"100%",minHeight:"84px",height:"auto",display:"flex",flexDirection:"column",alignSelf:"stretch",flex:"1 1 auto"},children:[o.jsx("h3",{style:{fontFamily:"Inter",fontWeight:"700",fontSize:"16px",lineHeight:"1.25",textAlign:"left",color:"#FFFFFF",width:"100%",minHeight:"20px",height:"auto",margin:"0 0 4px 0",padding:"0",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:e.title}),o.jsxs("div",{style:{display:"flex",flexDirection:"row",alignItems:"center",alignSelf:"stretch",gap:"6px",padding:"0px 0px 0px 2px"},children:[o.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",style:{color:"rgba(255, 255, 255, 0.7)"},children:o.jsx("path",{d:"M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm1 11h-3V7h2v4h3v2Z",fill:"currentColor"})}),o.jsx("span",{style:{fontFamily:"Inter",fontWeight:"300",fontSize:"12px",lineHeight:"1.4",textAlign:"left",color:"rgba(255, 255, 255, 0.7)",width:"100%",height:"14px",margin:"0",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:e.date})]}),o.jsxs("div",{style:{display:"flex",flexDirection:"row",alignItems:"center",alignSelf:"stretch",gap:"6px",padding:"0px 2px"},children:[o.jsx("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",style:{color:"rgba(255, 255, 255, 0.7)"},children:o.jsx("path",{d:"M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z",fill:"currentColor"})}),o.jsx("span",{style:{fontFamily:"Inter",fontWeight:"300",fontSize:"12px",lineHeight:"1.4",textAlign:"left",color:"rgba(255, 255, 255, 0.65)",width:"100%",height:"14px",margin:"0",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:e.location})]})]}),o.jsx("div",{style:{width:"100%",height:"32px",display:"flex",flexDirection:"row",justifyContent:"flex-start",alignItems:"flex-end",gap:"6px",padding:"0px 2px 0px 0px",position:"absolute",bottom:"4px",left:"0px"},children:e.isRealEvent&&e.hasTicketLink?o.jsx("button",{onClick:t=>{t.stopPropagation(),console.log(`🎫 Opening ticket link for ${e.title}:`,e.ticketsUrl),window.open(e.ticketsUrl,"_blank","noopener,noreferrer")},style:{background:"rgba(23, 23, 23, 0.8)",borderRadius:"46px",display:"flex",flexDirection:"row",justifyContent:"center",alignItems:"center",gap:"12px",padding:"16px 15px",width:"calc(100% - 4px)",height:"32px",border:"none",cursor:"pointer",fontFamily:"Inter",fontWeight:"500",fontSize:"14px",lineHeight:"1.21",textAlign:"center",color:"#FFFFFF",transition:"all 0.2s ease",transform:"scale(1)",boxSizing:"border-box"},onMouseEnter:t=>{t.currentTarget.style.transform="scale(1.02)",t.currentTarget.style.background="rgba(23, 23, 23, 0.9)"},onMouseLeave:t=>{t.currentTarget.style.transform="scale(1)",t.currentTarget.style.background="rgba(23, 23, 23, 0.8)"},children:e.buttonText||"View Event"}):null})]})]})},`homepage-${e.id}`)):C&&se.length>0?null:o.jsxs("div",{style:{display:"flex",width:"100%",height:"200px",flexDirection:"column",justifyContent:"center",alignItems:"center",gap:"16px",color:"#FFF",fontFamily:"Inter",textAlign:"center"},children:[o.jsx("div",{style:{fontSize:"18px",fontWeight:"600",opacity:.8},children:C?"No upcoming events":"No past events"}),C&&Q?.mobile_laylo_cta_url?o.jsx("button",{type:"button","aria-label":Q?.fallback_cta_button_text||"Join Waitlist",onClick:()=>{window.open(Q.mobile_laylo_cta_url,"_blank","noopener,noreferrer")},style:{display:"inline-flex",alignItems:"center",justifyContent:"center",padding:"12px 16px",minHeight:"44px",borderRadius:"14px",fontFamily:"Inter",fontSize:"14px",fontWeight:600,color:"#FFF",background:"rgba(22, 22, 22, 0.60)",border:"1px solid rgba(255, 255, 255, 0.12)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",transition:"all 0.25s cubic-bezier(0.4, 0, 0.2, 1)",boxSizing:"border-box",cursor:"pointer",WebkitTapHighlightColor:"transparent"},onMouseEnter:e=>{e.currentTarget.style.background="rgba(38, 38, 38, 0.80)"},onMouseLeave:e=>{e.currentTarget.style.background="rgba(22, 22, 22, 0.60)"},onTouchStart:e=>{e.currentTarget.style.transform="scale(0.98)"},onTouchEnd:e=>{e.currentTarget.style.transform="scale(1)"},children:Q?.fallback_cta_button_text||"Join Waitlist"}):o.jsx("button",{type:"button","aria-label":"View Past Events",onClick:()=>Me(!1),style:{display:"inline-flex",alignItems:"center",justifyContent:"center",padding:"12px 16px",minHeight:"44px",borderRadius:"14px",fontFamily:"Inter",fontSize:"14px",fontWeight:600,color:"#FFF",background:"rgba(22, 22, 22, 0.60)",border:"1px solid rgba(255, 255, 255, 0.12)",backdropFilter:"blur(12px)",WebkitBackdropFilter:"blur(12px)",transition:"all 0.25s cubic-bezier(0.4, 0, 0.2, 1)",boxSizing:"border-box",cursor:"pointer",WebkitTapHighlightColor:"transparent"},onMouseEnter:e=>{e.currentTarget.style.background="rgba(38, 38, 38, 0.80)"},onMouseLeave:e=>{e.currentTarget.style.background="rgba(22, 22, 22, 0.60)"},onTouchStart:e=>{e.currentTarget.style.transform="scale(0.98)"},onTouchEnd:e=>{e.currentTarget.style.transform="scale(1)"},children:"View Past Events"})]})}),!ge&&pe.length>3&&o.jsx("div",{className:"mobile-event-cards-overlay","aria-hidden":"true"})]}),pe.length>3&&o.jsx("div",{className:`mobile-expand-handle ${ge?"expanded":""}`,onClick:Ue,role:"button",tabIndex:0,"aria-label":ge?"Show fewer events":"Show more events","aria-expanded":ge,onKeyDown:e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),Ue())},style:{opacity:1,visibility:"visible"},children:o.jsx("div",{className:`mobile-expand-chevron ${ge?"expanded":""}`,"aria-hidden":"true"})})]})]}),o.jsxs("section",{"aria-labelledby":"follow-us-section-title",style:{width:"100%",marginTop:"2px",marginBottom:"4px",opacity:be?1:0,transform:be?"translateY(0)":"translateY(16px)",transition:"opacity var(--animation-duration-normal) var(--animation-easing-decelerate), transform var(--animation-duration-normal) var(--animation-easing-decelerate)",transitionDelay:"150ms"},children:[o.jsx("div",{style:{width:"min(344px, calc(100vw - 4px))",marginBottom:"8px",margin:"0 auto 8px auto",boxSizing:"border-box"},children:o.jsx("h2",{id:"follow-us-section-title",style:{color:"#FFF",fontFamily:"Inter",fontSize:"32px",fontWeight:"800",lineHeight:"1.2",margin:0,textAlign:"left"},children:"Follow Us"})}),o.jsxs("article",{style:{width:"min(344px, calc(100vw - 4px))",height:"200px",position:"relative",flexShrink:0,margin:"0 auto",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",transform:"scale(1)",borderRadius:"20px",overflow:"hidden"},"aria-label":"Henry Fong live performance video",children:[o.jsxs("div",{style:{position:"absolute",left:"0px",top:"0px",width:"100%",height:"100%",borderRadius:"20px",overflow:"hidden"},children:[o.jsx("div",{style:{position:"absolute",top:"0",left:"0",width:"100%",height:"100%",overflow:"hidden",transform:"translateZ(0)",willChange:"auto"},children:h?lt:W?o.jsx("iframe",{src:st,title:"Henry Fong YouTube Video - Adaptive Quality",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; fullscreen",loading:"lazy",style:{position:"absolute",top:"0",left:"0",width:"100%",height:"100%",transform:"translateZ(0)",pointerEvents:"none",border:"none",opacity:1,backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden"}}):o.jsx("div",{style:{position:"absolute",top:"0",left:"0",width:"100%",height:"100%",background:"linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 100%)",border:"none",transform:"translateZ(0)"}})}),o.jsx("div",{style:{position:"absolute",top:"0",left:"0",width:"100%",height:"100%",background:"linear-gradient(189deg, rgba(143, 143, 143, 0.00) 8.88%, rgba(0, 0, 0, 0.77) 77.64%)",borderRadius:"20px",zIndex:1,transform:"translateZ(0)",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden",willChange:"auto",pointerEvents:"none"}})]}),o.jsxs("div",{style:{position:"absolute",left:"0px",bottom:"16px",display:"flex",width:"100%",height:"40px",padding:"8px 16px",justifyContent:"space-between",alignItems:"flex-end",gap:"12px",zIndex:2,boxSizing:"border-box",pointerEvents:"none",transform:"translateZ(0)",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden",willChange:"auto"},children:[o.jsxs("div",{style:{display:"flex",flexDirection:"column",justifyContent:"flex-end",gap:"2px",flex:"1"},children:[o.jsx("div",{style:{color:"#FFF",fontFamily:"Inter",fontSize:"18px",fontWeight:"800",lineHeight:"1.1",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:"Watch on YouTube"}),o.jsx("div",{style:{color:"#FFF",fontFamily:"Inter",fontSize:"9px",fontWeight:"200",lineHeight:"normal"},children:"Henry Fong full set live"})]}),o.jsx("div",{onClick:e=>{e.stopPropagation(),window.open("https://youtu.be/vEHTO3gf1jk?si=87b8o-daRyN2O6sx","_blank")},style:{display:"flex",minWidth:"90px",height:"36px",justifyContent:"center",alignItems:"center",pointerEvents:"auto",borderRadius:"18px",background:"rgba(38, 38, 38, 0.80)",cursor:"pointer",transition:"all 0.3s ease",transform:"scale(1)",boxSizing:"border-box"},onTouchStart:e=>{e.stopPropagation(),e.currentTarget.style.transform="scale(0.95)",e.currentTarget.style.background="rgba(58, 58, 58, 0.90)"},onTouchEnd:e=>{e.stopPropagation(),e.currentTarget.style.transform="scale(1)",e.currentTarget.style.background="rgba(38, 38, 38, 0.80)"},children:o.jsx("span",{style:{color:"#FFF",fontFamily:"Inter",fontSize:"11px",fontWeight:"600",lineHeight:"normal"},children:"Watch now"})})]})]})]}),o.jsx("section",{style:{width:"100%",padding:"0",margin:"0",marginTop:"8px",boxSizing:"border-box",display:"flex",justifyContent:"center",alignItems:"center",opacity:be?1:0,transform:be?"translateY(0)":"translateY(16px)",transition:"opacity var(--animation-duration-normal) var(--animation-easing-decelerate), transform var(--animation-duration-normal) var(--animation-easing-decelerate)",transitionDelay:"300ms"},children:o.jsx("div",{style:{width:"min(344px, calc(100vw - 4px))",display:"flex",justifyContent:"center",alignItems:"center",margin:"0 auto"},children:o.jsx(bt,{})})})]}),o.jsx("div",{style:{display:b?"none":"block",visibility:b?"hidden":"visible"},children:o.jsx(ht,{compact:!0})})]}),!g&&o.jsx(yt,{contentRef:Ie,viewportContext:ze,onStateChange:e=>{const{drawerExpanded:l,drawerFullyClosed:t}=e;console.log("Drawer state changed:",e,`status=${t?"fullyClosed":l?"expanded":"collapsed"}`)}})]}),X&&o.jsxs("div",{style:{position:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundColor:"rgba(0, 0, 0, 0.7)",backdropFilter:"blur(30px)",WebkitBackdropFilter:"blur(30px)",zIndex:10001,display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",padding:"20px",boxSizing:"border-box",overflow:"hidden",overscrollBehavior:"none",touchAction:"none",animation:"expandedImageFadeIn 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards"},onClick:We,onTouchMove:e=>{e.preventDefault(),e.stopPropagation()},onWheel:e=>{e.preventDefault(),e.stopPropagation()},children:[o.jsx("div",{style:{width:"min(80vw, 80vh)",height:"min(80vw, 80vh)",aspectRatio:"1 / 1",borderRadius:"20px",overflow:"hidden",marginBottom:"20px",animation:"expandedImageScale 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94) forwards",boxShadow:"0 20px 60px rgba(0, 0, 0, 0.6)",border:"1px solid rgba(255, 255, 255, 0.1)",cursor:"pointer"},onClick:e=>e.stopPropagation(),children:o.jsx("img",{crossOrigin:"anonymous",referrerPolicy:"no-referrer",src:X.imageUrl,alt:X.title,style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}})}),o.jsxs("div",{style:{display:"flex",gap:"16px",animation:"expandedButtonsSlideUp 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94) 0.2s both"},onClick:e=>e.stopPropagation(),children:[o.jsx("button",{onClick:()=>{navigator.share?navigator.share({title:X.title,text:`Check out this event: ${X.title}`,url:window.location.href}):(navigator.clipboard.writeText(window.location.href),alert("Link copied to clipboard!"))},style:{background:"rgba(15, 15, 15, 0.95)",backdropFilter:"blur(20px) saturate(180%)",WebkitBackdropFilter:"blur(20px) saturate(180%)",border:"1px solid rgba(255, 255, 255, 0.2)",borderRadius:"25px",padding:"12px 24px",color:"#FFFFFF",fontFamily:"Inter",fontSize:"14px",fontWeight:"500",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",minWidth:"80px",height:"44px",boxShadow:"0 4px 16px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1)",textShadow:"0 1px 2px rgba(0, 0, 0, 0.5)"},onTouchStart:e=>{e.currentTarget.style.background="rgba(35, 35, 35, 0.98)",e.currentTarget.style.transform="scale(0.95)",e.currentTarget.style.boxShadow="0 2px 8px rgba(0, 0, 0, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.05)"},onTouchEnd:e=>{e.currentTarget.style.background="rgba(15, 15, 15, 0.95)",e.currentTarget.style.transform="scale(1)",e.currentTarget.style.boxShadow="0 4px 16px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1)"},onMouseEnter:e=>{e.currentTarget.style.background="rgba(35, 35, 35, 0.98)",e.currentTarget.style.transform="scale(1.05)",e.currentTarget.style.boxShadow="0 6px 20px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.15)"},onMouseLeave:e=>{e.currentTarget.style.background="rgba(15, 15, 15, 0.95)",e.currentTarget.style.transform="scale(1)",e.currentTarget.style.boxShadow="0 4px 16px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1)"},children:"Share"}),X.isRealEvent&&X.hasTicketLink?o.jsx("button",{onClick:()=>{console.log(`🎫 Opening ticket link from modal for ${X.title}:`,X.ticketsUrl),window.open(X.ticketsUrl,"_blank","noopener,noreferrer"),We()},style:{background:"rgba(15, 15, 15, 0.95)",backdropFilter:"blur(20px) saturate(180%)",WebkitBackdropFilter:"blur(20px) saturate(180%)",border:"1px solid rgba(255, 255, 255, 0.2)",borderRadius:"25px",padding:"12px 24px",color:"#FFFFFF",fontFamily:"Inter",fontSize:"14px",fontWeight:"500",cursor:"pointer",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",minWidth:"100px",height:"44px",boxShadow:"0 4px 16px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1)",textShadow:"0 1px 2px rgba(0, 0, 0, 0.5)"},onTouchStart:e=>{e.currentTarget.style.background="rgba(35, 35, 35, 0.98)",e.currentTarget.style.transform="scale(0.95)",e.currentTarget.style.boxShadow="0 2px 8px rgba(0, 0, 0, 0.6), inset 0 1px 0 rgba(255, 255, 255, 0.05)"},onTouchEnd:e=>{e.currentTarget.style.background="rgba(15, 15, 15, 0.95)",e.currentTarget.style.transform="scale(1)",e.currentTarget.style.boxShadow="0 4px 16px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1)"},onMouseEnter:e=>{e.currentTarget.style.background="rgba(35, 35, 35, 0.98)",e.currentTarget.style.transform="scale(1.05)",e.currentTarget.style.boxShadow="0 6px 20px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.15)"},onMouseLeave:e=>{e.currentTarget.style.background="rgba(15, 15, 15, 0.95)",e.currentTarget.style.transform="scale(1)",e.currentTarget.style.boxShadow="0 4px 16px rgba(0, 0, 0, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.1)"},children:X.buttonText||"View Event"}):null]})]})]})};export{Ft as default};
