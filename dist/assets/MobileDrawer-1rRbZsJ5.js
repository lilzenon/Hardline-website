import{b as t}from"./vendor-ViNJc2wV.js";import{j as n}from"./index-mtJnWiaw.js";import{S as Z}from"./SocialMediaButtons-fsS5Y7uB.js";const J=(m=null,R={})=>{const{throttleMs:v=32,threshold:o=20,passive:C=!0}=R,[L,D]=t.useState({scrollY:0,scrollX:0,isScrolled:!1,direction:"none",velocity:0}),i=t.useRef(0),k=t.useRef(0),F=t.useRef(0),E=t.useRef(0),T=t.useRef(null),I=t.useRef(!1),r=t.useCallback(l=>{if(I.current)return;I.current=!0,window.innerWidth<=767?setTimeout(()=>{const h=performance.now(),c=l.target===document?document.documentElement:l.target,f=c.scrollTop||window.pageYOffset||0,g=c.scrollLeft||window.pageXOffset||0,y=f-i.current,s=g-k.current,p=h-F.current;let d="none";Math.abs(y)>Math.abs(s)?d=y>0?"down":y<0?"up":"none":Math.abs(s)>0&&(d=s>0?"right":"left");const x=(p>0?Math.abs(y)/p:0)*.3+E.current*.7;D({scrollY:f,scrollX:g,isScrolled:f>o,direction:d,velocity:x}),i.current=f,k.current=g,F.current=h,E.current=x,setTimeout(()=>{I.current=!1},v)},v):(T.current&&cancelAnimationFrame(T.current),T.current=requestAnimationFrame(()=>{const h=performance.now(),c=l.target===document?document.documentElement:l.target,f=c.scrollTop||window.pageYOffset||0,g=c.scrollLeft||window.pageXOffset||0,y=f-i.current,s=g-k.current,p=h-F.current;let d="none";Math.abs(y)>Math.abs(s)?d=y>0?"down":y<0?"up":"none":Math.abs(s)>0&&(d=s>0?"right":"left");const x=(p>0?Math.abs(y)/p:0)*.3+E.current*.7;D({scrollY:f,scrollX:g,isScrolled:f>o,direction:d,velocity:x}),i.current=f,k.current=g,F.current=h,E.current=x,setTimeout(()=>{I.current=!1},v)}))},[v,o]);return t.useEffect(()=>{const l=m||window,b={passive:C};return requestAnimationFrame(()=>{const h=m?m.scrollTop:window.pageYOffset||0,c=m?m.scrollLeft:window.pageXOffset||0;D({scrollY:h,scrollX:c,isScrolled:h>o,direction:"none",velocity:0}),i.current=h,k.current=c,F.current=performance.now()}),l.addEventListener("scroll",r,b),()=>{l.removeEventListener("scroll",r),T.current&&cancelAnimationFrame(T.current)}},[m,r,o]),L},Q=({currentPage:m="events",scrollY:R=0,onNavigate:v=()=>{}})=>{const[o,C]=t.useState(!1),L=()=>{C(!o)},D=i=>{v(i),C(!1)};return t.useEffect(()=>{const i=document.body;if(o){const k=window.scrollY;i.classList.add("drawer-scroll-lock"),i.style.top=`-${k}px`}else{i.classList.remove("drawer-scroll-lock");const k=i.style.top;i.style.top="",k&&window.scrollTo(0,parseInt(k||"0")*-1)}return()=>{i.classList.remove("drawer-scroll-lock"),i.style.top=""}},[o]),n.jsxs(n.Fragment,{children:[n.jsx("style",{children:`
        ...
        `}),n.jsxs("header",{role:"banner",className:"mobile-navigation-header",onTouchMove:i=>{i.stopPropagation()},onWheel:i=>{i.stopPropagation()},style:{position:"sticky",top:"0px",width:"100%",maxWidth:"100%",margin:"0",height:"97px",minHeight:"97px",background:"rgba(0, 0, 0, 0.95)",backdropFilter:"blur(10px)",display:"flex",alignItems:"center",justifyContent:"center",padding:"0",boxSizing:"border-box",transform:"none",transformOrigin:"top center",transition:"background-color 0.3s cubic-bezier(0.4, 0, 0.2, 1), backdrop-filter 0.3s cubic-bezier(0.4, 0, 0.2, 1)",zIndex:200,flexShrink:0,contain:"layout style",willChange:"auto",backfaceVisibility:"visible",WebkitBackfaceVisibility:"visible",imageRendering:"-webkit-optimize-contrast",WebkitImageRendering:"-webkit-optimize-contrast"},children:[n.jsxs("div",{style:{width:"min(360px, calc(100vw - 16px))",maxWidth:"360px",margin:"0 auto",position:"relative",height:"100%",display:"flex",alignItems:"center",justifyContent:"center",contain:"layout style",overflow:"visible",flexShrink:0,flexGrow:0},children:[n.jsxs("div",{onClick:L,className:"mobile-menu-button",style:{position:"absolute",right:"0px",top:"50%",transform:"translateY(-50%)",width:"34px",height:"34px",cursor:"pointer",zIndex:1002,display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",gap:"4px",transformOrigin:"center center",contain:"layout style",transition:"transform 0.2s cubic-bezier(0.4, 0, 0.2, 1), opacity 0.2s ease"},children:[n.jsx("div",{style:{width:"24px",height:"2px",background:"#FFFFFF",borderRadius:"1px",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",transform:o?"rotate(45deg) translateY(6px)":"rotate(0deg) translateY(0px)",transformOrigin:"center"}}),n.jsx("div",{style:{width:"24px",height:"2px",background:"#FFFFFF",borderRadius:"1px",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",opacity:o?0:1,transform:o?"scale(0)":"scale(1)"}}),n.jsx("div",{style:{width:"24px",height:"2px",background:"#FFFFFF",borderRadius:"1px",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",transform:o?"rotate(-45deg) translateY(-6px)":"rotate(0deg) translateY(0px)",transformOrigin:"center"}})]}),n.jsx("img",{onClick:()=>v("/"),src:"/images/mobile-figma/b2b-logo-mobile.svg",alt:"B2B Logo",className:"mobile-navigation-logo",style:{width:"160px",height:"50px",position:"absolute",left:"50%",top:"50%",transform:"translate(-50%, -50%)",cursor:"pointer",userSelect:"none",zIndex:1001,willChange:"auto",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden"},onMouseDown:void 0,onMouseUp:void 0,onMouseLeave:void 0})]})," "]}),n.jsxs("div",{style:{position:"fixed",top:"0",left:"0",width:"100vw",height:"100vh",background:"rgba(0, 0, 0, 0.95)",zIndex:o?1e3:-1,display:"flex",flexDirection:"column",opacity:o?1:0,visibility:o?"visible":"hidden",transition:"all 0.4s cubic-bezier(0.4, 0, 0.2, 1)",backdropFilter:o?"blur(10px)":"blur(0px)",transform:"translateZ(0)",WebkitTransform:"translateZ(0)",willChange:"opacity, visibility, backdrop-filter",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden",pointerEvents:o?"auto":"none"},onClick:()=>C(!1),children:[n.jsxs("div",{style:{width:"min(360px, calc(100vw - 16px))",maxWidth:"360px",margin:"0 auto",height:"97px",position:"relative",background:"transparent",display:"flex",alignItems:"center",justifyContent:"center",padding:"0",boxSizing:"border-box"},children:[n.jsxs("div",{onClick:i=>{i.stopPropagation(),C(!1)},style:{position:"absolute",right:"0px",top:"50%",transform:"translateY(-50%)",width:"34px",height:"34px",cursor:"pointer",zIndex:1002,display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center",gap:"4px"},children:[n.jsx("div",{style:{width:"24px",height:"2px",background:"#FFFFFF",borderRadius:"1px",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",transform:"rotate(45deg) translateY(6px)",transformOrigin:"center"}}),n.jsx("div",{style:{width:"24px",height:"2px",background:"#FFFFFF",borderRadius:"1px",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",opacity:0,transform:"scale(0)"}}),n.jsx("div",{style:{width:"24px",height:"2px",background:"#FFFFFF",borderRadius:"1px",transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",transform:"rotate(-45deg) translateY(-6px)",transformOrigin:"center"}})]}),n.jsx("img",{src:"/images/mobile-figma/b2b-logo-mobile.svg",alt:"B2B Logo",style:{width:"160px",height:"50px",cursor:"pointer",userSelect:"none",transform:"none",transition:"none",flexShrink:0,flexGrow:0},onClick:i=>{i.stopPropagation(),v("/")},onMouseDown:void 0,onMouseUp:void 0,onMouseLeave:void 0})]}),n.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",width:"min(360px, calc(100vw - 16px))",maxWidth:"360px",margin:"0 auto",padding:"8px 8px 40px 8px",gap:"32px",transform:o?"translate3d(0, 0, 0)":"translate3d(0, -30px, 0)",opacity:1,transition:"transform 0.8s cubic-bezier(0.25, 0.46, 0.45, 0.94)",transitionDelay:o?"0.15s":"0s",willChange:"transform, opacity",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden"},onClick:i=>i.stopPropagation(),children:[n.jsx("div",{onClick:()=>D("/"),className:`mobile-nav-item ${m==="events"?"active":""}`,style:{fontFamily:"Inter",fontWeight:"800",fontSize:"64px",lineHeight:"1.21em",color:"#FFFFFF",cursor:"pointer",textAlign:"center",transform:o?"translate3d(0, 0, 0)":"translate3d(0, 40px, 0)",opacity:o?1:0,transition:"all 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94)",transitionDelay:o?"0.4s":"0s",willChange:"transform, opacity",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden",WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale"},children:"Events"}),n.jsx("div",{onClick:()=>D("/about"),className:`mobile-nav-item ${m==="about"?"active":""}`,style:{fontFamily:"Inter",fontWeight:"800",fontSize:"64px",lineHeight:"1.21em",color:"#FFFFFF",cursor:"pointer",textAlign:"center",transform:o?"translate3d(0, 0, 0)":"translate3d(0, 40px, 0)",opacity:o?1:0,transition:"all 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94)",transitionDelay:o?"0.6s":"0s",willChange:"transform, opacity",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden",WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale"},children:"About"}),n.jsx("div",{onClick:()=>D("/contact"),className:`mobile-nav-item ${m==="contact"?"active":""}`,style:{fontFamily:"Inter",fontWeight:"800",fontSize:"64px",lineHeight:"1.21em",color:"#FFFFFF",cursor:"pointer",textAlign:"center",transform:o?"translate3d(0, 0, 0)":"translate3d(0, 40px, 0)",opacity:o?1:0,transition:"all 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94)",transitionDelay:o?"0.8s":"0s",willChange:"transform, opacity",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden",WebkitFontSmoothing:"antialiased",MozOsxFontSmoothing:"grayscale"},children:"Contact"}),n.jsx("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",padding:"0px 25px 0px 25px",transform:o?"translate3d(0, 0, 0)":"translate3d(0, 40px, 0)",opacity:o?1:0,transition:"all 1.2s cubic-bezier(0.25, 0.46, 0.45, 0.94)",transitionDelay:o?"0.85s":"0s",willChange:"transform, opacity",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden"},onClick:i=>i.stopPropagation(),children:n.jsx(Z,{})})]})]})]})},G=t.memo(({dropId:m,color:R="ff0409",theme:v="dark",background:o="solid",minimal:C=!0,style:L={}})=>{const[D,i]=t.useState(!1),[k,F]=t.useState(!1),[E,T]=t.useState(!1),[I,r]=t.useState(0),l=t.useRef(null),b=t.useRef(null),h=2,c=2e3,f=t.useMemo(()=>`https://embed.laylo.com/?${new URLSearchParams({dropId:m,color:R,theme:v,background:o,...C&&{minimal:"true"}}).toString()}`,[m,R,v,o,C]),g=t.useCallback(()=>document.querySelector('script[src*="laylo-sdk.js"]')?(console.log("✅ Laylo SDK script found, proceeding with iframe"),!0):typeof window<"u"&&window.Laylo?(console.log("✅ Laylo global object found, proceeding with iframe"),!0):!1,[]),y=t.useCallback(()=>{if(!l.current)return!1;try{const d=l.current.contentDocument||l.current.contentWindow?.document;if(d&&d.querySelectorAll('[class*="laylo"], [id*="laylo"], input[type="tel"], input[placeholder*="phone"], form').length>0)return console.log("✅ Laylo content detected in iframe"),!0}catch{console.log("🔒 CORS restriction (expected), checking iframe dimensions...")}const p=l.current.getBoundingClientRect();return p.height>50&&p.width>100?(console.log("✅ Iframe has content-like dimensions, assuming loaded"),!0):!1},[]);t.useEffect(()=>{if(!m){console.warn("⚠️ LayloIframe: No dropId provided");return}if(console.log("🚀 LayloIframe: Initializing with dropId:",m),g())i(!0);else{const p=setTimeout(()=>{console.log("⏰ Laylo SDK timeout, proceeding anyway..."),i(!0)},1e3);return()=>clearTimeout(p)}},[m,g]);const s=t.useCallback(()=>{if(console.log("📡 Iframe load event fired"),F(!0),typeof window<"u"&&window.Laylo&&window.Laylo.init)try{console.log("🔄 Notifying Laylo SDK of iframe readiness"),window.Laylo.init()}catch(z){console.warn("⚠️ Laylo SDK init failed:",z)}b.current&&clearInterval(b.current);let p=0;const d=10;b.current=setInterval(()=>{p++,y()?(T(!0),clearInterval(b.current),console.log("✅ Laylo content confirmed loaded")):p>=d&&(console.log("⏰ Content check timeout, assuming loaded"),T(!0),clearInterval(b.current))},200),setTimeout(()=>{b.current&&(clearInterval(b.current),E||(console.log("⏰ Final timeout, assuming content loaded"),T(!0)))},c)},[y,E]);return t.useEffect(()=>()=>{b.current&&clearInterval(b.current)},[]),t.useCallback(()=>{I<h&&(console.log(`🔄 Retrying Laylo iframe (attempt ${I+1}/${h})`),r(p=>p+1),F(!1),T(!1),l.current&&(l.current.src=l.current.src))},[I,h]),D?n.jsx("iframe",{ref:l,id:`laylo-drop-${m}`,title:"Laylo Signup",width:"100%",height:"100%",frameBorder:"0",scrolling:"no",onLoad:s,allow:"web-share",style:{...L,opacity:E?1:.8,transition:"opacity 0.15s ease-out",minHeight:"60px"},src:f}):n.jsx("div",{style:{...L,display:"flex",alignItems:"center",justifyContent:"center",minHeight:"60px"},children:n.jsx("span",{style:{color:"#666",fontSize:"14px"},children:"Loading..."})})}),_=({contentRef:m,viewportContext:R={isRealMobileDevice:!1},onStateChange:v=()=>{}})=>{const[o,C]=t.useState("");t.useState(!1);const[L,D]=t.useState(!1);t.useState("us"),t.useState("normal");const[i,k]=t.useState(!1),[F,E]=t.useState("");t.useState(""),t.useState(!1);const[T,I]=t.useState("normal"),[r,l]=t.useState(!1),[b,h]=t.useState(!1),[c,f]=t.useState(!1),[g,y]=t.useState(!1);t.useState(!1),t.useState(0),t.useState(!1);const[s,p]=t.useState({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1,isOnDrawerContent:!1,isOnDrawerHandle:!1}),[d,z]=t.useState({expanded:!1,showDisclaimer:!1,showVerification:!1,verificationCode:"",phoneNumber:""});t.useState(!1),t.useRef(null),t.useRef(null);const x=t.useRef(null);t.useRef(null),t.useEffect(()=>{const e=setTimeout(()=>{f(!1),l(!1)},500);return()=>clearTimeout(e)},[]),t.useEffect(()=>{if(!document.querySelector('script[src="https://embed.laylo.com/laylo-sdk.js"]')){const e=document.createElement("script");e.src="https://embed.laylo.com/laylo-sdk.js",e.async=!0,e.defer=!0,e.onerror=a=>{console.warn("⚠️ Laylo SDK failed to load in MobileDrawer:",a)},e.onload=()=>{console.log("✅ Laylo SDK script loaded successfully in MobileDrawer")},document.head.appendChild(e)}},[]),t.useEffect(()=>{const e=document.body,a=m?.current;if(r){const u=window.scrollY;e.classList.add("drawer-scroll-lock"),e.style.top=`-${u}px`,a&&a.classList.add("drawer-active")}else{const u=e.style.top;e.classList.remove("drawer-scroll-lock"),e.style.top="",u&&window.scrollTo(0,parseInt(u||"0")*-1),a&&a.classList.remove("drawer-active")}return()=>{e.classList.remove("drawer-scroll-lock"),e.style.top="",a&&a.classList.remove("drawer-active")}},[r,m]);const V=t.useCallback(()=>{z({expanded:r,showDisclaimer:b,showVerification:i,verificationCode:F,phoneNumber:o}),console.log("💾 Drawer state saved, iframe content preserved")},[r,b,i,F,o]),M=t.useCallback(e=>{x.current&&!x.current.contains(e.target)&&(V(),l(!1),i?f(!1):(f(!1),h(!1)))},[o,i,V]);t.useEffect(()=>(r&&(document.addEventListener("mousedown",M),document.addEventListener("touchstart",M)),()=>{document.removeEventListener("mousedown",M),document.removeEventListener("touchstart",M)}),[r,M]),t.useEffect(()=>{const e=document.body,a=m?.current;if(r){const u=window.scrollY;e.classList.add("drawer-scroll-lock"),e.style.top=`-${u}px`,a&&a.classList.add("drawer-active")}else{e.classList.remove("drawer-scroll-lock");const u=e.style.top;e.style.top="",u&&window.scrollTo(0,parseInt(u||"0")*-1),a&&a.classList.remove("drawer-active")}return()=>{e.classList.remove("drawer-scroll-lock"),e.style.top="",a&&a.classList.remove("drawer-active")}},[r,m]),t.useEffect(()=>{v({drawerExpanded:r,drawerFullyClosed:c,showVerification:i,iframeExpanded:g,phoneSubmitted:L})},[r,c,i,g,L,v]);const j=t.useCallback(()=>c?"50px":g?"320px":i&&r?"240px":i&&!r?"60px":r?"280px":"80px",[c,i,r,b,g]);t.useCallback(()=>{const e=j(),a=(()=>{const S="ontouchstart"in window||navigator.maxTouchPoints>0,w=/Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),O=window.innerWidth,N=window.innerHeight,A=O/N;return S&&w&&(A<1.5||O<768)})(),u=parseInt(e.replace("px",""));if(a)return`calc(${e} + 20px)`;{const S=Math.max(15,u*.2);return`calc(${e} + ${S}px)`}},[j,R]);const H=t.useCallback(e=>{if(e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.closest("iframe"))return;const a=e.touches[0],u=Date.now(),S=e.target.closest(".mobile-drawer-content"),w=x.current?.getBoundingClientRect(),O=w&&a.clientY>w.top&&a.clientY<w.top+50;p({isActive:!0,startY:a.clientY,currentY:a.clientY,startTime:u,isDragging:!1,initialDrawerState:r,isOnDrawerContent:!!S,isOnDrawerHandle:!!O}),O&&!S&&(e.preventDefault(),e.stopPropagation())},[r]),W=t.useCallback(e=>{if(!s.isActive||e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.closest("iframe"))return;const a=e.touches[0],u=s.startY-a.clientY,S=Math.abs(u);!s.isDragging&&S>5&&s.isOnDrawerHandle&&!s.isOnDrawerContent&&(p(w=>({...w,isDragging:!0})),e.preventDefault(),e.stopPropagation()),s.isDragging&&s.isOnDrawerHandle&&!s.isOnDrawerContent?(e.preventDefault(),e.stopPropagation(),p(w=>({...w,currentY:a.clientY}))):s.isOnDrawerContent||p(w=>({...w,currentY:a.clientY}))},[s]),B=t.useCallback(e=>{if(!s.isActive)return;const a=s.startY-s.currentY,u=Math.abs(a),S=Date.now()-s.startTime,w=u/S,O=15,N=.2,A=8;let Y=!1;if(s.isDragging)(w>N||u>O||u>A)&&(Y=!0),Y&&(w>N?(x.current?.classList.add("momentum-fast"),setTimeout(()=>{x.current?.classList.remove("momentum-fast")},100)):(x.current?.classList.add("momentum-slow"),setTimeout(()=>{x.current?.classList.remove("momentum-slow")},250)),a>0?r||(l(!0),f(!1),console.log("🔄 Drawer opened via swipe up")):r&&(l(!1),console.log("🔄 Drawer closed via swipe down")));else{const P=x.current?.getBoundingClientRect();P&&s.startY>P.top&&s.startY<P.top+50&&(c?(f(!1),l(!0),console.log("🔄 Drawer opened via tap")):r?(l(!1),console.log("🔄 Drawer collapsed via tap")):(l(!0),console.log("🔄 Drawer expanded via tap")))}p({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1,isOnDrawerContent:!1,isOnDrawerHandle:!1})},[s,r,c]),X=t.useCallback(()=>{c?(f(!1),l(d.expanded||!0),h(d.showDisclaimer),k(d.showVerification),d.verificationCode&&(E(d.verificationCode),d.verificationCode.length===4&&I("filled")),d.phoneNumber&&C(d.phoneNumber)):r||(l(!0),d.showDisclaimer&&!i&&h(!0))},[c,r,d,i]),$=t.useCallback(e=>{e.stopPropagation(),c&&f(!1),l(!0),y(!0),setTimeout(()=>{y(!1)},1e4)},[c]);return n.jsxs(n.Fragment,{children:[n.jsx("style",{children:`
