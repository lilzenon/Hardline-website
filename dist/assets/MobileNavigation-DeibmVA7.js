import{j as t}from"./index-0Yv6-Kds.js";import{b as a}from"./vendor-ViNJc2wV.js";import{S as f}from"./SocialMediaButtons-2Cg5UYAK.js";import{s as g}from"./shopService-D3Jzy0Uo.js";const F=({currentPage:r="events",scrollY:v=0,onNavigate:c=()=>{},onMenuToggle:s=()=>{}})=>{const[i,l]=a.useState(!1),[b,h]=a.useState(!1);a.useEffect(()=>{(async()=>{try{const n=await g.fetchConfig();if(n){const p=n.shopEnabled??n.shop_enabled;typeof p<"u"&&h(p)}}catch(n){console.error("Failed to load shop settings:",n)}})()},[]);const[x,d]=a.useState("100vh");a.useEffect(()=>{const e=()=>{try{const n=window.visualViewport?window.visualViewport.height:window.innerHeight;d(`${n}px`)}catch{d(`${window.innerHeight}px`)}};return e(),window.addEventListener("resize",e),window.addEventListener("orientationchange",e),window.visualViewport&&window.visualViewport.addEventListener("resize",e),()=>{window.removeEventListener("resize",e),window.removeEventListener("orientationchange",e),window.visualViewport&&window.visualViewport.removeEventListener("resize",e)}},[]);const m=()=>{const e=!i;l(e),s(e)},o=e=>{c(e),l(!1),s(!1)};return a.useEffect(()=>{const e=document.body;if(i){const n=window.scrollY;e.classList.add("drawer-scroll-lock"),e.style.top=`-${n}px`}else{e.classList.remove("drawer-scroll-lock");const n=e.style.top;e.style.top="",n&&window.scrollTo(0,parseInt(n||"0")*-1)}return()=>{e.classList.remove("drawer-scroll-lock"),e.style.top=""}},[i]),t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
