function n(){return Ln||(Ln=1,(n=Un).exports=function(n){function e(n,e,l,r){return new Rt(n,e,l,r)}function l(){}function r(n){var e="https://react.dev/errors/"+n
...
t&e|n[r]&e&&(n[r]|=e),l&=~t}}function P(n){return 2<(n&=-n)?8<n?134217727&n?32:268435456:8:2}function R(n){if("function"==typeof Ni&&Bi(n),qi&&"function"==typeof qi.setStrictMode)try{qi.setStrictMode(Hi,n)}catch(e){}}function T(n,e){if("object"==typeof n&&null!==n){var l=$i.get(n)
...
var u=32-Ci(e)+t
if(30<u){var o=t-t%5
u=(r&(1<<o)-1).toString(32),r>>=o,t-=o,Ji=1<<32-Ci(e)+t|l<<t|r,Zi=u+n}else Ji=1<<u|l<<t|r,Zi=n}function O(n){null!==n.return&&(I(n,1),z(n,1,0))}function _(n){for(;n===Gi;)Gi=Vi[--Wi],Vi[Wi]=null,Qi=Vi[--Wi],Vi[Wi]=null
for(;n===Xi;)Xi=Yi[--Ki],Yi[Ki]=null,Zi=Yi[--Ki],Yi[Ki]=null,Ji=Yi[--Ki],Yi[Ki]=null}function A(n,e){b(la,e),b(ea,n),b(na,null),n=xu(e),y(na),b(na,n)}function F(){y(na),y(ea),y(la)}function L(n){null!==n.memoizedState&&b(ra,n)
var e=na.current,l=Eu(e,n.type)
e!==l&&(b(ea,n),b(na,l))}function D(n){ea.current===n&&(y(na),y(ea)),ra.current===n&&(y(ra),_u?Xu.o=Ku:Xu.i=Ku)}function N(n){throw $(T(Error(r(418,"")),n)),ca}function B(n,e){if(!Lu)throw Error(r(175))
Vo(n.stateNode,n.type,n.memoizedProps,e,n)||N(n)}function H(n){for(ta=n.return;ta;)switch(ta.tag){case 3:case 27:return aa=!0,void 0
case 5:case 13:return aa=!1,void 0
default:ta=ta.return}}function q(n){if(!Lu||n!==ta)return!1
if(!oa)return H(n),oa=!0,!1
var e=!1
if(yi?3!==n.tag&&27!==n.tag&&(5!==n.tag||Zo(n.type)&&!Ru(n.type,n.memoizedProps))&&(e=!0):3!==n.tag&&(5!==n.tag||Zo(n.type)&&!Ru(n.type,n.memoizedProps))&&(e=!0),e&&ua&&N(n),H(n),13===n.tag){if(!Lu)throw Error(r(316))
...
null===o?t.next=t:(t.next=o.next,o.next=t),r.pending=t}0!==u&&K(l,t,u)}}function G(n,e,l,r){fa[sa++]=n,fa[sa++]=e,fa[sa++]=l,fa[sa++]=r,va|=r,n.lanes|=r,null!==(n=n.alternate)&&(n.lanes|=r)}function Q(n,e,l,r){return G(n,e,l,r),X(n)}function Y(n,e){return G(n,null,null,e),X(n)}function K(n,e,l){n.lanes|=l
var r=n.alternate
null!==r&&(r.lanes|=l)
...
n!==pa&&null===n.next&&(null===pa?da=pa=n:pa=pa.next=n),ya=!0,ha||(ha=!0,e=nn,Zu?no(function(){6&Oc?Ti(Ai,e):e()}):Ti(Ai,e))}function Z(n,e){if(!ba&&ya){ba=!0
do{for(var l=!1,r=da;null!==r;){if(0!==n){var t=r.pendingLanes
if(0===t)var u=0
else{var o=r.suspendedLanes,i=r.pingedLanes
u=(1<<31-Ci(42|n)+1)-1,u=201326677&(u&=t&~(o&~i))?201326677&u|1:u?2|u:0}0!==u&&(l=!0,rn(r,u))}else u=Fc,!(3&(u=m(r,r===_c?u:0)))||k(r,u)||(l=!0,rn(r,u))
r=r.next}}while(l)
ba=!1}}function nn(){ya=ha=!1
var n=0
0!==wa&&(Uu()&&(n=wa),wa=0)
for(var e=_i(),l=null,r=da;null!==r;){var t=r.next,u=en(r,e)
0===u?(r.next=null,null===l?da=t:l.next=t,null===t&&(pa=l)):(l=r,(0!==n||3&u)&&(ya=!0)),r=t}Z(n)}function en(n,e){for(var l=n.suspendedLanes,r=n.pingedLanes,t=n.expirationTimes,u=-62914561&n.pendingLanes;0<u;){var o=31-Ci(u),i=1<<o,a=t[o];-1===a?0!==(i&l)&&0===(i&r)||(t[o]=g(i,e)):a<=e&&(n.expiredLanes|=i),u&=~i}if(l=Fc,l=m(n,n===(e=_c)?l:0),r=n.callbackNode,0===l||n===e&&2===Lc||null!==n.cancelPendingCommit)return null!==r&&null!==r&&Ii(r),n.callbackNode=null,n.callbackPriority=0
if(!(3&l)||k(n,l)){if((e=l&-l)===n.callbackPriority)return e
switch(null!==r&&Ii(r),P(l)){case 2:case 8:l=Fi
break
case 32:default:l=Li
break
case 268435456:l=Di}return r=ln.bind(null,n),l=Ti(l,r),n.callbackPriority=e,n.callbackNode=l,e}return null!==r&&null!==r&&Ii(r),n.callbackPriority=2,n.callbackNode=null,2}function ln(n,e){var l=n.callbackNode
if(gt()&&n.callbackNode!==l)return null
var r=Fc
return 0===(r=m(n,n===_c?r:0))?null:(Jr(n,r,e),en(n,_i()),null!=n.callbackNode&&n.callbackNode===l?ln.bind(null,n):null)}function rn(n,e){if(gt())return null
...
return null===t?e.next=e:(e.next=t.next,t.next=e),r.pending=e,e=X(n),K(n,null,l),e}return G(n,r,e,l),X(n)}function sn(n,e,l){if(null!==(e=e.updateQueue)&&(e=e.shared,4194176&l)){var r=e.lanes
...
if(d?(Fc&v)===v:(r&v)===v){0!==v&&v===ga&&(Sa=!0),null!==f&&(f=f.next={lane:0,tag:i.tag,payload:i.payload,callback:null,next:null})
n:{var p=n,h=i
v=e
var y=l
...
else{if(null!==(n=_c)&&100<n.shellSuspendCounter)throw Error(r(482));(n=e).status="pending",n.then(function(n){if("pending"===e.status){var l=e
...
case fu:return p(n,e=(0,e.u)(e.t),l)}if(bu(e)||t(e))return(e=_t(e,n.mode,l,null)).return=n,e
...
break n}u(e,f)
break}l(e,f),f=f.sibling}s.type===nu?((v=_t(s.props.children,e.mode,v,s.key)).return=e,e=v):(En(v=Ot(s.type,s.key,s.props,null,e.mode,v),s),v.return=e,e=v)}return c(e)
...
Sn(e,s)}return"string"==typeof s&&""!==s||"number"==typeof s||"bigint"==typeof s?(s=""+s,null!==f&&6===f.tag?(u(e,f.sibling),(v=i(f,s)).return=e,e=v):(u(e,f),(v=Ft(s,e.mode,v)).return=e,e=v),c(e)):u(e,f)}return function(n,l,r,t){try{Ia=0
var u=b(n,l,r,t)
return Ta=null,u}catch(i){if(i===Ma)throw i
var o=e(29,i,null,n.mode)
return o.lanes=t,o.return=n,o}}}function jn(n,e){b(Aa,n=qc),b(_a,e),qc=n|e.baseLanes}function Pn(){b(Aa,qc),b(_a,_a.current)}function Rn(){qc=Aa.current,y(_a),y(Aa)}function Tn(n){var e=n.alternate
b(Da,1&Da.current),b(Fa,n),null===La&&(null===e||null!==_a.current||null!==e.memoizedState)&&(La=n)}function In(n){if(22===n.tag){if(b(Da,Da.current),b(Fa,n),null===La){var e=n.alternate
null!==e&&null!==e.memoizedState&&(La=n)}}else zn()}function zn(){b(Da,Da.current),b(Fa,Fa.current)}function On(n){y(Fa),La===n&&(La=null),y(Da)}function _n(n){for(var e=n;null!==e;){if(13===e.tag){var l=e.memoizedState
...
e=e.return}e.sibling.return=e.return,e=e.sibling}return null}function Ln(){throw Error(r(321))}function Dn(n,e){if(null===e)return!1
for(var l=0;l<e.length&&l<n.length;l++)if(!Ui(n[l],e[l]))return!1
return!0}function Nn(n,e,l,r,t,u){return Na=u,Ba=e,e.memoizedState=null,e.updateQueue=null,e.lanes=0,hu.H=null===n||null===n.memoizedState?Ja:Za,Va=!1,u=l(r,t),Va=!1,$a&&(u=Hn(e,l,r,t)),Bn(n),u}function Bn(n){hu.H=Xa
var e=null!==Ha&&null!==Ha.next
if(Na=0,qa=Ha=Ba=null,Ua=!1,Ga=0,Qa=null,e)throw Error(r(300))
null===n||tc||null!==(n=n.dependencies)&&Al(n)&&(tc=!0)}function Hn(n,e,l,t){Ba=n
var u=0
...
return Wa=0,n}function Wn(n,e,l){e.updateQueue=n.updateQueue,e.flags&=-2053,n.lanes&=~l}function Gn(n){if(Ua){for(n=n.memoizedState;null!==n;){var e=n.queue
null!==e&&(e.pending=null),n=n.next}Ua=!1}Na=0,qa=Ha=Ba=null,$a=!1,Ga=Wa=0,Qa=null}function Qn(){var n={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null}
...
if(v!==f.lane?(Fc&v)===v:(Na&v)===v){var d=f.revertLane
...
if(i&&(u.memoizedState=l,tc=!0),u=u.queue,Pe(oe.bind(null,t,u,n),[n]),u.getSnapshot!==e||i||null!==qa&&1&qa.memoizedState.tag){if(t.flags|=2048,Ee(9,ue.bind(null,t,u,l,e),{destroy:void 0},null),null===_c)throw Error(r(349))
...
for(var e=0;e<n.length;e++)(0,n[e])()}function be(n,e){return e}function we(n,e){if(oa){var l=_c.formState
if(null!==l){n:{var r=Ba
if(oa){if(ua){var t=Fo(ua,aa)
if(t){ua=Do(t),r=Lo(t)
break n}}N(r)}r=!1}r&&(e=l[0])}}(l=Qn()).memoizedState=l.baseState=e,r={pending:null,lanes:0,dispatch:null,lastRenderedReducer:be,lastRenderedState:e},l.queue=r,l=We.bind(null,Ba,r),r.dispatch=l,r=ce(!1)
...
null!==Ha&&null!==r&&Dn(r,Ha.memoizedState.deps)?t.memoizedState=Ee(e,l,u,r):(Ba.flags|=n,t.memoizedState=Ee(1|e,l,u,r))}function je(n,e){Ce(8390656,8,n,e)}function Pe(n,e){Me(2048,8,n,e)}function Re(n,e){return Me(4,2,n,e)}function Te(n,e){return Me(4,4,n,e)}function Ie(n,e){if("function"==typeof e){n=n()
var l=e(n)
return function(){"function"==typeof l?l():e(null)}}if(null!=e)return n=n(),e.current=n,function(){e.current=null}}function ze(n,e,l){l=null!=l?l.concat([n]):null,Me(4,4,Ie.bind(null,e,n),l)}function Oe(){}function _e(n,e){var l=Yn()
e=void 0===e?null:e
var r=l.memoizedState
return null!==e&&Dn(e,r[1])?r[0]:(l.memoizedState=[n,e],n)}function Ae(n,e){var l=Yn()
e=void 0===e?null:e
var r=l.memoizedState
if(null!==e&&Dn(e,r[1]))return r[0]
if(r=n(),Va){R(!0)
try{n()}finally{R(!1)}}return l.memoizedState=[r,e],r}function Fe(n,e,l){return void 0===l||1073741824&Na?n.memoizedState=e:(n.memoizedState=l,n=Kr(),Ba.lanes|=n,$c|=n,l)}function Le(n,e,l,r){return Ui(l,e)?l:null!==_a.current?(n=Fe(n,l,r),Ui(n,e)||(tc=!0),n):42&Na?(n=Kr(),Ba.lanes|=n,$c|=n,e):(tc=!0,n.memoizedState=l)}function De(n,e,l,r,t){var u=Hu()
Bu(0!==u&&8>u?u:8)
var o=hu.T,i={}
hu.T=i,Qe(n,!1,e,l)
try{var a=t(),c=hu.S
...
return l}function ll(n,e){try{(0,n.onUncaughtError)(e.value,{componentStack:e.stack})}catch(qe){setTimeout(function(){throw qe})}}function rl(n,e,l){try{(0,n.onCaughtError)(l.value,{componentStack:l.stack,errorBoundary:1===e.tag?e.stateNode:null})}catch(qe){setTimeout(function(){throw qe})}}function tl(n,e,l){return(l=cn(l)).tag=3,l.payload={element:null},l.callback=function(){ll(n,e)},l}function ul(n){return(n=cn(n)).tag=3,n}function ol(n,e,l,r){var t=l.type.getDerivedStateFromError
...
return Fl(e),r=Nn(n,e,l,o,u,t),i=Un(),null===n||tc?(oa&&i&&O(e),e.flags|=1,il(n,e,r,t),e.child):(Wn(n,e,t),jl(n,e,t))}function cl(n,e,l,r,t){if(null===n){var u=l.type
...
return t=null===t?null:{parent:_u?vc.o:vc.i,pool:t},e.memoizedState={baseLanes:l,cachePool:t},null!==n&&Ul(0,null),Pn(),In(e),null!==n&&_l(n,e,r,!0),null}function dl(n,e){var l=e.ref
if(null===l)null!==n&&null!==n.ref&&(e.flags|=2097664)
else{if("function"!=typeof l&&"object"!=typeof l)throw Error(r(284))
null!==n&&n.ref===l||(e.flags|=2097664)}}function pl(n,e,l,r,t){return Fl(e),l=Nn(n,e,l,r,void 0,t),r=Un(),null===n||tc?(oa&&r&&O(e),e.flags|=1,il(n,e,l,t),e.child):(Wn(n,e,t),jl(n,e,t))}function hl(n,e,l,r,t,u){return Fl(e),e.updateQueue=null,l=Hn(e,r,l,t),Bn(n),r=Un(),null===n||tc?(oa&&r&&O(e),e.flags|=1,il(n,e,l,u),e.child):(Wn(n,e,u),jl(n,e,u))}function yl(n,e,l,r,t){if(Fl(e),null===e.stateNode){var u=Si,o=l.contextType
...
break
default:o=0}if(0!==(o=0!==(o&(u.suspendedLanes|t))?0:o)&&o!==c.retryLane)throw c.retryLane=o,Y(n,o),Xr(u,0,o),rc}zo(f)||ft(),l=El(n,l,t)}else zo(f)?(l.flags|=128,l.child=n.child,l=jt.bind(null,n),Ao(f,l),l=null):(n=c.treeContext,Lu&&(ua=Ho(f),ta=l,oa=!0,ia=null,aa=!1,null!==n&&(Yi[Ki++]=Ji,Yi[Ki++]=Zi,Yi[Ki++]=Xi,Ji=n.id,Zi=n.overflow,Xi=l)),(l=gl(l,o.children)).flags|=4096)
return l}return i?(zn(),i=o.fallback,f=l.mode,a=(c=n.child).sibling,(o=It(c,{mode:"hidden",children:o.children})).subtreeFlags=31457280&c.subtreeFlags,null!==a?i=It(a,i):(i=_t(i,f,t,null)).flags|=2,i.return=l,o.return=l,o.sibling=i,l.child=o,o=i,i=l.child,null===(f=n.child.memoizedState)?f=wl(t):(null!==(c=f.cachePool)?(a=_u?vc.o:vc.i,c=c.parent!==a?{parent:a,pool:a}:c):c=$l(),f={baseLanes:f.baseLanes|t,cachePool:c}),i.memoizedState=f,i.childLanes=ml(n,u,t),l.memoizedState=uc,o):(Tn(l),n=(t=n.child).sibling,(t=It(t,{mode:"visible",children:o.children})).return=l,t.sibling=null,null!==n&&(null===(u=l.deletions)?(l.deletions=[n],l.flags|=16):u.push(n)),l.child=t,l.memoizedState=null,t)}function gl(n,e){return(e=xl({mode:"visible",children:e},n.mode)).return=n,n.child=e}function xl(n,e){return At(n,e,0,null)}function El(n,e,l){return za(e,n.child,null,l),(n=gl(e,e.pendingProps.children)).flags|=2,e.memoizedState=null,n}function Sl(n,e,l){n.lanes|=e
var r=n.alternate
...
n=n.return}n.sibling.return=n.return,n=n.sibling}r&=1}switch(b(Da,r),t){case"forwards":for(l=e.child,t=null;null!==l;)null!==(n=l.alternate)&&null===_n(n)&&(t=l),l=l.sibling
null===(l=t)?(t=e.child,e.child=null):(t=l.sibling,l.sibling=null),Cl(e,!1,t,l,u)
break
case"backwards":for(l=null,t=e.child,e.child=null;null!==t;){if(null!==(n=t.alternate)&&null===_n(n)){e.child=t
...
if(_l(n,e,l,!1),0===(l&e.childLanes))return null}if(null!==n&&e.child!==n.child)throw Error(r(153))
...
l.sibling=null}return e.child}function Pl(n,e){return 0!==(n.lanes&e)||!(null===(n=n.dependencies)||!Al(n))}function Rl(n,e,l){if(null!==n)if(n.memoizedProps!==e.pendingProps)tc=!0
else{if(!(Pl(n,l)||128&e.flags))return tc=!1,function(n,e,l){switch(e.tag){case 3:A(e,e.stateNode.containerInfo),Tl(0,vc,n.memoizedState.cache),U()
break
case 27:case 5:L(e)
break
case 4:A(e,e.stateNode.containerInfo)
break
...
if((r=0!==(l&e.childLanes))||(_l(n,e,l,!1),r=0!==(l&e.childLanes)),t){if(r)return Ml(n,e,l)
...
case 3:n:{if(A(e,e.stateNode.containerInfo),null===n)throw Error(r(387))
...
case 27:if(yi)return L(e),null===n&&yi&&oa&&(t=e.stateNode=bi(e.type,e.pendingProps,la.current,na.current,!1),ta=e,aa=!0,ua=No(t)),t=e.pendingProps.children,null!==n||oa?il(n,e,t,l):e.child=za(e,null,t,l),dl(n,e),e.child
case 5:return null===n&&oa&&(ni(e.type,e.pendingProps,na.current),(o=t=ua)&&(null!==(t=qo(t,e.type,e.pendingProps,aa))?(e.stateNode=t,ta=e,ua=No(t),aa=!1,o=!0):o=!1),o||N(e)),L(e),o=e.type,i=e.pendingProps,a=null!==n?n.memoizedProps:null,t=i.children,Ru(o,i)?t=null:null!==a&&Ru(o,a)&&(e.flags|=32),null!==e.memoizedState&&(o=Nn(n,e,qn,null,null,l),_u?Xu.o=o:Xu.i=o),dl(n,e),il(n,e,t,l),e.child
case 6:return null===n&&oa&&(ei(e.pendingProps,na.current),(n=l=ua)&&(null!==(l=Uo(l,e.pendingProps,aa))?(e.stateNode=l,ta=e,ua=null,n=!0):n=!1),n||N(e)),null
case 13:return kl(n,e,l)
case 4:return A(e,e.stateNode.containerInfo),t=e.pendingProps,null===n?e.child=za(e,null,t,l):il(n,e,t,l),e.child
...
case 9:return o=e.type.l,t=e.pendingProps.children,Fl(e),t=t(o=Ll(o)),e.flags|=1,il(n,e,t,l),e.child
...
case 24:return Fl(e),t=Ll(vc),null===n?(null===(o=ql())&&(o=_c,i=Bl(),o.pooledCache=i,i.refCount++,null!==i&&(o.pooledCacheLanes|=l),o=i),e.memoizedState={parent:t,cache:o},on(e),Tl(0,vc,o)):(0!==(n.lanes&l)&&(an(n,e),pn(e,null,null,l),dn()),o=n.memoizedState,i=e.memoizedState,o.parent!==t?(o={parent:t,cache:t},e.memoizedState=o,0===e.lanes&&(e.memoizedState=e.updateQueue.baseState=o),Tl(0,vc,t)):(t=i.cache,Tl(0,vc,t),t!==o.cache&&Ol(e,[vc],l,!0))),il(n,e,e.pendingProps.children,l),e.child
case 29:throw e.pendingProps}throw Error(r(156,e.tag))}function Tl(n,e,l){_u?(b(oc,e.o),e.o=l):(b(oc,e.i),e.i=l)}function Il(n){var e=oc.current
_u?n.o=e:n.i=e,y(oc)}function zl(n,e,l){for(;null!==n;){var r=n.alternate
...
break}i=i.return}u=i}}function _l(n,e,l,t){n=null
...
i.memoizedState.memoizedState!==u.memoizedState.memoizedState&&(null!==n?n.push(Xu):n=[Xu])}u=u.return}null!==n&&Ol(e,n,l,t),e.flags|=262144}function Al(n){for(n=n.firstContext;null!==n;){var e=n.context
if(!Ui(_u?e.o:e.i,n.memoizedValue))return!0
n=n.next}return!1}function Fl(n){ic=n,ac=null,null!==(n=n.dependencies)&&(n.firstContext=null)}function Ll(n){return Nl(ic,n)}function Dl(n,e){return null===ic&&Fl(n),Nl(n,e)}function Nl(n,e){var l=_u?e.o:e.i
...
return null!==n?n:_c.pooledCache}function Ul(n,e){b(pc,null===e?pc.current:e.pool)}function $l(){var n=ql()
return null===n?null:{parent:_u?vc.o:vc.i,pool:n}}function Vl(n){n.flags|=4}function Wl(n,e){if(null!==n&&n.child===e.child)return!1
if(16&e.flags)return!0
for(n=e.child;null!==n;){if(13878&n.flags||13878&n.subtreeFlags)return!0
n=n.sibling}return!1}function Gl(n,e,l,r){if(Au)for(l=e.child;null!==l;){if(5===l.tag||6===l.tag)ju(n,l.stateNode)
...
l=l.return}l.sibling.return=l.return,l=l.sibling}else if(Fu)for(var t=e.child;null!==t;){if(5===t.tag){var u=t.stateNode
...
t=t.return}t.sibling.return=t.return,t=t.sibling}}function Ql(n,e,l,r){if(Fu)for(var t=e.child;null!==t;){if(5===t.tag){var u=t.stateNode
...
continue}if(t===e)break
for(;null===t.sibling;){if(null===t.return||t.return===e)return
t=t.return}t.sibling.return=t.return,t=t.sibling}}function Yl(n,e){if(Fu&&Wl(n,e)){var l=(n=e.stateNode).containerInfo,r=Mo()
Ql(r,e,!1,!1),n.pendingChildren=r,Vl(e),Po(l,r)}}function Kl(n,e,l,r){if(Au)n.memoizedProps!==r&&Vl(e)
else if(Fu){var t=n.stateNode,u=n.memoizedProps
...
switch(_(e),e.tag){case 16:case 15:case 0:case 11:case 7:case 8:case 12:case 9:case 14:case 1:return er(e),null
case 3:return l=e.stateNode,t=null,null!==n&&(t=n.memoizedState.cache),e.memoizedState.cache!==t&&(e.flags|=2048),Il(vc),F(),l.pendingContext&&(l.context=l.pendingContext,l.pendingContext=null),null!==n&&null!==n.child||(q(e)?Vl(e):null===n||n.memoizedState.isDehydrated&&!(256&e.flags)||(e.flags|=1024,null!==ia&&(Zr(ia),ia=null))),Yl(n,e),er(e),null
case 26:if(li){l=e.type
var u=e.memoizedState
return null===n?(Vl(e),null!==u?(er(e),Jl(e,u)):(er(e),Xl(e,l,t))):u?u!==n.memoizedState?(Vl(e),er(e),Jl(e,u)):(er(e),e.flags&=-16777217):(Au?n.memoizedProps!==t&&Vl(e):Kl(n,e,l,t),er(e),Xl(e,l,t)),null}case 27:if(yi){if(D(e),l=la.current,u=e.type,null!==n&&null!=e.stateNode)Au?n.memoizedProps!==t&&Vl(e):Kl(n,e,u,t)
else{if(!t){if(null===e.stateNode)throw Error(r(166))
return er(e),null}n=na.current,q(e)?B(e,n):(n=bi(u,t,l,n,!0),e.stateNode=n,Vl(e))}return er(e),null}case 5:if(D(e),l=e.type,null!==n&&null!=e.stateNode)Kl(n,e,l,t)
else{if(!t){if(null===e.stateNode)throw Error(r(166))
...
case 6:if(n&&null!=e.stateNode)l=n.memoizedProps,Au?l!==t&&Vl(e):Fu&&(l!==t?(e.stateNode=Tu(t,la.current,na.current,e),Vl(e)):e.stateNode=n.stateNode)
...
case 4:return F(),Yl(n,e),null===n&&Nu(e.stateNode.containerInfo),er(e),null
...
else{if(0!==Uc||null!==n&&128&n.flags)for(n=e.child;null!==n;){if(null!==(o=_n(n))){for(e.flags|=128,nr(u,!1),n=o.updateQueue,e.updateQueue=n,Zl(e,n),e.subtreeFlags=0,n=l,l=e.child;null!==l;)zt(l,n),l=l.sibling
return b(Da,1&Da.current|2),e.child}n=n.sibling}null!==u.tail&&_i()>Zc&&(e.flags|=128,t=!0,nr(u,!1),e.lanes=4194304)}else{if(!t)if(null!==(n=_n(o))){if(e.flags|=128,t=!0,n=n.updateQueue,e.updateQueue=n,Zl(e,n),nr(u,!0),null===u.tail&&"hidden"===u.tailMode&&!o.alternate&&!oa)return er(e),null}else 2*_i()-u.renderingStartTime>Zc&&536870912!==l&&(e.flags|=128,t=!0,nr(u,!1),e.lanes=4194304)
u.isBackwards?(o.sibling=e.child,e.child=o):(null!==(n=u.last)?n.sibling=o:e.child=o,u.last=o)}return null!==u.tail?(e=u.tail,u.rendering=e,u.tail=e.sibling,u.renderingStartTime=_i(),e.sibling=null,n=Da.current,b(Da,t?1&n|2:1&n),e):(er(e),null)
...
case 25:return null}throw Error(r(156,e.tag))}function rr(n,e){switch(_(e),e.tag){case 1:return 65536&(n=e.flags)?(e.flags=-65537&n|128,e):null
case 3:return Il(vc),F(),65536&(n=e.flags)&&!(128&n)?(e.flags=-65537&n|128,e):null
...
default:return null}}function tr(n,e){switch(_(e),e.tag){case 3:Il(vc),F()
break
...
case 6:if(Au){if(r=gc,t=xc,gc=null,kr(n,e,l),xc=t,null!==(gc=r))if(xc)try{wo(gc,l.stateNode)}catch(o){Et(l,e,o)}else try{bo(gc,l.stateNode)}catch(o){Et(l,e,o)}}else kr(n,e,l)
break
case 18:Au&&null!==gc&&(xc?Jo(gc,l.stateNode):Xo(gc,l.stateNode))
break
case 4:Au?(r=gc,t=xc,gc=l.stateNode.containerInfo,xc=!0,kr(n,e,l),gc=r,xc=t):(Fu&&br(l.stateNode,l,Mo()),kr(n,e,l))
break
...
try{wi(u),mi(n.type,o,u,n)}catch(s){Et(n,n.return,s)}}case 5:if(Sr(e,n),Mr(n),512&t&&(yc||null===l||fr(l,l.return)),Au){if(32&n.flags){e=n.stateNode
try{mo(e)}catch(s){Et(n,n.return,s)}}4&t&&null!=n.stateNode&&vr(n,e=n.memoizedProps,null!==l?l.memoizedProps:e),1024&t&&(bc=!0)}break
case 6:if(Sr(e,n),Mr(n),4&t&&Au){if(null===n.stateNode)throw Error(r(162))
t=n.memoizedProps,l=null!==l?l.memoizedProps:t,e=n.stateNode
try{so(e,l,t)}catch(s){Et(n,n.return,s)}}break
case 3:if(li?(vi(),u=Ec,Ec=ti(e.containerInfo),Sr(e,n),Ec=u):Sr(e,n),Mr(n),4&t){if(Au&&Lu&&null!==l&&l.memoizedState.isDehydrated)try{Yo(e.containerInfo)}catch(s){Et(n,n.return,s)}if(Fu){t=e.containerInfo,l=e.pendingChildren
try{Ro(t,l)}catch(s){Et(n,n.return,s)}}}bc&&(bc=!1,jr(n))
break
case 4:li?(l=Ec,Ec=ti(n.stateNode.containerInfo),Sr(e,n),Mr(n),Ec=l):(Sr(e,n),Mr(n)),4&t&&Fu&&br(n.stateNode,n,n.stateNode.pendingChildren)
break
case 12:Sr(e,n),Mr(n)
break
case 13:Sr(e,n),Mr(n),8192&n.child.flags&&null!==n.memoizedState!=(null!==l&&null!==l.memoizedState)&&(Jc=_i()),4&t&&null!==(t=n.updateQueue)&&(n.updateQueue=null,Er(n,t))
break
case 22:512&t&&(yc||null===l||fr(l,l.return)),u=null!==n.memoizedState
var i=null!==l&&null!==l.memoizedState,a=hc,c=yc
if(hc=a||u,yc=c||i,Sr(e,n),yc=c,hc=a,Mr(n),(e=n.stateNode).C=n,e.v&=-3,e.v|=2&e.p,8192&t&&(e.v=u?-2&e.v:1|e.v,u&&(e=hc||yc,null===l||i||e||Rr(n)),Au&&(null===n.memoizedProps||"manual"!==n.memoizedProps.mode)))n:if(l=null,Au)for(e=n;;){if(5===e.tag||li&&26===e.tag||yi&&27===e.tag){if(null===l){i=l=e
...
if(2&e){try{if(Au&&(!yi||27!==n.tag)){n:{for(var l=n.return;null!==l;){if(dr(l)){var t=l
...
null!==n&&null!==n.memoizedState&&null!==n.memoizedState.cachePool&&(l=n.memoizedState.cachePool.pool),n=null,null!==e.memoizedState&&null!==e.memoizedState.cachePool&&(n=e.memoizedState.cachePool.pool),n!==l&&(null!=n&&n.refCount++,null!=l&&Hl(l))}function zr(n,e){n=null,null!==e.alternate&&(n=e.alternate.memoizedState.cache),(e=e.memoizedState.cache)!==n&&(e.refCount++,null!=n&&Hl(n))}function Or(n,e,l,r){if(10256&e.subtreeFlags)for(e=e.child;null!==e;)_r(n,e,l,r),e=e.sibling}function _r(n,e,l,r){var t=e.flags
...
break
case 23:break
case 22:u=e.stateNode,null!==e.memoizedState?4&u.v?Or(n,e,l,r):Fr(n,e):4&u.v?Or(n,e,l,r):(u.v|=4,Ar(n,e,l,r,!!(10256&e.subtreeFlags))),2048&t&&Ir(e.alternate,e)
break
case 24:Or(n,e,l,r),2048&t&&zr(e.alternate,e)
break
default:Or(n,e,l,r)}}function Ar(n,e,l,r,t){for(t=t&&!!(10256&e.subtreeFlags),e=e.child;null!==e;){var u=n,o=e,i=l,a=r,c=o.flags
switch(o.tag){case 0:case 11:case 15:Ar(u,o,i,a,t),ur(8,o)
break
case 23:break
case 22:var f=o.stateNode
null!==o.memoizedState?4&f.v?Ar(u,o,i,a,t):Fr(u,o):(f.v|=4,Ar(u,o,i,a,t)),t&&2048&c&&Ir(o.alternate,o)
break
case 24:Ar(u,o,i,a,t),t&&2048&c&&zr(o.alternate,o)
break
default:Ar(u,o,i,a,t)}e=e.sibling}}function Fr(n,e){if(10256&e.subtreeFlags)for(e=e.child;null!==e;){var l=n,r=e,t=r.flags
switch(r.tag){case 22:Fr(l,r),2048&t&&Ir(r.alternate,r)
break
case 24:Fr(l,r),2048&t&&zr(r.alternate,r)
break
default:Fr(l,r)}e=e.sibling}}function Lr(n){if(n.subtreeFlags&Sc)for(n=n.child;null!==n;)Dr(n),n=n.sibling}function Dr(n){switch(n.tag){case 26:Lr(n),n.flags&Sc&&(null!==n.memoizedState?hi(Ec,n.memoizedState,n.memoizedProps):Qu(n.type,n.memoizedProps))
break
...
break
default:Lr(n)}}function Nr(n){var e=n.alternate
...
mc=r,Ur(r,n)}Nr(n)}if(10256&n.subtreeFlags)for(n=n.child;null!==n;)Hr(n),n=n.sibling}function Hr(n){switch(n.tag){case 0:case 11:case 15:Br(n),2048&n.flags&&or(9,n,n.return)
break
...
if(16&n.flags){if(null!==e)for(var l=0;l<e.length;l++){var r=e[l]
mc=r,Ur(r,n)}Nr(n)}for(n=n.child;null!==n;){switch((e=n).tag){case 0:case 11:case 15:or(8,e,e.return),qr(e)
break
...
break n}mc=u}}}function $r(n){var e=Du(n)
...
else for(t=t.child;null!==t;)n.push(t),t=t.sibling}return e}function Yr(){return 2&Oc&&0!==Fc?Fc&-Fc:null!==hu.T?0!==ga?ga:tn():qu()}function Kr(){0===Gc&&(Gc=536870912&Fc&&!oa?536870912:x())
var n=Fa.current
return null!==n&&(n.flags|=32),Gc}function Xr(n,e,l){(n===_c&&2===Lc||null!==n.cancelPendingCommit)&&(ut(n,0),lt(n,Fc,Gc,!1)),C(n,l),2&Oc&&n===_c||(n===_c&&(!(2&Oc)&&(Vc|=l),4===Uc&&lt(n,Fc,Gc,!1)),J(n))}function Jr(n,e,l){if(6&Oc)throw Error(r(327))
for(var t=!l&&!(60&e)&&0===(e&n.expiredLanes)||k(n,e),u=t?function(n,e){var l=Oc
Oc|=2
var t=at(),u=ct()
_c!==n||Fc!==e?(nf=null,Zc=_i()+500,ut(n,e)):Bc=k(n,e)
n:for(;;){try{if(0!==Lc&&null!==Ac){e=Ac
var o=Dc
e:switch(Lc){case 1:Lc=0,Dc=null,yt(n,e,o,1)
break
case 2:if(wn(o)){Lc=0,Dc=null,ht(e)
break}e=function(){2===Lc&&_c===n&&(Lc=7),J(n)},o.then(e,e)
break n
case 3:Lc=7
break n
case 4:Lc=5
...
break
case 5:var i=null
switch(Ac.tag){case 26:i=Ac.memoizedState
case 5:case 27:var a=Ac,c=a.type,f=a.pendingProps
if(i?pi(i):Wu(c,f)){Lc=0,Dc=null
var s=a.sibling
if(null!==s)Ac=s
else{var v=a.return
null!==v?(Ac=v,bt(v)):Ac=null}break e}}Lc=0,Dc=null,yt(n,e,o,5)
break
...
break}catch(d){ot(n,d)}1}return ac=ic=null,hu.H=t,hu.A=u,Oc=l,null!==Ac?0:(_c=null,Fc=0,V(),Uc)}(n,e):st(n,e,!0),o=t;;){if(0===u){Bc&&!t&&lt(n,e,0,!1)
...
break
case 3:case 5:break
default:throw Error(r(329))}if(t.finishedWork=l,t.finishedLanes=e,(62914560&e)===e&&10<(o=Jc+300-_i())){if(lt(t,e,Gc,!Nc),0!==m(t,0))break n
t.timeoutHandle=Iu(nt.bind(null,t,l,Kc,nf,Xc,e,Gc,Vc,Qc,Nc,2,-0,0),o)}else nt(t,l,Kc,nf,Xc,e,Gc,Vc,Qc,Nc,0,-0,0)}}break}J(n)}function Zr(n){null===Kc?Kc=n:Kc.push.apply(Kc,n)}function nt(n,e,l,r,t,u,o,i,a,c,f,s,v){var d=e.subtreeFlags
if((8192&d||!(16785408&~d))&&(Gu(),Dr(e),null!==(e=Yu())))return n.cancelPendingCommit=e(mt.bind(null,n,l,r,t,o,i,a,1,s,v)),lt(n,u,o,!c),void 0
...
r[u]=-1,t&=~o}0!==l&&M(n,l,e)}function rt(){return!!(6&Oc)||(Z(0),!1)}function tt(){if(null!==Ac){if(0===Lc)var n=Ac.return
else ac=ic=null,Gn(n=Ac),Ta=null,Ia=0,n=Ac
for(;null!==n;)tr(n.alternate,n),n=n.return
Ac=null}}function ut(n,e){n.finishedWork=null,n.finishedLanes=0
var l=n.timeoutHandle
l!==Ou&&(n.timeoutHandle=Ou,zu(l)),null!==(l=n.cancelPendingCommit)&&(n.cancelPendingCommit=null,l()),tt(),_c=n,Ac=l=It(n.current,null),Fc=e,Lc=0,Dc=null,Nc=!1,Bc=k(n,e),Hc=!1,Qc=Gc=Wc=Vc=$c=Uc=0,Kc=Yc=null,Xc=!1,8&e&&(e|=32&e)
var r=n.entangledLanes
if(0!==r)for(n=n.entanglements,r&=e;0<r;){var t=31-Ci(r),u=1<<t
e|=n[t],r&=~u}return qc=e,V(),l}function ot(n,e){Ba=null,hu.H=Xa,e===Ma?(e=gn(),Lc=3):e===ja?(e=gn(),Lc=4):Lc=e===rc?8:null!==e&&"object"==typeof e&&"function"==typeof e.then?6:1,Dc=e,null===Ac&&(Uc=1,ll(n,T(e,n.current)))}function it(){var n=Fa.current
return null===n||((4194176&Fc)===Fc?null===La:!!((62914560&Fc)===Fc||536870912&Fc)&&n===La)}function at(){var n=hu.H
return hu.H=Xa,null===n?Xa:n}function ct(){var n=hu.A
return hu.A=Cc,n}function ft(){Uc=4,Nc||(4194176&Fc)!==Fc&&null!==Fa.current||(Bc=!0),!(134217727&$c)&&!(134217727&Vc)||null===_c||lt(_c,Fc,Gc,!1)}function st(n,e,l){var r=Oc
Oc|=2
var t=at(),u=ct()
_c===n&&Fc===e||(nf=null,ut(n,e)),e=!1
var o=Uc
n:for(;;){try{if(0!==Lc&&null!==Ac){var i=Ac,a=Dc
switch(Lc){case 8:tt(),o=6
break n
case 3:case 2:case 6:null===Fa.current&&(e=!0)
var c=Lc
if(Lc=0,Dc=null,yt(n,i,a,c),l&&Bc){o=0
break n}break
default:c=Lc,Lc=0,Dc=null,yt(n,i,a,c)}}vt(),o=Uc
break}catch(f){ot(n,f)}1}return e&&n.shellSuspendCounter++,ac=ic=null,Oc=r,hu.H=t,hu.A=u,null===Ac&&(_c=null,Fc=0,V()),o}function vt(){for(;null!==Ac;)pt(Ac)}function dt(){for(;null!==Ac&&!zi();)pt(Ac)}function pt(n){var e=Rl(n.alternate,n,qc)
n.memoizedProps=n.pendingProps,null===e?bt(n):Ac=e}function ht(n){var e=n,l=e.alternate
switch(e.tag){case 15:case 0:e=hl(l,e,e.pendingProps,e.type,void 0,Fc)
break
case 11:e=hl(l,e,e.pendingProps,e.type.render,e.ref,Fc)
break
case 5:Gn(e)
default:tr(l,e),e=Rl(l,e=Ac=zt(e,qc),qc)}n.memoizedProps=n.pendingProps,null===e?bt(n):Ac=e}function yt(n,e,l,t){ac=ic=null,Gn(e),Ta=null,Ia=0
var u=e.return
try{if(function(n,e,l,t,u){if(l.flags|=32768,null!==t&&"object"==typeof t&&"function"==typeof t.then){if(null!==(e=l.alternate)&&_l(e,l,u,!0),null!==(l=Fa.current)){switch(l.tag){case 13:return null===La?ft():null===l.alternate&&0===Uc&&(Uc=3),l.flags&=-257,l.flags|=65536,l.lanes=u,t===Pa?l.flags|=16384:(null===(e=l.updateQueue)?l.updateQueue=new Set([t]):e.add(t),St(n,t,u)),!1
case 22:return l.flags|=65536,t===Pa?l.flags|=16384:(null===(e=l.updateQueue)?(e={transitions:null,markerInstances:null,retryQueue:new Set([t])},l.updateQueue=e):null===(l=e.retryQueue)?e.retryQueue=new Set([t]):l.add(t),St(n,t,u)),!1}throw Error(r(435,l.tag))}return St(n,t,u),ft(),!1}if(oa)return null!==(e=Fa.current)?(!(65536&e.flags)&&(e.flags|=256),e.flags|=65536,e.lanes=u,t!==ca&&$(T(n=Error(r(422),{cause:t}),l))):(t!==ca&&$(T(e=Error(r(423),{cause:t}),l)),(n=n.current.alternate).flags|=65536,u&=-u,n.lanes|=u,t=T(t,l),vn(n,u=tl(n.stateNode,t,u)),4!==Uc&&(Uc=2)),!1
...
return!1}(n,u,e,l,Fc))return Uc=1,ll(n,T(l,n.current)),Ac=null,void 0}catch(o){if(null!==u)throw Ac=u,o
return Uc=1,ll(n,T(l,n.current)),Ac=null,void 0}32768&e.flags?(oa||1===t?n=!0:Bc||536870912&Fc?n=!1:(Nc=n=!0,(2===t||3===t||6===t)&&null!==(t=Fa.current)&&13===t.tag&&(t.flags|=16384)),wt(e,n)):bt(e)}function bt(n){var e=n
do{if(32768&e.flags)return wt(e,Nc),void 0
n=e.return
var l=lr(e.alternate,e,qc)
if(null!==l)return Ac=l,void 0
if(null!==(e=e.sibling))return Ac=e,void 0
Ac=e=n}while(null!==e)
0===Uc&&(Uc=5)}function wt(n,e){do{var l=rr(n.alternate,n)
if(null!==l)return l.flags&=32767,Ac=l,void 0
if(null!==(l=n.return)&&(l.flags|=32768,l.subtreeFlags=0,l.deletions=null),!e&&null!==(n=n.sibling))return Ac=n,void 0
Ac=n=l}while(null!==n)
Uc=6,Ac=null}function mt(n,e,l,t,u,o,i,a,c,f){var s=hu.T,v=Hu()
...
null!==d&&(d.lane&=-536870913)}l&=~s}0!==r&&M(n,r,0),0!==u&&0===t&&0!==n.tag&&(n.suspendedLanes|=u&~(o&~e))}(n,t,f|=va,o,i,a),n===_c&&(Ac=_c=null,Fc=0),!(10256&c.subtreeFlags)&&!(10256&c.flags)||lf||(lf=!0,uf=f,of=l,Ti(Li,function(){return gt(),null})),l=!!(15990&c.flags),15990&c.subtreeFlags||l?(l=hu.T,hu.T=null,o=Hu(),Bu(2),i=Oc,Oc|=4,function(n,e){for(Su(n.containerInfo),mc=e;null!==mc;)if(e=(n=mc).child,1028&n.subtreeFlags&&null!==e)e.return=n,mc=e
...
case 3:1024&e&&Au&&So(n.stateNode.containerInfo)
break
...
var c=Oc
if(Oc|=4,Hr(i.current),_r(i,i.current,a,t),Oc=c,Z(0),qi&&"function"==typeof qi.onPostCommitFiberRoot)try{qi.onPostCommitFiberRoot(Hi,i)}catch(f){}o=!0}return o}finally{Bu(u),hu.T=l,kt(n,e)}}return!1}function xt(n,e,l){e=T(l,e),null!==(n=fn(n,e=tl(n.stateNode,e,2),2))&&(C(n,2),J(n))}function Et(n,e,l){if(3===n.tag)xt(n,n,l)
...
null!==r&&r.delete(e),n.pingedLanes|=n.suspendedLanes&l,n.warmLanes&=~l,_c===n&&(Fc&l)===l&&(4===Uc||3===Uc&&(62914560&Fc)===Fc&&300>_i()-Jc?!(2&Oc)&&ut(n,0):Wc|=l,Qc===Fc&&(Qc=0)),J(n)}function Mt(n,e){0===e&&(e=E()),null!==(n=Y(n,e))&&(C(n,e),J(n))}function jt(n){var e=n.memoizedState,l=0
...
else n:switch(n){case nu:return _t(t.children,o,i,l)
case eu:a=8,o|=24
break
...
break n
case fu:a=16,u=null
break n}a=29,t=Error(r(130,null===n?"null":typeof n,"")),u=null}return(l=e(a,t,l,o)).elementType=n,l.type=u,l.lanes=i,l}function _t(n,l,r,t){return(n=e(7,n,t,l)).lanes=r,n}function At(n,l,t,u){(n=e(22,n,u,l)).elementType=su,n.lanes=t
...
n.retryLane=0!==l&&l<e?l:e}}function $t(n,e){Ut(n,e),(n=n.alternate)&&Ut(n,e)}var Vt,Wt,Gt={},Qt=W(),Yt=function(){return Fn||(Fn=1,$n.exports=function(){return An||(An=1,function(n){function e(n,e){var l=n.length
n.push(e)
...
return e.dispatch=l,[n.memoizedState,l]},useDebugValue:Oe,useDeferredValue:function(n,e){return Fe(Qn(),n,e)},useTransition:function(){var n=ce(!1)
return n=De.bind(null,Ba,n.queue,!0,!1),Qn().memoizedState=n,[!1,n]},useSyncExternalStore:function(n,e,l){var t=Ba,u=Qn()
if(oa){if(void 0===l)throw Error(r(407))
l=l()}else{if(l=e(),null===_c)throw Error(r(349))
60&Fc||te(t,e,l)}u.memoizedState=l
var o={value:l,getSnapshot:e}
return u.queue=o,je(oe.bind(null,t,o,n),[n]),t.flags|=2048,Ee(9,ue.bind(null,t,o,l,e),{destroy:void 0},null),l},useId:function(){var n=Qn(),e=_c.identifierPrefix
if(oa){var l=Zi
...
var Za={readContext:Ll,use:Xn,useCallback:_e,useContext:Ll,useEffect:Pe,useImperativeHandle:ze,useInsertionEffect:Re,useLayoutEffect:Te,useMemo:Ae,useReducer:ne,useRef:Se,useState:function(){return ne(Zn)},useDebugValue:Oe,useDeferredValue:function(n,e){return Le(Yn(),Ha.memoizedState,n,e)},useTransition:function(){var n=ne(Zn)[0],e=Yn().memoizedState
return["boolean"==typeof n?n:Kn(n),e]},useSyncExternalStore:re,useId:He}
Za.useCacheRefresh=Ue,Za.useMemoCache=Jn,Za.useHostTransitionStatus=Be,Za.useFormState=me,Za.useActionState=me,Za.useOptimistic=function(n,e){return fe(Yn(),0,n,e)}
var nc={readContext:Ll,use:Xn,useCallback:_e,useContext:Ll,useEffect:Pe,useImperativeHandle:ze,useInsertionEffect:Re,useLayoutEffect:Te,useMemo:Ae,useReducer:le,useRef:Se,useState:function(){return le(Zn)},useDebugValue:Oe,useDeferredValue:function(n,e){var l=Yn()
return null===Ha?Fe(l,n,e):Le(l,Ha.memoizedState,n,e)},useTransition:function(){var n=le(Zn)[0],e=Yn().memoizedState
return["boolean"==typeof n?n:Kn(n),e]},useSyncExternalStore:re,useId:He}
nc.useCacheRefresh=Ue,nc.useMemoCache=Jn,nc.useHostTransitionStatus=Be,nc.useFormState=xe,nc.useActionState=xe,nc.useOptimistic=function(n,e){var l=Yn()
...
Mc=Ic("selector.component"),jc=Ic("selector.has_pseudo_class"),Pc=Ic("selector.role"),Rc=Ic("selector.test_id"),Tc=Ic("selector.text")}var zc="function"==typeof WeakMap?WeakMap:Map,Oc=0,_c=null,Ac=null,Fc=0,Lc=0,Dc=null,Nc=!1,Bc=!1,Hc=!1,qc=0,Uc=0,$c=0,Vc=0,Wc=0,Gc=0,Qc=0,Yc=null,Kc=null,Xc=!1,Jc=0,Zc=1/0,nf=null,ef=null,lf=!1,rf=null,tf=0,uf=0,of=null,af=0,cf=null
...
n.entanglements[1]|=l,e&=~l}J(n),!(6&Oc)&&(Zc=_i()+500,Z(0))}}break
case 13:null!==(e=Y(n,2))&&Xr(e,0,2),rt(),$t(n,2)}},Gt.batchedUpdates=function(n,e){return n(e)},Gt.createComponentSelector=function(n){return{$$typeof:Mc,value:n}},Gt.createContainer=function(n,e,l,r,t,u,o,i,a,c){return Nt(n,e,!1,null,0,r,u,o,i,a,0,null)},Gt.createHasPseudoClassSelector=function(n){return{$$typeof:jc,value:n}},Gt.createHydrationContainer=function(n,e,l,r,t,u,o,i,a,c,f,s,v){return(n=Nt(l,r,!0,n,0,u,i,a,c,f,0,v)).context=Bt(null),l=n.current,(t=cn(r=Yr())).callback=null!=e?e:null,fn(l,t,r),n.current.lanes=r,C(n,r),J(n),n},Gt.createPortal=function(n,e,l){var r=3<arguments.length&&void 0!==arguments[3]?arguments[3]:null
...
try{return Bu(2),hu.T=null,n(e,l,r,t)}finally{Bu(o),hu.T=u,0===Oc&&(Zc=_i()+500)}},Gt.findAllNodes=Qr,Gt.findBoundingRects=function(n,e){if(!eo)throw Error(r(363))
e=Qr(n,e),n=[]
...
return qt(t,u,n,e,l,r),u},Gt.updateContainerSync=function(n,e,l,r){return 0===e.tag&&gt(),qt(e.current,2,n,e,l,r),2},Gt},n.exports.default=n.exports,Object.defineProperty(n.exports,"I",{value:!0})),Un.exports
var n}function e(n){let e=n.root
for(;e.getState().previousRoot;)e=e.getState().previousRoot
return e}function l(n){const e=Q.useRef(n)
return ne(()=>{e.current=n},[n]),e}function r({set:n}){return ne(()=>(n(new Promise(()=>null)),()=>n(!1)),[n]),null}function t(n){var e
...
for(const l in n)re.includes(l)||(e[l]=n[l])
...
e=t,n=l,l=null==(r=l)?void 0:r[e]}return{root:n,key:e,target:l}}function c(n,e){if(le.str(e.props.attach)){if(te.test(e.props.attach)){const l=e.props.attach.replace(te,""),{root:r,key:t}=a(n.object,l)
Array.isArray(r[t])||(r[t]=[])}const{root:l,key:r}=a(n.object,e.props.attach)
e.previousAttach=l[r],l[r]=e.object}else le.fun(e.props.attach)&&(e.previousAttach=e.props.attach(n.object,e.object))}function f(n,e){if(le.str(e.props.attach)){const{root:l,key:r}=a(n.object,e.props.attach),t=e.previousAttach
void 0===t?delete l[r]:l[r]=t}else null==e.previousAttach?void 0:e.previousAttach(n.object,e.object)
delete e.previousAttach}function s(n){let e=oe.get(n.constructor)
try{e||(e=new n.constructor,oe.set(n.constructor,e))}catch(qe){}return e}function v(n,l){var r
const t=n.O,u=t&&e(t).getState(),o=null==t?void 0:t.eventCount
for(const e in l){let r=l[e]
if(ue.includes(e))continue
if(t&&ae.test(e)){"function"==typeof r?t.handlers[e]=r:delete t.handlers[e],t.eventCount=Object.keys(t.handlers).length
continue}if(void 0===r)continue
let{root:o,key:c,target:f}=a(n,e)
if(f instanceof pn&&r instanceof pn)f.mask=r.mask
else if(f instanceof hn&&Zn(r))f.set(r)
...
o[c]=r,u&&!u.linear&&ie.includes(c)&&null!=(i=o[c])&&i.isTexture&&o[c].format===yn&&o[c].type===bn&&(o[c].colorSpace=fn)}}if(null!=t&&t.parent&&null!=u&&u.internal&&null!=(r=t.object)&&r.isObject3D&&o!==t.eventCount){const n=t.object,e=u.internal.interaction.indexOf(n)
...
t&&(l.delete(e),0===l.size&&(n.delete(r),t.target.releasePointerCapture(r)))}function y(){const n=Q.useContext(se)
...
return ne(()=>t(u,e,r),[e,t,r]),null}function m(n){if("function"==typeof n){const e=""+he++
return ve[e]=n,e}Object.assign(ve,n)}function k(n,e){const l=pe(n),r=ve[l]
...
n.isHidden&&(n.props.attach&&null!=(e=n.parent)&&e.object?c(n.parent,n):ce(n.object)&&!1!==n.props.visible&&(n.object.visible=!0),n.isHidden=!1,d(n))}function x(n,e,l){const r=e.root.getState()
if(n.parent||n.object===r.scene){if(!e.object){var t,u
const n=ve[pe(e.type)]
e.object=null!=(t=e.props.object)?t:new n(...null!=(u=e.props.args)?u:[]),e.object.O=e}if(v(e.object,e.props),e.props.attach)c(n,e)
else if(ce(e.object)&&ce(n.object)){const r=n.object.children.indexOf(null==l?void 0:l.object)
...
"undefined"!=typeof IS_REACT_ACT_ENVIRONMENT?e():Xn.unstable_scheduleCallback(Xn.unstable_IdlePriority,e)}}function M(n,l,r){if(!l)return
l.parent=null
const t=n.children.indexOf(l);-1!==t&&n.children.splice(t,1),l.props.attach?f(n,l):ce(l.object)&&ce(n.object)&&(n.object.remove(l.object),function(n,e){const{internal:l}=n.getState()
...
const n=l.ref(e)
"function"==typeof n&&(l.refCleanup=n)}else l.ref&&(l.ref.current=e)}function P({store:n,children:e,onCreated:l,rootElement:r}){return ne(()=>{const e=n.getState()
e.set(n=>({internal:{...n.internal,active:!0}})),l&&l(e),n.getState().events.connected||null==e.events.connect||e.events.connect(r)},[]),V.jsx(se.Provider,{value:n,children:e})}function R(n,e){const l=ge.get(n),r=null==l?void 0:l.fiber
if(r){const e=null==l?void 0:l.store.getState()
e&&(e.internal.active=!1),ke.updateContainer(null,r,null,()=>{e&&setTimeout(()=>{try{var l,r,t,u
...
"Scene"!==(null==l?void 0:l.type)&&(null==l||null==l.dispose?void 0:l.dispose())}}(e.scene),ge.delete(n)}catch(qe){}},500)})}}function T(n,e){if(n.size)for(const{callback:l}of n.values())l(e)}function I(n,e){switch(n){case"before":return T(Ee,e)
case"after":return T(Se,e)
case"tail":return T(Ce,e)}}function z(n,e,l){let r=e.clock.getDelta()
"never"===e.frameloop&&"number"==typeof n&&(r=n-e.clock.elapsedTime,e.clock.oldTime=e.clock.elapsedTime,e.clock.elapsedTime=n),Me=e.internal.subscribers
for(let t=0;t<Me.length;t++)je=Me[t],je.ref.current(je.store.getState(),r,l)
return!e.internal.priority&&e.gl.render&&e.gl.render(e.scene,e.camera),e.internal.frames=Math.max(0,e.internal.frames-1),"always"===e.frameloop?1:e.internal.frames}function O(n){Re=requestAnimationFrame(O),Ie=!0,Pe=0,I("before",n),ze=!0
for(const l of ge.values()){var e
Te=l.store.getState(),!Te.internal.active||!("always"===Te.frameloop||Te.internal.frames>0)||null!=(e=Te.gl.xr)&&e.isPresenting||(Pe+=z(n,Te))}if(ze=!1,I("after",n),0===Pe)return I("tail",n),Ie=!1,cancelAnimationFrame(Re)}function _(n,e=1){var l
if(!n)return ge.forEach(n=>_(n.store.getState(),e))
null!=(l=n.gl.xr)&&l.isPresenting||!n.internal.active||"never"===n.frameloop||(n.internal.frames=e>1?Math.min(60,n.internal.frames+e):ze?2:1,Ie||(Ie=!0,requestAnimationFrame(O)))}function A(n,e=!0,l,r){if(e&&I("before",n),l)z(n,l,r)
else for(const t of ge.values())z(n,t.store.getState())
e&&I("after",n)}function F(n){const{handlePointer:e}=function(n){function e(n){return n.filter(n=>["Move","Over","Enter","Out","Leave"].some(e=>{var l
...
if(e)return a=e,!1}),a){const{raycaster:u,pointer:c,camera:f,internal:s}=a,v=new wn(c.x,c.y,0).unproject(f),d=n=>{var e,l
...
return{priority:1,enabled:!0,compute(n,e,l){e.pointer.set(n.offsetX/e.size.width*2-1,-n.offsetY/e.size.height*2+1),e.raycaster.setFromCamera(e.pointer,e.camera)},connected:void 0,handlers:Object.keys(Oe).reduce((n,l)=>({...n,[l]:e(l)}),{}),update:()=>{var e
...
if(null==r.disconnect?void 0:r.disconnect(),l(n=>({events:{...n.events,connected:e}})),r.handlers)for(const n in r.handlers){const l=r.handlers[n],[t,u]=Oe[n]
e.addEventListener(t,l,{passive:u})}},disconnect:()=>{const{set:e,events:l}=n.getState()
if(l.connected){if(l.handlers)for(const n in l.handlers){const e=l.handlers[n],[r]=Oe[n]
...
const[i,a]=Q.useState({left:0,top:0,width:0,height:0,bottom:0,right:0,x:0,y:0}),c=Q.useRef({element:null,scrollContainers:null,resizeObserver:null,lastBounds:i,orientationHandler:null}),f=n?"number"==typeof n?n:n.scroll:null,s=n?"number"==typeof n?n:n.resize:null,v=Q.useRef(!1)
Q.useEffect(()=>(v.current=!0,()=>{v.current=!1}))
const[d,p,h]=Q.useMemo(()=>{const n=()=>{if(!c.current.element)return
...
return function(n,e){Q.useEffect(()=>{if(e){const e=n
return window.addEventListener("scroll",e,{capture:!0,passive:!0}),()=>{window.removeEventListener("scroll",e,!0)}}},[n,e])}(h,!!e),function(n){Q.useEffect(()=>{const e=n
return window.addEventListener("resize",e),()=>{window.removeEventListener("resize",e)}},[n])}(p),Q.useEffect(()=>{t(),u()},[e,h,p]),Q.useEffect(()=>t,[]),[n=>{!n||n===c.current.element||(t(),c.current.element=n,c.current.scrollContainers=N(n),u())},i,d]}function N(n){const e=[]
if(!n||n===document.body)return e
const{overflow:l,overflowX:r,overflowY:t}=window.getComputedStyle(n)
return[l,r,t].some(n=>"auto"===n||"scroll"===n)&&e.push(n),[...e,...N(n.parentElement)]}function B({ref:n,children:e,fallback:u,resize:o,style:a,gl:c,events:f=F,eventSource:s,eventPrefix:d,shadows:p,linear:h,flat:y,legacy:b,orthographic:w,frameloop:k,dpr:g,performance:x,raycaster:E,camera:S,scene:C,onPointerMissed:M,onCreated:j,...T}){Q.useMemo(()=>m(xn),[])
const I=function(){const n=Y(),e=K()
return Q.useMemo(()=>({children:l})=>{const r=X(n,!0,n=>n.type===Q.StrictMode)?Q.StrictMode:Q.Fragment
return V.jsx(r,{children:V.jsx(e,{children:l})})},[n,e])}(),[z,O]=D({scroll:!0,debounce:{scroll:50,resize:0},...o}),L=Q.useRef(null),N=Q.useRef(null)
Q.useImperativeHandle(n,()=>L.current)
const B=l(M),[H,q]=Q.useState(!1),[U,$]=Q.useState(!1)
if(H)throw H
if(U)throw U
const W=Q.useRef(null)
ne(()=>{const n=L.current
...
e.pointer.set(l/e.size.width*2-1,-r/e.size.height*2+1),e.raycaster.setFromCamera(e.pointer,e.camera)}}),null==j||j(n)}}),W.current.render(V.jsx(I,{children:V.jsx(ee,{set:$,children:V.jsx(Q.Suspense,{fallback:V.jsx(r,{set:q}),children:null!=e?e:null})})}))}W.current||(W.current=function(n){const e=ge.get(n),l=null==e?void 0:e.fiber,r=null==e?void 0:e.store
e,0
const u="function"==typeof reportError?reportError:console.error,o=r||((n,e)=>{const l=dn((l,r)=>{function u(n=r().camera,e=i,l=r().size){const{width:t,height:u,top:c,left:f}=l,s=t/u
e.isVector3?a.copy(e):a.set(...e)
const v=n.getWorldPosition(o).distanceTo(a)
if(Jn(n))return{width:t/n.zoom,height:u/n.zoom,top:c,left:f,factor:1,distance:v,aspect:s}
{const e=n.fov*Math.PI/180,l=2*Math.tan(e/2)*v,r=l*(t/u)
return{width:r,height:l,top:c,left:f,factor:t/r,distance:v,aspect:s}}}const o=new wn,i=new wn,a=new wn
let c
const f=n=>l(e=>({performance:{...e.performance,current:n}})),s=new mn,v={set:l,get:r,gl:null,camera:null,raycaster:null,events:{priority:1,enabled:!0,connected:!1},scene:null,xr:null,invalidate:(e=1)=>n(r(),e),advance:(n,l)=>e(n,l,r()),legacy:!1,linear:!1,flat:!1,controls:null,clock:new kn,pointer:s,mouse:s,frameloop:"always",onPointerMissed:void 0,performance:{current:1,min:.5,max:1,debounce:200,regress:()=>{const n=r()
...
e.stop(),e.elapsedTime=0,"never"!==n&&(e.start(),e.elapsedTime=0),l(()=>({frameloop:n}))},previousRoot:void 0,internal:{interaction:[],hovered:new Map,subscribers:[],initialClick:[0,0],initialHits:[],capturedMap:new Map,lastEvent:Q.createRef(),active:!1,frames:0,priority:0,subscribe:(n,e,l)=>{const t=r().internal
...
if(e.width!==u.width||e.height!==u.height||r.dpr!==o){u=e,o=r.dpr,function(n,e){n.manual||(Jn(n)?(n.left=e.width/-2,n.right=e.width/2,n.top=e.height/2,n.bottom=e.height/-2):n.aspect=e.width/e.height,n.updateProjectionMatrix())}(n,e),r.dpr>0&&t.setPixelRatio(r.dpr)
const l="undefined"!=typeof HTMLCanvasElement&&t.domElement instanceof HTMLCanvasElement
t.setSize(e.width,e.height,l)}n!==i&&(i=n,a(e=>({viewport:{...e.viewport,...e.viewport.getCurrentViewport(n)}})))}),l.subscribe(e=>n(e)),l})(_,A),a=l||ke.createContainer(o,Hn.ConcurrentRoot,null,!1,null,"",u,u,u,null)
let c,f
e||ge.set(n,{fiber:a,store:o})
let s=!1,d=null
...
P=fe(l)?l:new J({...e,...r}),j.set({gl:P})}let R=j.raycaster
R||j.set({raycaster:R=new Z})
const{params:T,...I}=S||{}
if(le.equ(I,R,xe)||v(R,{...I}),le.equ(T,R.params,xe)||v(R,{params:{...R.params,...T}}),!j.camera||j.camera===f&&!le.equ(f,C,xe)){f=C
const n=null==C?void 0:C.isCamera,e=n?C:k?new nn(0,0,0,0,.1,1e3):new en(75,0,.1,1e3)
...
null!=a&&a.isScene?(n=a,i(n,o,"",{})):(n=new ln,i(n,o,"",{}),a&&v(n,a)),j.set({scene:n})}p&&!j.events.handlers&&j.set({events:p(o)})
...
if(le.equ(z,j.size,xe)||j.setSize(z.width,z.height,z.top,z.left),x&&j.viewport.dpr!==t(x)&&j.setDpr(x),j.frameloop!==g&&j.setFrameloop(g),j.onPointerMissed||j.set({onPointerMissed:M}),E&&!le.equ(E,j.performance,xe)&&j.set(n=>({performance:{...n.performance,...E}})),!j.xr){var O
const n=(n,e)=>{const l=o.getState()
"never"!==l.frameloop&&A(n,!0,l,e)},e=()=>{const e=o.getState()
e.gl.xr.enabled=e.gl.xr.isPresenting,e.gl.xr.setAnimationLoop(e.gl.xr.isPresenting?n:null),e.gl.xr.isPresenting||_(e)},l={connect(){const n=o.getState().gl
...
return function(){var l=m
m=e
try{return n.apply(this,arguments)}finally{m=l}}}}(Kn)),Kn}()),Yn.exports}()
const Jn=n=>n&&n.isOrthographicCamera,Zn=n=>null!=n&&("string"==typeof n||"number"==typeof n||n.isColor),ne=((n,e)=>"undefined"!=typeof window&&((null==(n=window.document)?void 0:n.createElement)||"ReactNative"===(null==(e=window.navigator)?void 0:e.product)))()?Q.useLayoutEffect:Q.useEffect,ee=(n=>((n=class extends Q.Component{constructor(...n){super(...n),this.state={error:!1}}componentDidCatch(n){this.props.set(n)}render(){return this.state.error?null:this.props.children}}).getDerivedStateFromError=()=>({error:!0}),n))(),le={obj:n=>n===Object(n)&&!le.arr(n)&&"function"!=typeof n,fun:n=>"function"==typeof n,str:n=>"string"==typeof n,num:n=>"number"==typeof n,boo:n=>"boolean"==typeof n,und:n=>void 0===n,nul:n=>null===n,arr:n=>Array.isArray(n),equ(n,e,{arrays:l="shallow",objects:r="reference",strict:t=!0}={}){if(typeof n!=typeof e||!!n!=!!e)return!1
if(le.str(n)||le.num(n)||le.boo(n))return n===e
const u=le.obj(n)
...
if(u&&"shallow"===l&&"shallow"===r){for(i in t?e:n)if(!le.equ(n[i],e[i],{strict:t,objects:"reference"}))return!1}else for(i in t?e:n)if(n[i]!==e[i])return!1
if(le.und(i)){if(o&&0===n.length&&0===e.length)return!0
if(u&&0===Object.keys(n).length&&0===Object.keys(e).length)return!0
if(n!==e)return!1}return!0}},re=["children","key","ref"],te=/-\d+$/,ue=[...re,"args","dispose","attach","object","onUpdate","dispose"],oe=new Map,ie=["map","emissiveMap","sheenColorMap","specularColorMap","envMap"],ae=/^on(Pointer|Click|DoubleClick|ContextMenu|Wheel)/,ce=n=>null==n?void 0:n.isObject3D,fe=n=>!(null==n||!n.render),se=Q.createContext(null),ve={},de=/^three(?=[A-Z])/,pe=n=>`${n[0].toUpperCase()}${n.slice(1)}`
let he=0
const ye=[],be=()=>{},we={}
let me=0
const ke=function(n){const e=Wn(n)
return e.injectIntoDevTools({bundleType:0,rendererPackageName:"@react-three/fiber",version:Q.version}),e}({isPrimaryRenderer:!1,warnsIfNotActing:!1,supportsMutation:!0,supportsPersistence:!1,supportsHydration:!1,createInstance:function(n,e,l){var r
return k(n=pe(n)in ve?n:n.replace(de,""),e),"primitive"===n&&null!=(r=e.object)&&r.O&&delete e.object.O,i(e.object,l,n,e)},removeChild:M,appendChild:E,appendInitialChild:E,insertBefore:S,appendChildToContainer(n,e){const l=n.getState().scene.O
...
e&&l&&r&&S(r,e,l)},getRootHostContext:()=>we,getChildHostContext:()=>we,commitUpdate(n,e,l,r,t){var u,o,i
k(e,r)
let p=!1
...
return n!==(null==(r=l.args)?void 0:r[e])}))&&(p=!0),p)ye.push([n,{...r},t])
else{const e=function(n,e){const l={}
for(const r in e)if(!ue.includes(r)&&!le.equ(e[r],n.props[r])){l[r]=e[r]
for(const n in e)n.startsWith(`${r}-`)&&(l[n]=e[n])}for(const r in n.props){if(ue.includes(r)||e.hasOwnProperty(r))continue
const{root:t,key:u}=a(n.object,r)
if(t.constructor&&0===t.constructor.length){const n=s(t)
le.und(n)||(l[u]=n[u])}else l[u]=0}return l}(n,r)
Object.keys(e).length&&(Object.assign(n.props,e),v(n.object,e))}!(null!==t.sibling&&4&t.flags||function(){for(const[l]of ye){const n=l.parent
if(n){l.props.attach?f(n,l):ce(l.object)&&ce(n.object)&&n.object.remove(l.object)
for(const n of l.children)n.props.attach?f(l,n):ce(n.object)&&ce(l.object)&&l.object.remove(n.object)}l.isHidden&&g(l),l.object.O&&delete l.object.O,"primitive"!==l.type&&C(l.object)}for(const[l,r,t]of ye){l.props=r
const u=l.parent
if(u){var n,e
const r=ve[pe(l.type)]
l.object=null!=(n=l.props.object)?n:new r(...null!=(e=l.props.args)?e:[]),l.object.O=l,j(t,l.object),v(l.object,l.props),l.props.attach?c(u,l):ce(l.object)&&ce(u.object)&&u.object.add(l.object)
for(const n of l.children)n.props.attach?c(l,n):ce(n.object)&&ce(l.object)&&l.object.add(n.object)
d(l)}}ye.length=0}())},finalizeInitialChildren:()=>!1,commitMount(){},getPublicInstance:n=>null==n?void 0:n.object,prepareForCommit:()=>null,preparePortalMount:n=>i(n.getState().scene,n,"",{}),resetAfterCommit:()=>{},shouldSetTextContent:()=>!1,clearContainer:()=>!1,hideInstance:function(n){var e
n.isHidden||(n.props.attach&&null!=(e=n.parent)&&e.object?f(n.parent,n):ce(n.object)&&(n.object.visible=!1),n.isHidden=!0,d(n))},unhideInstance:g,createTextInstance:be,hideTextInstance:be,unhideTextInstance:be,scheduleTimeout:"function"==typeof setTimeout?setTimeout:void 0,cancelTimeout:"function"==typeof clearTimeout?clearTimeout:void 0,noTimeout:-1,getInstanceFromNode:()=>null,beforeActiveInstanceBlur(){},afterActiveInstanceBlur(){},detachDeletedInstance(){},prepareScopeUpdate(){},getInstanceFromScope:()=>null,shouldAttemptEagerTransition:()=>!1,trackSchedulerEvent:()=>{},resolveEventType:()=>null,resolveEventTimeStamp:()=>-1.1,requestPostPaintCallback(){},maySuspendCommit:()=>!1,preloadInstance:()=>!0,startSuspendingCommit(){},suspendInstance(){},waitForCommitToBeReady:()=>null,NotPendingTransition:null,HostTransitionContext:Q.createContext(null),setCurrentUpdatePriority(n){me=n},getCurrentUpdatePriority:()=>me,resolveUpdatePriority(){var n
if(0!==me)return me
switch("undefined"!=typeof window&&(null==(n=window.event)?void 0:n.type)){case"click":case"contextmenu":case"dblclick":case"pointercancel":case"pointerdown":case"pointerup":return Hn.DiscreteEventPriority
case"pointermove":case"pointerout":case"pointerover":case"pointerenter":case"pointerleave":case"wheel":return Hn.ContinuousEventPriority
default:return Hn.DefaultEventPriority}},resetFormInstance(){}}),ge=new Map,xe={objects:"shallow",strict:!1},Ee=new Set,Se=new Set,Ce=new Set
let Me,je,Pe,Re,Te,Ie=!1,ze=!1
const Oe={onClick:["click",!1],onContextMenu:["contextmenu",!1],onDoubleClick:["dblclick",!1],onWheel:["wheel",!0],onPointerDown:["pointerdown",!0],onPointerUp:["pointerup",!0],onPointerLeave:["pointerleave",!0],onPointerMove:["pointermove",!0],onPointerCancel:["pointercancel",!0],onLostPointerCapture:["lostpointercapture",!0]},_e=["x","y","top","bottom","left","right","width","height"],Ae=(n,e)=>_e.every(l=>n[l]===e[l]),Fe=Q.createContext(null),Le=n=>!(2&~n.getAttributes()),De=Q.memo(Q.forwardRef(({children:n,camera:e,scene:l,resolutionScale:r,enabled:t=!0,renderPriority:u=1,autoClear:o=!0,depthBuffer:i,enableNormalPass:a,stencilBuffer:c,multisampling:f=8,frameBufferType:s=Sn},v)=>{const{gl:d,scene:p,camera:h,size:y}=b(),m=l||p,k=e||h,[g,x,E]=Q.useMemo(()=>{const n=new En(d,{depthBuffer:i,stencilBuffer:c,multisampling:f,frameBufferType:s})
n.addPass(new Cn(m,k))
let e=null,l=null
return a&&(l=new Mn(m,k),l.enabled=!1,n.addPass(l),void 0!==r&&(e=new jn({normalBuffer:l.texture,resolutionScale:r}),e.enabled=!1,n.addPass(e))),[n,l,e]},[k,d,i,c,f,s,m,a,r])
Q.useEffect(()=>g?.setSize(y.width,y.height),[g,y]),w((n,e)=>{if(t){const n=d.autoClear
d.autoClear=o,c&&!o&&d.clearStencil(),g.render(e),d.autoClear=n}},t?u:0)
const S=Q.useRef(null)
Q.useLayoutEffect(()=>{const n=[],e=S.current.O
if(e&&g){const l=e.children
for(let e=0;e<l.length;e++){const r=l[e].object
if(r instanceof Pn){const t=[r]
if(!Le(r)){let n=null
for(;(n=l[e+1]?.object)instanceof Pn&&!Le(n);)t.push(n),e++}const u=new Rn(k,...t)
n.push(u)}else r instanceof In&&n.push(r)}for(const e of n)g?.addPass(e)
x&&(x.enabled=!0),E&&(E.enabled=!0)}return()=>{for(const e of n)g?.removePass(e)
x&&(x.enabled=!1),E&&(E.enabled=!1)}},[g,n,k,x,E]),Q.useEffect(()=>{const n=d.toneMapping
return d.toneMapping=sn,()=>{d.toneMapping=n}},[d])
const C=Q.useMemo(()=>({composer:g,normalPass:x,downSamplingPass:E,resolutionScale:r,camera:k,scene:m}),[g,x,E,r,k,m])
return Q.useImperativeHandle(v,()=>g,[g]),V.jsx(Fe.Provider,{value:C,children:V.jsx("group",{ref:S,children:n})})}))
let Ne=0
const Be=new WeakMap,He=(qe=class extends Pn{constructor(){const n=new Map([["colorNum",new zn(4)],["pixelSize",new zn(2)]])
super("RetroEffect","\nprecision highp float;\nuniform float colorNum;\nuniform float pixelSize;\nconst float bayerMatrix8x8[64] = float[64](\n  0.0/64.0, 48.0/64.0, 12.0/64.0, 60.0/64.0,  3.0/64.0, 51.0/64.0, 15.0/64.0, 63.0/64.0,\n  32.0/64.0,16.0/64.0, 44.0/64.0, 28.0/64.0, 35.0/64.0,19.0/64.0, 47.0/64.0, 31.0/64.0,\n  8.0/64.0, 56.0/64.0,  4.0/64.0, 52.0/64.0, 11.0/64.0,59.0/64.0,  7.0/64.0, 55.0/64.0,\n  40.0/64.0,24.0/64.0, 36.0/64.0, 20.0/64.0, 43.0/64.0,27.0/64.0, 39.0/64.0, 23.0/64.0,\n  2.0/64.0, 50.0/64.0, 14.0/64.0, 62.0/64.0,  1.0/64.0,49.0/64.0, 13.0/64.0, 61.0/64.0,\n  34.0/64.0,18.0/64.0, 46.0/64.0, 30.0/64.0, 33.0/64.0,17.0/64.0, 45.0/64.0, 29.0/64.0,\n  10.0/64.0,58.0/64.0,  6.0/64.0, 54.0/64.0,  9.0/64.0,57.0/64.0,  5.0/64.0, 53.0/64.0,\n  42.0/64.0,26.0/64.0, 38.0/64.0, 22.0/64.0, 41.0/64.0,25.0/64.0, 37.0/64.0, 21.0/64.0\n);\n\nvec3 dither(vec2 uv, vec3 color) {\n  vec2 scaledCoord = floor(uv * resolution / pixelSize);\n  int x = int(mod(scaledCoord.x, 8.0));\n  int y = int(mod(scaledCoord.y, 8.0));\n  float threshold = bayerMatrix8x8[y * 8 + x] - 0.25;\n  float step = 1.0 / (colorNum - 1.0);\n  color += threshold * step;\n  float bias = 0.2;\n  color = clamp(color - bias, 0.0, 1.0);\n  return floor(color * (colorNum - 1.0) + 0.5) / (colorNum - 1.0);\n}\n\nvoid mainImage(in vec4 inputColor, in vec2 uv, out vec4 outputColor) {\n  vec2 normalizedPixelSize = pixelSize / resolution;\n  vec2 uvPixel = normalizedPixelSize * floor(uv / normalizedPixelSize);\n  vec4 color = texture2D(inputBuffer, uvPixel);\n  color.rgb = dither(uv, color.rgb);\n  outputColor = color;\n}\n",{uniforms:n}),this.uniforms=n}set colorNum(n){this.uniforms.get("colorNum").value=n}get colorNum(){return this.uniforms.get("colorNum").value}set pixelSize(n){this.uniforms.get("pixelSize").value=n}get pixelSize(){return this.uniforms.get("pixelSize").value}},function({blendFunction:n,opacity:e,...l}){let r=Be.get(qe)
if(!r){const n=`@react-three/postprocessing/${qe.name}-${Ne++}`
m({[n]:qe}),Be.set(qe,r=n)}const t=b(n=>n.camera),u=Tn.useMemo(()=>[...l.args??[{...l}]],[JSON.stringify(l)])
return V.jsx(r,{camera:t,"blendMode-blendFunction":n,"blendMode-opacity-value":e,...l,args:u})})
var qe
const Ue=Q.forwardRef((n,e)=>{const{colorNum:l,pixelSize:r}=n
return V.jsx(He,{ref:e,colorNum:l,pixelSize:r})})
Ue.displayName="RetroEffect"
export{$ as default}
