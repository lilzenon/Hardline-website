const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/DitherShadcn-gD3YR4Ff.js","assets/index-BI7dje9I.js","assets/vendor-ViNJc2wV.js","assets/index-C9VxiwSc.css"])))=>i.map(i=>d[i]);
import{j as t,_ as o}from"./index-BI7dje9I.js";import{b as a}from"./vendor-ViNJc2wV.js";import{l as i}from"./productionDebug-ZprwcnaH.js";const n=a.lazy(()=>o(()=>import("./DitherShadcn-gD3YR4Ff.js"),__vite__mapDeps([0,1,2,3])).then(r=>({default:r.Dither}))),s=()=>t.jsx("div",{style:{position:"absolute",top:0,left:0,width:"100%",height:"100%",zIndex:1,background:`
