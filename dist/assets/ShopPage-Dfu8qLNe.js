const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ShopPageMobile-noMLQB1G.js","assets/index-CzEcVaxA.js","assets/vendor-ViNJc2wV.js","assets/index-BPM0BZxC.css","assets/MobileNavigation-DNCxjqSE.js","assets/SocialMediaButtons-DrttEGV2.js","assets/shopService-D3Jzy0Uo.js","assets/Footer-VWVT0JZz.js","assets/CartIcon-BNavJ2RS.js","assets/Breadcrumb-DTXaE98_.js","assets/useSEO-DBKKBGJL.js"])))=>i.map(i=>d[i]);
import{a as B,j as e,B as z,_ as R}from"./index-CzEcVaxA.js";import{b as r}from"./vendor-ViNJc2wV.js";import{a as O,D as W,F as N}from"./Footer-VWVT0JZz.js";import{C as U,a as A}from"./CartIcon-BNavJ2RS.js";import{f as D}from"./shopService-D3Jzy0Uo.js";import{u as H}from"./useSEO-DBKKBGJL.js";import{B as $}from"./Breadcrumb-DTXaE98_.js";const V=t=>{window.navigateWithTransition?window.navigateWithTransition(t):window.location.href=t};function E(t){return new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"}).format(t/100)}function Y({product:t,onAddToCart:a}){const[x,l]=r.useState(!1),[f,p]=r.useState(!1),[g,m]=r.useState(!1),[d,u]=r.useState(!1),[y,k]=r.useState(0),{addItem:b,toggleCart:v}=B(),h=t.stock_quantity!==null&&t.stock_quantity<=0,c=t?.sizes&&Array.isArray(t.sizes)&&t.sizes.length>0?t.sizes.filter(o=>o.stock>0).map(o=>o.size):[],w="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 200 200' fill='%23666'%3E%3Crect width='200' height='200' fill='%23222'/%3E%3Cpath d='M80 70h40v60H80z' fill='%23444'/%3E%3Ccircle cx='95' cy='85' r='8' fill='%23555'/%3E%3Cpath d='M80 130l20-25 10 15 10-10 20 20H80z' fill='%23555'/%3E%3C/svg%3E",I=t.images&&Array.isArray(t.images)&&t.images.length>0?typeof t.images[0]=="object"&&t.images[0].url?t.images.sort((o,i)=>o.is_primary&&!i.is_primary?-1:!o.is_primary&&i.is_primary?1:(o.sort_order||0)-(i.sort_order||0)).map(o=>o.url):t.images:t.image_url?[t.image_url]:[w],P=I.length,T=o=>{const i=o.target.scrollLeft,S=o.target.offsetWidth;if(i<0){o.target.scrollLeft=0;return}const j=Math.round(i/S);j!==y&&k(j)},_=async o=>{if(o.stopPropagation(),!(h||g)){if(c.length>0){u(!d);return}m(!0),await new Promise(i=>setTimeout(i,600)),b(t,1),v(!0),a&&a(t),m(!1)}},M=async(o,i)=>{if(o.stopPropagation(),g)return;m(!0),u(!1),await new Promise(j=>setTimeout(j,600));const S={...t,size:i};b(S,1),v(!0),a&&a(S),m(!1)},C=()=>{V(`/shop/${t.id}`)},L=c.length>0?`${Math.min(c.length*44+8,220)}px`:"40px";return e.jsxs("div",{style:{background:"transparent",border:"none",borderRadius:"0",overflow:"visible",cursor:"pointer",position:"relative",opacity:0,animation:"fadeInUp 0.6s ease-out forwards"},onClick:C,onMouseEnter:()=>l(!0),onMouseLeave:()=>{l(!1),p(!1),u(!1)},role:"article",tabIndex:0,onKeyDown:o=>{(o.key==="Enter"||o.key===" ")&&(o.preventDefault(),C())},"aria-label":`${t.name} - ${E(t.price)}. Click to view details.`,children:[e.jsx("style",{children:`
        @keyframes fadeInUp {
