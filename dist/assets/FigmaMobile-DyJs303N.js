import{j as n,B as ot}from"./index-DGG7zKy1.js";import{b as t}from"./vendor-ViNJc2wV.js";import{u as at,a as rt,M as st}from"./useNavHeight-vrJMwQTh.js";import{u as lt,a as ct}from"./HomePage-8cTsxfpz.js";import{S as dt}from"./SocialMediaButtons-BkMhOiWn.js";import"./DesktopNavigationPills-BJ52-fkg.js";import"./beacon-CzvgH2JC.js";import"./mobileOptimization-ILGdA5i5.js";import"./sanitizer-C_5hlFeC.js";const mt=()=>{const[a,v]=t.useState(!1),[T,h]=t.useState(0),o=3,F=1e4,m="https://embed.laylo.com/laylo-sdk.js";t.useCallback(()=>typeof window<"u"&&(window.Laylo!==void 0||document.querySelector(`script[src="${m}"]`)!==null),[]);const p=t.useCallback(()=>new Promise((x,P)=>{if(document.querySelector(`script[src="${m}"]`)){const B=()=>{window.Laylo||document.readyState==="complete"?x():setTimeout(B,100)};B();return}const d=document.createElement("script");d.src=m,d.async=!0;const O=setTimeout(()=>{d.remove(),P(new Error("Script load timeout"))},F);d.onload=()=>{clearTimeout(O),setTimeout(x,200)},d.onerror=()=>{clearTimeout(O),d.remove(),P(new Error("Script load failed"))},document.head.appendChild(d)}),[]),W=t.useCallback(async(x=0)=>{if(!a)try{await p(),v(!0),console.log("🎉 Laylo SDK ready")}catch(P){if(x<o-1){const M=Math.pow(2,x)*1e3;h(x+1),console.warn(`⚠️ Laylo SDK load failed (attempt ${x+1}), retrying in ${M}ms...`),setTimeout(()=>W(x+1),M)}else console.error("❌ Laylo SDK failed to load after retries:",P.message)}},[a,p]);return t.useEffect(()=>{W(0)},[W]),a},pt=({dropId:a,color:v="ff0409",theme:T="dark",background:h="solid",minimal:o=!0,style:F={},visible:m=!0})=>{const[p,W]=t.useState(0),[x,P]=t.useState(0),M=t.useRef(0),d=t.useRef(null),O=t.useRef(!1),B=2,K=7e3,re=t.useMemo(()=>{if(typeof navigator>"u")return!1;const I=navigator.userAgent,S=/AppleWebKit/i.test(I),g=/iP(hone|od|ad)|Mobile/i.test(I),A=/CriOS/i.test(I),ce=/FxiOS/i.test(I);return S&&g&&!A&&!ce},[]),[te,w]=t.useState(null),D=t.useRef(m),z=t.useRef(0),f=1e3,G=I=>(I||"")+((I||"").includes("?")?"&":"?")+"_ts="+Date.now(),y=t.useMemo(()=>a?`https://embed.laylo.com/?${new URLSearchParams({dropId:a,color:v,theme:T,background:h,...o&&{minimal:"true"}}).toString()}`:null,[a,v,T,h,o]),H=(I,S)=>{const g=new Date().toISOString();console.log(`[LayloSimple ${g}] ${I}`,S??"")};t.useEffect(()=>{const I=!D.current&&m;if(!m){d.current&&(clearTimeout(d.current),d.current=null),D.current=m;return}if(!I){D.current=m;return}if(P(0),M.current=Date.now(),O.current=!1,H("Visible -> ensuring iframe src",{retryCount:0,url:y}),re){w(null);const S=setTimeout(()=>{const g=G(y);z.current=Date.now(),w(g)},180);return D.current=m,()=>{clearTimeout(S),d.current&&(clearTimeout(d.current),d.current=null)}}else te||(z.current=Date.now(),w(y));D.current=m},[m,y,re,te]),t.useEffect(()=>{if(!re)return;const I=g=>{if(g.persisted&&m){const A=Date.now();A-z.current>f&&(H("pageshow (persisted) -> refreshing iframe src (iOS)"),z.current=A,O.current=!1,w(null),setTimeout(()=>{w(G(y))},180))}},S=()=>{if(document.visibilityState==="visible"&&m){const g=Date.now();g-z.current>f&&(H("visibilitychange -> visible; refreshing iframe src (iOS)"),z.current=g,w(A=>A??G(y)))}};return window.addEventListener("pageshow",I),document.addEventListener("visibilitychange",S),()=>{window.removeEventListener("pageshow",I),document.removeEventListener("visibilitychange",S)}},[re,m,y]);const U=()=>{const I=Date.now()-(M.current||0);O.current=!0,d.current&&(clearTimeout(d.current),d.current=null),H("Iframe onLoad fired",{elapsedMs:I})},Q=I=>{if(H("Iframe onError",{error:I}),d.current&&(clearTimeout(d.current),d.current=null),x<B){H("Error -> retry (src bust)",{retryCount:x+1}),P(g=>g+1);const S=Date.now();S-z.current>f&&(z.current=S,M.current=Date.now(),O.current=!1,w(G(y)))}else H("Final error -> giving up after max retries")};return t.useEffect(()=>{if(!(!m||!te))return d.current&&(clearTimeout(d.current),d.current=null),M.current=Date.now(),d.current=setTimeout(()=>{if(!O.current)if(x<B){H("Load timeout -> retry (src bust)",{retryCount:x+1}),P(S=>S+1);const I=Date.now();I-z.current>f&&(z.current=I,w(G(y)))}else H("Final load timeout -> giving up after max retries")},K),()=>{d.current&&(clearTimeout(d.current),d.current=null)}},[te,m,x,y]),a?m?n.jsx("iframe",{id:`laylo-drop-${a}`,title:"Laylo Signup",width:"100%",height:"100%",frameBorder:"0",scrolling:"no",allow:"web-share; clipboard-write; fullscreen; autoplay; encrypted-media; picture-in-picture",loading:"eager",onLoad:U,onError:Q,style:{...F,WebkitTransform:"translateZ(0)",transform:"translateZ(0)",display:"block"},src:te??y},p):n.jsx("div",{style:{...F}}):n.jsx("div",{style:{...F,display:"flex",alignItems:"center",justifyContent:"center",minHeight:60},children:n.jsx("span",{style:{color:"#999",fontSize:14},children:"[LayloSimple] Missing dropId"})})},gt=({contentRef:a,viewportContext:v={isRealMobileDevice:!1},onStateChange:T=()=>{}})=>{const[h,o]=t.useState("");t.useState(!1);const[F,m]=t.useState(!1);t.useState("us"),t.useState("normal");const[p,W]=t.useState(!1),[x,P]=t.useState(!1),[M,d]=t.useState(!1),[O,B]=t.useState(!1),[K,re]=t.useState(!1);t.useState(0);const te=mt();t.useState(!1);const w=!M&&te,D=w,z=p,[f,G]=t.useState({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1,isOnDrawerContent:!1,isOnDrawerHandle:!1,isOnSwipeZone:!1,dragDistance:0,isIntentionalGesture:!1}),[y,H]=t.useState({expanded:!1,showDisclaimer:!1,phoneNumber:""});t.useState(!1),t.useRef(null),t.useRef(null);const U=t.useRef(null);t.useRef(null);const Q=t.useCallback(()=>{H({expanded:p,showDisclaimer:x,phoneNumber:h}),console.log("💾 Drawer state saved, iframe content preserved")},[p,x,h]),I=t.useCallback(r=>{U.current&&!U.current.contains(r.target)&&(Q(),W(!1),d(!1),P(!1))},[h,Q]);t.useEffect(()=>(p&&(document.addEventListener("mousedown",I),document.addEventListener("touchstart",I)),()=>{document.removeEventListener("mousedown",I),document.removeEventListener("touchstart",I)}),[p,I]),t.useEffect(()=>{const r=document.body,b=a?.current;if(p){const j=window.scrollY;r.classList.add("drawer-scroll-lock"),r.style.top=`-${j}px`,b&&b.classList.add("drawer-active")}else{r.classList.remove("drawer-scroll-lock");const j=r.style.top;r.style.top="",j&&window.scrollTo(0,parseInt(j||"0")*-1),b&&b.classList.remove("drawer-active")}return()=>{r.classList.remove("drawer-scroll-lock"),r.style.top="",b&&b.classList.remove("drawer-active")}},[p,a]);const S=t.useRef({drawerExpanded:void 0,drawerFullyClosed:void 0,iframeExpanded:void 0,phoneSubmitted:void 0});t.useEffect(()=>{const r={drawerExpanded:p,drawerFullyClosed:M,iframeExpanded:O,phoneSubmitted:F},b=S.current;(b.drawerExpanded!==r.drawerExpanded||b.drawerFullyClosed!==r.drawerFullyClosed||b.iframeExpanded!==r.iframeExpanded||b.phoneSubmitted!==r.phoneSubmitted)&&(S.current=r,T(r))},[p,M,O,F,T]),t.useRef(!1),t.useEffect(()=>{},[M]),t.useEffect(()=>{if(w&&te&&!K){const r=setTimeout(()=>{re(!0),console.log("✅ Laylo iframe ready for interaction")},1e3);return()=>clearTimeout(r)}},[w,te,K]);const g=t.useCallback(()=>M?"50px":O?"320px":p?"280px":"80px",[M,p,x,O]);t.useCallback(()=>{const r=g(),b=(()=>{const N="ontouchstart"in window||navigator.maxTouchPoints>0,k=/Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),Z=window.innerWidth,V=window.innerHeight,$=Z/V;return N&&k&&($<1.5||Z<768)})(),j=parseInt(r.replace("px",""));if(b)return`calc(${r} + 20px)`;{const N=Math.max(15,j*.2);return`calc(${r} + ${N}px)`}},[g,v]);const A=t.useCallback(r=>{if(r.target.tagName==="INPUT"||r.target.tagName==="TEXTAREA"||r.target.tagName==="BUTTON"||r.target.closest("iframe")||r.target.closest("button")||r.target.closest('[role="button"]'))return;const b=r.touches[0],j=Date.now(),N=r.target.closest(".mobile-drawer-content"),k=U.current?.getBoundingClientRect(),Z=k&&b.clientY>k.top&&b.clientY<k.top+120,V=p?k?.height*.4:120,$=k&&b.clientY>k.top&&b.clientY<k.top+V;G({isActive:!0,startY:b.clientY,currentY:b.clientY,startTime:j,isDragging:!1,initialDrawerState:p,isOnDrawerContent:!!N,isOnDrawerHandle:!!Z,isOnSwipeZone:!!$,dragDistance:0,isIntentionalGesture:!1}),$&&!N&&(r.preventDefault(),r.stopPropagation())},[p]),ce=t.useCallback(r=>{if(!f.isActive||r.target.tagName==="INPUT"||r.target.tagName==="TEXTAREA"||r.target.tagName==="BUTTON"||r.target.closest("iframe")||r.target.closest("button")||r.target.closest('[role="button"]'))return;const b=r.touches[0],j=f.startY-b.clientY,N=Math.abs(j);if(!f.isDragging&&N>3&&f.isOnSwipeZone&&!f.isOnDrawerContent){const k=N>8||N>3&&Date.now()-f.startTime>100;G(Z=>({...Z,isDragging:!0,isIntentionalGesture:k,dragDistance:N})),k&&(r.preventDefault(),r.stopPropagation())}if(f.isDragging&&f.isOnSwipeZone&&!f.isOnDrawerContent){const k=Math.max(N,f.dragDistance);f.isIntentionalGesture&&(r.preventDefault(),r.stopPropagation()),G(Z=>({...Z,currentY:b.clientY,dragDistance:k}))}else f.isOnDrawerContent||G(k=>({...k,currentY:b.clientY}))},[f]),oe=t.useCallback(r=>{if(!f.isActive)return;const b=f.startY-f.currentY,j=Math.abs(b),N=Date.now()-f.startTime,k=j/N,Z=8,V=.15,$=5,R=f.isIntentionalGesture?.7:1;let X=!1;if(f.isDragging&&f.isIntentionalGesture){const _=Z*R,C=V*R;k>C?(X=!0,console.log("🚀 Flick gesture detected:",{velocity:k,threshold:C})):j>_?(X=!0,console.log("🚀 Swipe gesture detected:",{distance:j,threshold:_})):j>$&&(X=!0,console.log("🚀 Snap gesture detected:",{distance:j,threshold:$}))}else f.isDragging&&!f.isIntentionalGesture&&(k>V*1.2||j>Z*1.5)&&(X=!0,console.log("🚀 Fallback gesture detected"));if(X)k>V?(U.current?.classList.add("momentum-fast"),setTimeout(()=>{U.current?.classList.remove("momentum-fast")},100)):(U.current?.classList.add("momentum-slow"),setTimeout(()=>{U.current?.classList.remove("momentum-slow")},250)),b>0?p||(W(!0),d(!1),console.log("🔄 Drawer opened via swipe up")):p&&(W(!1),console.log("🔄 Drawer closed via swipe down"));else{const _=U.current?.getBoundingClientRect(),C=p?_?.height*.4:120;_&&f.startY>_.top&&f.startY<_.top+C&&(M?(d(!1),W(!0),console.log("🔄 Drawer opened via tap on swipe zone")):p?(W(!1),console.log("🔄 Drawer collapsed via tap on swipe zone")):(W(!0),console.log("🔄 Drawer expanded via tap on swipe zone")))}G({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1,isOnDrawerContent:!1,isOnDrawerHandle:!1,isOnSwipeZone:!1,dragDistance:0,isIntentionalGesture:!1})},[f,p,M]),se=t.useCallback(()=>{M?(d(!1),W(y.expanded||!0),P(y.showDisclaimer),y.phoneNumber&&o(y.phoneNumber)):p||(W(!0),y.showDisclaimer&&P(!0))},[M,p,y]),Y=t.useCallback(r=>{r.stopPropagation(),M&&d(!1),W(!0),B(!0),setTimeout(()=>{B(!1)},1e4)},[M]);return n.jsxs(n.Fragment,{children:[n.jsx("style",{children:`
