import{j as i,B as lt}from"./index-Yla00mlq.js";import{b as o}from"./vendor-ViNJc2wV.js";import{u as ct,a as dt,M as mt}from"./useNavHeight-Dg5kgKVn.js";import{u as pt,a as gt,E as ut}from"./HomePage-B___J9Md.js";import{S as bt}from"./SocialMediaButtons-CX4FcURL.js";import{F as ht}from"./Footer-CQY4-7tL.js";import{i as ft}from"./breadcrumbSchema-BG74ATTs.js";import"./beacon-BB01f5iw.js";import"./mobileOptimization-ILGdA5i5.js";import"./sanitizer-BwoNezYD.js";const xt=({dropId:a,color:m="ff0409",theme:x="dark",background:p="solid",minimal:n=!0,style:I={},visible:u=!0})=>{const[S,ne]=o.useState(0),k=o.useRef(Date.now()),h=o.useRef(null),V=o.useRef(!1),B=2,ke=8e3,T=o.useCallback((d=!1)=>a?`https://embed.laylo.com/?${new URLSearchParams({dropId:a,color:m,theme:x,background:p,...n&&{minimal:"true"},...d&&{_ts:String(Date.now())}}).toString()}`:null,[a,m,x,p,n])(S>0),D=o.useCallback((d,W)=>{const J=new Date().toISOString();console.log(`[LayloSimple ${J}] ${d}`,W??"")},[]);o.useEffect(()=>{D("Component mounted",{dropId:a,visible:u,src:T})},[]),o.useEffect(()=>{if(!(!u||!T))return h.current&&(clearTimeout(h.current),h.current=null),k.current=Date.now(),V.current=!1,h.current=setTimeout(()=>{V.current||(S<B?(D("Load timeout -> retry",{retryCount:S+1}),ne(d=>d+1)):D("Final load timeout -> giving up after max retries"))},ke),()=>{h.current&&(clearTimeout(h.current),h.current=null)}},[T,u,S,D]);const Me=o.useCallback(()=>{const d=Date.now()-(k.current||0);V.current=!0,h.current&&(clearTimeout(h.current),h.current=null),D("Iframe onLoad fired",{elapsedMs:d})},[D]),v=o.useCallback(()=>{D("Iframe onError"),h.current&&(clearTimeout(h.current),h.current=null),S<B?(D("Error -> retry",{retryCount:S+1}),ne(d=>d+1)):D("Final error -> giving up after max retries")},[S,D]);return a?u?T?i.jsx("iframe",{id:`laylo-drop-${a}`,title:"Laylo Signup",width:"100%",height:"100%",frameBorder:"0",scrolling:"no",allow:"web-share; clipboard-write; fullscreen; autoplay; encrypted-media; picture-in-picture",loading:"eager",onLoad:Me,onError:v,style:{...I,WebkitTransform:"translateZ(0)",transform:"translateZ(0)",display:"block"},src:T},`laylo-${a}-${S}`):i.jsx("div",{style:{...I}}):i.jsx("div",{style:{...I}}):i.jsx("div",{style:{...I,display:"flex",alignItems:"center",justifyContent:"center",minHeight:60},children:i.jsx("span",{style:{color:"#999",fontSize:14},children:"[LayloSimple] Missing dropId"})})},de=(a,m=null)=>{if(!a)return a;if(typeof a=="string"&&a.startsWith("data:"))return console.log("⚠️ Data URL detected, returning as-is:",a.substring(0,50)+"..."),a;const x=/iPad|iPhone|iPod/.test(navigator.userAgent)&&/Safari/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent);if(typeof a=="string"&&a.includes("/api/images/serve/")){console.log("🔄 Processing new image system URL:",a);const p=a.match(/\/api\/images\/serve\/([a-f0-9-]{36})/);if(p){const n=p[1],I=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click";let u="small";m&&(m<=150?u="thumbnail":m<=300?u="small":m<=600?u="medium":(m<=1200,u="large"));const S=`${I}/api/images/serve/${n}/${u}`;return console.log("✅ Generated optimized URL for new image system:",S,`(variant: ${u}, width: ${m})`),S}}if(typeof a=="string"&&a.includes("/images/figma-exact/")){const p=a.split("/").pop();return x&&p.includes(".webp")?`/images/optimized/${p.replace(".webp",".jpg")}`:`/images/optimized/${p}`}if(typeof a=="string"&&a.startsWith("http")){const p=encodeURIComponent(a),I=`${window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click"}/images/proxy-optimized?url=${p}`,u=x?"&format=jpeg&quality=85":"";return m?`${I}&w=${m}${u}`:`${I}${u}`}if(typeof a=="string"&&a.startsWith("/")&&(a.includes("/api/images/serve/")||!a.includes("/images/"))){console.log("🔄 Processing relative URL, assuming new image system:",a);const p=a.match(/([a-f0-9-]{36})/);if(p){const n=p[1],u=`${window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click"}/api/images/serve/${n}/medium`;return console.log("✅ Generated URL for UUID-based relative path:",u),u}}if(typeof a=="string"&&(a.includes("/images/")||a.includes("/custom/images/"))){const n=a.split("/").pop().replace(/\.[^/.]+$/,"");return m?`/images/optimized/${n}-${m}w.webp`:`/images/optimized/${n}.webp`}return console.log("⚠️ No optimization applied to URL:",a),a},Ye=a=>a==="event"?[150,300,450]:a==="hero"?[600,900,1200]:[150,300,600],yt=(a,m="event")=>a?Ye(m).map(x=>`${de(a,x)} ${x}w`).join(", "):"",vt=(a,m="event")=>{if(!a||/iPhone|iPad|iPod/.test(navigator.userAgent)&&/Safari/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent))return"";if(typeof a=="string"&&(a.includes("/api/images/serve/")||a.includes("/api/settings/serve/")||a.startsWith("/api/")))return console.log("🚫 Skipping AVIF for internal API URL to prevent loop:",a),"";const p=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click";return Ye(m).map(n=>`${p}/images/proxy-optimized?url=${encodeURIComponent(a)}&w=${n}&format=avif ${n}w`).join(", ")},me=[{id:"us",code:"+1",name:"United States",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"(555) 123-4567",maxLength:14,digitLength:10},{id:"ca",code:"+1",name:"Canada",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"(555) 123-4567",maxLength:14,digitLength:10},{id:"gb",code:"+44",name:"United Kingdom",flag:"data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjEiIGhlaWdodD0iMTUiIHZpZXdCb3g9IjAgMCAyMSAxNSIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPHJlY3Qgd2lkdGg9IjIxIiBoZWlnaHQ9IjE1IiBmaWxsPSIjMDEyMTY5Ii8+CjxwYXRoIGQ9Ik0wIDBoMjF2MTVIMHoiIGZpbGw9IiMwMTIxNjkiLz4KPC9zdmc+",pattern:/^\d{10,11}$/,placeholder:"7911 123456",maxLength:13,digitLength:11},{id:"au",code:"+61",name:"Australia",flag:"data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjEiIGhlaWdodD0iMTUiIHZpZXdCb3g9IjAgMCAyMSAxNSIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPHJlY3Qgd2lkdGg9IjIxIiBoZWlnaHQ9IjE1IiBmaWxsPSIjMDEyMTY5Ii8+PC9zdmc+",pattern:/^\d{9}$/,placeholder:"412 345 678",maxLength:11,digitLength:9},{id:"de",code:"+49",name:"Germany",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"30 12345678",maxLength:13,digitLength:11},{id:"fr",code:"+33",name:"France",flag:"data:image/svg+xml;base64,",pattern:/^\d{9}$/,placeholder:"6 12 34 56 78",maxLength:12,digitLength:9},{id:"es",code:"+34",name:"Spain",flag:"data:image/svg+xml;base64,",pattern:/^\d{9}$/,placeholder:"612 34 56 78",maxLength:11,digitLength:9},{id:"it",code:"+39",name:"Italy",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"312 345 6789",maxLength:12,digitLength:10},{id:"jp",code:"+81",name:"Japan",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"90 1234 5678",maxLength:13,digitLength:11},{id:"kr",code:"+82",name:"South Korea",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"10 1234 5678",maxLength:13,digitLength:11},{id:"cn",code:"+86",name:"China",flag:"data:image/svg+xml;base64,",pattern:/^\d{11}$/,placeholder:"138 0013 8000",maxLength:13,digitLength:11},{id:"in",code:"+91",name:"India",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"98765 43210",maxLength:12,digitLength:10},{id:"br",code:"+55",name:"Brazil",flag:"data:image/svg+xml;base64,",pattern:/^\d{10,11}$/,placeholder:"11 91234 5678",maxLength:14,digitLength:11},{id:"mx",code:"+52",name:"Mexico",flag:"data:image/svg+xml;base64,",pattern:/^\d{10}$/,placeholder:"55 1234 5678",maxLength:12,digitLength:10}],$e=(a,m)=>{const x=typeof a=="string"?a.replace(/[^\d]/g,""):"",p=me.find(I=>I.id===m);if(!p||x.length===0)return x;const n=x.slice(0,p.digitLength);switch(m){case"us":case"ca":return n.length<=3?n:n.length<=6?`(${n.slice(0,3)}) ${n.slice(3)}`:`(${n.slice(0,3)}) ${n.slice(3,6)}-${n.slice(6)}`;case"gb":return n.length<=4?n:n.length<=7?`${n.slice(0,4)} ${n.slice(4)}`:`${n.slice(0,4)} ${n.slice(4,7)} ${n.slice(7)}`;case"jp":case"kr":return n.length<=2?n:n.length<=6?`${n.slice(0,2)} ${n.slice(2)}`:`${n.slice(0,2)} ${n.slice(2,6)} ${n.slice(6)}`;case"cn":return n.length<=3?n:n.length<=7?`${n.slice(0,3)} ${n.slice(3)}`:`${n.slice(0,3)} ${n.slice(3,7)} ${n.slice(7)}`;case"in":return n.length<=5?n:`${n.slice(0,5)} ${n.slice(5)}`;case"br":return n.length<=2?n:n.length<=7?`${n.slice(0,2)} ${n.slice(2)}`:`${n.slice(0,2)} ${n.slice(2,7)} ${n.slice(7)}`;case"mx":return n.length<=2?n:n.length<=6?`${n.slice(0,2)} ${n.slice(2)}`:`${n.slice(0,2)} ${n.slice(2,6)} ${n.slice(6)}`;default:return n.length<=3?n:n.length<=6?`${n.slice(0,3)} ${n.slice(3)}`:`${n.slice(0,3)} ${n.slice(3,6)} ${n.slice(6)}`}},wt=(a,m)=>{const x=a.replace(/[^\d]/g,""),p=me.find(n=>n.id===m);return p?p.pattern.test(x):x.length>=10&&x.length<=15},Se=a=>me.find(m=>m.id===a)||me[0],Pt=()=>{const{trackEvent:a}=pt(),[m,x]=o.useState(!1);o.useCallback(e=>{x(e),e&&a("privacy_consent",{action:"granted",timestamp:Date.now(),component:"PrivacyConsentModal"})},[a]);const[p,n]=o.useState(!0),[I,u]=o.useState(!1);o.useEffect(()=>{setTimeout(()=>{n(!1),u(!0)},2e3),a("component_load",{component:"FigmaMobile",viewport_type:"mobile"})},[a]),o.useEffect(()=>{ft("homepage")},[]),o.useEffect(()=>{if(!document.querySelector('script[src="https://embed.laylo.com/laylo-sdk.js"]')){const e=document.createElement("script");e.src="https://embed.laylo.com/laylo-sdk.js",e.async=!0,e.defer=!0,e.onerror=s=>{console.warn("⚠️ Laylo SDK failed to load in FigmaMobile:",s)},e.onload=()=>{console.log("✅ Laylo SDK script loaded successfully in FigmaMobile")},document.head.appendChild(e)}},[]);const[S,ne]=o.useState(!1),[k,h]=o.useState(""),[V,B]=o.useState(!1),[ke,G]=o.useState(!1),[T,D]=o.useState("us"),[Me,v]=o.useState("normal"),[d,W]=o.useState(!1),[J,pe]=o.useState(""),[N,ae]=o.useState(""),[je,Q]=o.useState(!1),[It,C]=o.useState("normal"),[w,M]=o.useState(!1),[ge,O]=o.useState(!1),[K,z]=o.useState(!1),[Te,De]=o.useState(!1);o.useState(!1);const[Ee,ee]=o.useState(0),[re,te]=o.useState(!1),[Ce,Ae]=o.useState(!1),[A,ie]=o.useState({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1}),{loading:ue,homeSettings:se,showAllEvents:y,setShowAllEvents:be,filteredFeaturedEvents:R,filteredHomepageEvents:X,featuredEvents:Ve,homepageEvents:Je,normalizeEvent:Ne}=gt(),[St,Qe]=o.useState(0),[_,Ke]=o.useState(!1),[H,Xe]=o.useState(!1),[j,ze]=o.useState(null),[Le,Ze]=o.useState(!1),Pe=o.useCallback((e,s)=>{if(Le)return;Ze(!0);let t=e.coverImage;t&&!t.startsWith("http")&&(t=`${window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click"}${t}`),t&&(t=t.replace(/[?&](w|width|h|height|size)=\d+/g,""),t=t.replace(/[?&]$/,"")),ze({...e,imageUrl:t||e.coverImage,originalRect:s?.getBoundingClientRect()||null}),setTimeout(()=>{Ze(!1)},400)},[Le]),Fe=o.useCallback(()=>{ze(null)},[]),f=o.useRef({scrollY:0,locked:!1,prevent:void 0,prevBodyPosition:"",prevBodyTop:"",prevBodyWidth:"",prevBodyOverflow:"",prevBodyTouchAction:""}),We=o.useCallback(()=>{if(f.current.locked)return;const e=window.scrollY||window.pageYOffset||0;f.current.scrollY=e;const s=r=>{r&&typeof r.preventDefault=="function"&&r.preventDefault(),r&&typeof r.stopPropagation=="function"&&r.stopPropagation()};f.current.prevent=s,document.documentElement.style.overscrollBehavior="none";const t=document.body;f.current.prevBodyPosition=t.style.position||"",f.current.prevBodyTop=t.style.top||"",f.current.prevBodyWidth=t.style.width||"",f.current.prevBodyOverflow=t.style.overflow||"",f.current.prevBodyTouchAction=t.style.touchAction||"",t.style.position="fixed",t.style.top=`-${e}px`,t.style.width="100%",t.style.overflow="hidden",t.style.touchAction="none",window.addEventListener("wheel",s,{passive:!1,capture:!0}),window.addEventListener("touchmove",s,{passive:!1,capture:!0}),f.current.locked=!0},[]),he=o.useCallback(()=>{if(!f.current.locked)return;const e=document.body;e.style.position=f.current.prevBodyPosition,e.style.top=f.current.prevBodyTop,e.style.width=f.current.prevBodyWidth,e.style.overflow=f.current.prevBodyOverflow,e.style.touchAction=f.current.prevBodyTouchAction,document.documentElement.style.overscrollBehavior="",f.current.prevent&&(window.removeEventListener("wheel",f.current.prevent,{capture:!0}),window.removeEventListener("touchmove",f.current.prevent,{capture:!0}));const s=f.current.scrollY||0;window.scrollTo(0,s),f.current.locked=!1},[]);o.useEffect(()=>{if(j)return We(),()=>{he()};he()},[j,We,he]);const[le,U]=o.useState("hd720"),[Re,$]=o.useState("fast"),[L,fe]=o.useState({expanded:!1,showDisclaimer:!1,showVerification:!1,verificationCode:"",phoneNumber:""}),He=o.useCallback(()=>{fe({expanded:w,showDisclaimer:ge,showVerification:d,verificationCode:J,phoneNumber:k}),console.log("💾 Drawer state saved, iframe content preserved")},[w,ge,d,J,k]),[kt,xe]=o.useState(!1),Z=o.useRef(null),ye=o.useRef(null),g=o.useRef(null),ce=o.useRef(!0),ve=o.useRef(null),we=o.useRef(null),_e=ct(),qe=Math.max(_e||0,0)+12,{scrollY:et}=dt(we.current,{threshold:20,throttleMs:32,passive:!0});o.useEffect(()=>{const e=document.body,s=we.current;if(w){const t=window.scrollY;e.classList.add("drawer-scroll-lock"),e.style.top=`-${t}px`,s&&s.classList.add("drawer-active")}else{const t=e.style.top;e.classList.remove("drawer-scroll-lock"),e.style.top="",t&&window.scrollTo(0,parseInt(t||"0")*-1),s&&s.classList.remove("drawer-active")}return()=>{e.classList.remove("drawer-scroll-lock"),e.style.top="",s&&s.classList.remove("drawer-active")}},[w]),o.useCallback(e=>{const s=e.target.value,t=Se(T),r=s.replace(/[^\d]/g,"");if(r.length>t.digitLength)return;const l=$e(r,T);h(l)},[T]),o.useCallback(e=>{e.key==="Enter"&&tt()},[]),o.useCallback(e=>{const s=e.target.value,t=Se(s);if(D(s),ye.current&&t.flag&&(ye.current.src=t.flag,ye.current.alt=t.name),k){const r=k.replace(/[^\d]/g,""),l=$e(r,s);h(l)}console.log(`🌍 Country changed to: ${t.code} (${t.name})`)},[k]);const tt=o.useCallback(async()=>{const e=k.trim();if(!e||V)return;if(e.replace(/\D/g,"")==="5555555555"){console.log("🧪 Test number detected - showing loading then verification UI"),B(!0),v("loading"),setTimeout(()=>{v("valid"),ae(e),B(!1),setTimeout(()=>{W(!0),M(!0)},200)},800);return}const r=Se(T);if(!wt(e,T)){console.warn("Invalid phone number format for",r.name),v("invalid"),Z.current&&(Z.current.classList.add("shake"),setTimeout(()=>{Z.current?.classList.remove("shake"),v("normal")},400));return}try{B(!0),v("loading"),console.log("📱 Submitting phone number:",{phone:e,countryCode:r.code});const l=window.location.hostname==="localhost"?"":"https://admin.b2b.click",c=await fetch(`${l}/api/home-settings/submit-phone`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:e,countryCode:r.code})}),b=await c.json();c.ok&&b.success?(console.log("✅ Phone number submitted successfully"),b.requiresVerification?(console.log("🔐 Moving to verification step"),v("normal"),ae(e),setTimeout(()=>{W(!0),M(!0)},500)):(G(!0),v("valid"),h(""),setTimeout(()=>{G(!1),v("normal")},3e3))):(console.error("❌ Failed to submit phone number:",b.error||"Unknown error"),v("invalid"),Z.current&&(Z.current.classList.add("shake"),setTimeout(()=>{Z.current?.classList.remove("shake"),v("normal")},400)))}catch(l){console.error("❌ Error submitting phone number:",l),v("invalid"),Z.current&&(Z.current.classList.add("shake"),setTimeout(()=>{Z.current?.classList.remove("shake"),v("normal")},400))}finally{B(!1)}},[k,V,T]);o.useCallback(async()=>{const e=J.trim();if(!e||je)return;if(N.replace(/\D/g,"")==="5555555555"&&(console.log("🧪 Test verification - accepting any 4-digit code"),e.length===4)){Q(!0),v("loading"),setTimeout(()=>{C("valid"),G(!0),Q(!1)},1e3),setTimeout(()=>{z(!0),W(!1),M(!1),O(!1)},2e3),setTimeout(()=>{pe(""),ae(""),h(""),G(!1),v("normal"),C("normal"),Q(!1),z(!1),ee(0),te(!1),g.current&&(clearInterval(g.current),g.current=null),fe({expanded:!1,showDisclaimer:!1,showVerification:!1,verificationCode:"",phoneNumber:""})},5e3);return}if(!/^\d{4}$/.test(e)){console.warn("Invalid verification code format"),C("invalid"),setTimeout(()=>{C("filled")},400);return}try{Q(!0),v("loading"),console.log("🔐 Submitting verification code");const r=window.location.hostname==="localhost"?"":"https://admin.b2b.click",l=await fetch(`${r}/api/home-settings/verify-phone`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:N,code:e})}),c=await l.json();l.ok&&c.success?(console.log("✅ Phone verification successful"),C("valid"),G(!0),setTimeout(()=>{z(!0),W(!1),M(!1),O(!1)},2e3),setTimeout(()=>{pe(""),ae(""),h(""),G(!1),v("normal"),C("normal"),Q(!1),z(!1),ee(0),te(!1),g.current&&(clearInterval(g.current),g.current=null),fe({expanded:!1,showDisclaimer:!1,showVerification:!1,verificationCode:"",phoneNumber:""})},5e3)):(console.error("❌ Phone verification failed:",c.error||"Unknown error"),C("invalid"),setTimeout(()=>{C("filled")},400))}catch(r){console.error("❌ Error submitting verification code:",r),C("invalid"),setTimeout(()=>{C("filled")},400)}finally{Q(!1)}},[J,je,N]);const q=o.useCallback(()=>{console.log("🚀 Starting countdown timer"),g.current&&(clearInterval(g.current),g.current=null),ee(60),te(!1),g.current=setInterval(()=>{if(!ce.current){g.current&&(clearInterval(g.current),g.current=null);return}ee(e=>(console.log("⏰ Countdown tick:",e),e<=1?(console.log("✅ Countdown finished, enabling resend"),ce.current&&te(!0),g.current&&(clearInterval(g.current),g.current=null),0):e-1))},1e3)},[]);o.useCallback(async()=>{if(!(!re||Ce||!N))try{Ae(!0),console.log("🔄 Resending verification code to:",N);const e=window.location.hostname==="localhost"?"":"https://admin.b2b.click",t=await(await fetch(`${e}/api/home-settings/resend-verification`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phoneNumber:N})})).json();t.success?(console.log("✅ Verification code resent successfully"),q()):(console.error("❌ Failed to resend verification code:",t.error),q())}catch(e){console.error("❌ Error resending verification code:",e),q()}finally{Ae(!1)}},[re,Ce,N,q]),o.useEffect(()=>(ce.current=!0,()=>{ce.current=!1,g.current&&(clearInterval(g.current),g.current=null)}),[]),o.useEffect(()=>{!d&&g.current&&(clearInterval(g.current),g.current=null,ee(0),te(!1))},[d]),o.useEffect(()=>{console.log("🔄 Countdown useEffect triggered:",{showVerification:d,verificationPhone:N,resendCountdown:Ee,canResend:re}),d&&N&&Ee===0&&!re&&(console.log("🚀 Starting resend countdown"),q())},[d,N,q]),o.useEffect(()=>{ue||(setTimeout(()=>{Ke(!0)},150),setTimeout(()=>{Xe(!0)},300))},[ue]),o.useEffect(()=>{const e=setTimeout(()=>{z(!1),M(!1)},500);return()=>clearTimeout(e)},[]),o.useEffect(()=>{const s=setTimeout(()=>{if("connection"in navigator){const l=navigator.connection||navigator.mozConnection||navigator.webkitConnection;if(l){const c=l.effectiveType,b=l.downlink;console.log("🌐 Connection detected:",{effectiveType:c,downlink:b}),c==="4g"&&b>5?(U("hd1080"),$("fast")):c==="4g"||c==="3g"&&b>2?(U("hd720"),$("medium")):(U("large"),$("slow"));return}}const t=performance.now(),r=new Image;r.onload=()=>{const c=performance.now()-t;console.log("🚀 Speed test completed in:",c+"ms"),c<200?(U("hd1080"),$("fast")):c<500?(U("hd720"),$("medium")):(U("large"),$("slow"))},r.onerror=()=>{console.log("⚠️ Speed test failed, using default HD quality"),U("hd720"),$("medium")},r.src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"},200);return()=>clearTimeout(s)},[]),o.useEffect(()=>{if(R&&R.length>0){console.log("🚀 Preloading critical event images for instant display...");const e=/iPhone|iPad|iPod/.test(navigator.userAgent)&&/Safari/.test(navigator.userAgent)&&!/Chrome/.test(navigator.userAgent);R.slice(0,2).forEach((s,t)=>{if(s.coverImage){if(!e&&!s.coverImage.includes("/api/images/serve/")){const l=document.createElement("link");l.rel="preload",l.as="image",l.type="image/avif";const c=window.location.hostname==="localhost"?"http://localhost:3002":"https://admin.b2b.click";l.href=`${c}/images/proxy-optimized?url=${encodeURIComponent(s.coverImage)}&w=120&format=avif`,document.head.appendChild(l)}const r=document.createElement("link");if(r.rel="preload",r.as="image",r.type="image/webp",r.href=de(s.coverImage,300),document.head.appendChild(r),e){const l=document.createElement("link");l.rel="preload",l.as="image",l.href=s.coverImage,document.head.appendChild(l)}console.log(`✅ Preloaded mobile event image ${t+1}: ${s.title} ${e?"(Safari mobile optimized)":""}`)}})}},[R]);const[Y,Be]=o.useState(!1),[Mt,Ie]=o.useState(!1),Ge=()=>{Y?(Be(!1),Ie(!1)):(Ie(!0),Be(!0),setTimeout(()=>Ie(!1),600))},Oe=()=>{const e=window.location.pathname;return e==="/"||e===""?"events":e.startsWith("/about")?"about":e.startsWith("/contact")?"contact":"events"},[it,ot]=o.useState(Oe());o.useEffect(()=>{const e=()=>{ot(Oe())};return window.addEventListener("popstate",e),e(),()=>{window.removeEventListener("popstate",e)}},[]);const nt=e=>{if(e==="/"){window.scrollTo({top:0,behavior:"smooth"});return}window.location.href=e};o.useCallback(()=>{M(!0),O(!0)},[]),o.useCallback(()=>{!k.trim()&&!d&&setTimeout(()=>{M(!1),O(!1)},200)},[k,d]);const oe=o.useCallback(e=>{ve.current&&!ve.current.contains(e.target)&&(He(),M(!1),d?z(!1):(z(!1),O(!1)))},[k,d,He]);o.useEffect(()=>(w&&(document.addEventListener("mousedown",oe),document.addEventListener("touchstart",oe)),()=>{document.removeEventListener("mousedown",oe),document.removeEventListener("touchstart",oe)}),[w,oe]),o.useCallback(()=>K?"50px":Te?"320px":d&&w?"240px":d&&!w?"60px":w?"280px":"80px",[K,d,w,ge,Te]);const at=o.useCallback(()=>"calc(16px + env(safe-area-inset-bottom, 0px))",[]);o.useEffect(()=>{const e=()=>{Qe(s=>s+1)};return window.addEventListener("resize",e),window.addEventListener("orientationchange",e),e(),()=>{window.removeEventListener("resize",e),window.removeEventListener("orientationchange",e)}},[]),o.useCallback(e=>{if(e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.closest("iframe"))return;const s=e.touches[0],t=Date.now();ie({isActive:!0,startY:s.clientY,currentY:s.clientY,startTime:t,isDragging:!1,initialDrawerState:w})},[w]),o.useCallback(e=>{if(!A.isActive||e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.closest("iframe"))return;const s=e.touches[0],t=A.startY-s.clientY,r=Math.abs(t);!A.isDragging&&r>10&&(ie(l=>({...l,isDragging:!0})),e.preventDefault()),A.isDragging&&(ie(l=>({...l,currentY:s.clientY})),e.preventDefault())},[A]),o.useCallback(e=>{if(!A.isActive)return;if(e.target.tagName==="INPUT"||e.target.tagName==="TEXTAREA"||e.target.closest("iframe")){ie({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1});return}const s=A.startY-A.currentY,t=Math.abs(s),r=Date.now()-A.startTime,l=t/r,c=30,b=.5,P=50;let F=!1;if(A.isDragging&&((l>b||t>c||t>P)&&(F=!0),F)){const E=ve.current;E&&(E.classList.remove("momentum-fast","momentum-slow"),l>b?E.classList.add("momentum-fast"):E.classList.add("momentum-slow"),setTimeout(()=>{E&&E.classList.remove("momentum-fast","momentum-slow")},250)),s>0?w||(M(!0),z(!1)):w&&M(!1)}ie({isActive:!1,startY:0,currentY:0,startTime:0,isDragging:!1,initialDrawerState:!1})},[A,w]),o.useCallback(()=>{K?(z(!1),M(L.expanded||!0),O(L.showDisclaimer),W(L.showVerification),L.verificationCode&&(pe(L.verificationCode),L.verificationCode.length===4&&C("filled")),L.phoneNumber&&h(L.phoneNumber)):w||(M(!0),L.showDisclaimer&&!d&&O(!0))},[K,w,L,d]),o.useCallback(e=>{e.stopPropagation(),K&&z(!1),M(!0),De(!0),setTimeout(()=>{De(!1)},1e4)},[K]),o.useCallback(()=>{xe(!0)},[]),o.useCallback(()=>{xe(!1)},[]),o.useCallback(()=>{xe(!1)},[]),o.useEffect(()=>{const e=document.querySelector('meta[name="viewport"]'),s=e?e.getAttribute("content"):"";let t=document.querySelector('meta[name="viewport"]');t||(t=document.createElement("meta"),t.name="viewport",document.head.appendChild(t)),t.content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, viewport-fit=cover, shrink-to-fit=no";const r=(P,F)=>{let E=document.querySelector(`meta[name="${P}"]`);E||(E=document.createElement("meta"),E.name=P,document.head.appendChild(E)),E.content=F};r("apple-mobile-web-app-capable","yes"),r("apple-mobile-web-app-status-bar-style","black-translucent"),r("apple-touch-fullscreen","yes"),r("mobile-web-app-capable","yes"),r("format-detection","telephone=no"),document.documentElement.style.webkitTextSizeAdjust="100%",document.documentElement.style.textSizeAdjust="100%";let l=null,c=null;const b=()=>{l&&cancelAnimationFrame(l),c&&clearTimeout(c),c=setTimeout(()=>{l=requestAnimationFrame(()=>{const P=window.innerHeight*.01;document.documentElement.style.setProperty("--vh",`${P}px`)})},100)};return b(),window.addEventListener("resize",b,{passive:!0}),window.addEventListener("orientationchange",b,{passive:!0}),()=>{e&&s&&e.setAttribute("content",s),window.removeEventListener("resize",b),window.removeEventListener("orientationchange",b),l&&cancelAnimationFrame(l),c&&clearTimeout(c)}},[]);const rt=o.useMemo(()=>{const e="https://www.youtube.com/embed/vEHTO3gf1jk",r={...{autoplay:"1",mute:"1",controls:"0",showinfo:"0",rel:"0",loop:"1",playlist:"vEHTO3gf1jk",modestbranding:"1",iv_load_policy:"3",fs:"0",disablekb:"1",hd:"1",cc_load_policy:"0",autohide:"1",wmode:"transparent",enablejsapi:"1",origin:window.location.origin},...{vq:le,quality:le}},l=Object.entries(r).map(([b,P])=>`${b}=${P}`).join("&"),c=`${e}?${l}`;return console.log("🎥 YouTube URL built:",{videoQuality:le,connectionSpeed:Re,finalURL:c}),c},[le,Re]),Ue=o.useCallback(()=>{n(!1),u(!0),a("video_interaction",{action:"thumbnail_click",video_id:"vEHTO3gf1jk",component:"FigmaMobile"})},[a]),st=o.useMemo(()=>i.jsx("div",{onClick:Ue,style:{position:"absolute",top:"0",left:"0",width:"100%",height:"100%",cursor:"pointer",backgroundImage:"url(https://img.youtube.com/vi/vEHTO3gf1jk/maxresdefault.jpg)",backgroundSize:"cover",backgroundPosition:"center",backgroundRepeat:"no-repeat",transform:"translateZ(0)",backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden",transition:"transform 0.2s ease-out"},onMouseDown:e=>{e.currentTarget.style.transform="translateZ(0) scale(0.98)"},onMouseUp:e=>{e.currentTarget.style.transform="translateZ(0) scale(1)"},onMouseLeave:e=>{e.currentTarget.style.transform="translateZ(0) scale(1)"},onTouchStart:e=>{e.currentTarget.style.transform="translateZ(0) scale(0.98)"},onTouchEnd:e=>{e.currentTarget.style.transform="translateZ(0) scale(1)"}}),[Ue]);return ue?i.jsx(lt,{fullScreen:!0,minDisplayTime:600,showMessage:!1}):i.jsxs(i.Fragment,{children:[i.jsx(ut,{events:[...Ve,...Je],domain:"bounce2bounce.com"}),i.jsx("link",{rel:"stylesheet",href:"/css/mobile-scroll-fix.css"}),i.jsx("style",{children:`
