    ...
    <div className="homepage-root">
      ...
      <div
        style={{
          ...
          justifyContent: 'space-between',  // Space between for proper distribution
          alignItems: 'center',
      ...
      >
        ...
        <div
          style={{
            ...
            overflow: 'hidden'  // Ensure all content stays within hero boundaries
          }}
        >
          ...
          <div
            style={{
              position: 'absolute',
              left: '0px',
              top: `${scaledDimensions.heroHeight - 47}px`,  // Position relative to actual hero height
              display: 'flex',
              width: `${scaledDimensions.heroWidth}px`,  // Match actual hero width to stay contained
          ...
          >
            ...
            <div
              style={{
                display: 'flex',
                width: `${Math.min(157, scaledDimensions.heroWidth - 100)}px`,  // Responsive width
                height: '36px',
                padding: '4px 0px',
            ...
            {/* Pages - CTA - Hide when space gets tight */}
                ...
                >
                  <span
                    style={{
                      color: '#FFF',
                      fontFamily: 'Inter',
                      fontSize: `${Math.max(10, Math.min(14, scaledDimensions.heroWidth * 0.056))}px`,  // Responsive font size
                      fontWeight: '400',
                      lineHeight: 'normal'
                    }}
                  >
          ...
          <div
            style={{
              position: 'absolute',
              left: '0px',
              top: `${scaledDimensions.heroHeight * 0.65}px`,  // Scale position relative to hero height
              display: 'flex',
              width: `${scaledDimensions.heroWidth}px`,  // Use full hero width
              height: `${Math.min(68, scaledDimensions.heroHeight * 0.25)}px`,  // Scale height but cap at 68px
              padding: '8px 12px',
          ...
          >
            <div
              style={{
                color: '#FFF',
                fontFamily: 'Inter',
                fontSize: `${Math.max(14, Math.min(24, scaledDimensions.heroWidth * 0.08))}px`,  // Responsive font size
                fontWeight: '800',
                lineHeight: '1.1',
                flex: '1',
                overflow: 'hidden',
                textOverflow: 'ellipsis',
                whiteSpace: 'nowrap',
                maxWidth: `${scaledDimensions.heroWidth - 24}px`  // Full width minus padding
              }}
            >
